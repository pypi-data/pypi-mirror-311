import threading
from contentgrid_management_client import AttributeType, get_organizations, SearchType, ExactAttributeSearchOption, PrefixAttributeSearchOption
from contentgrid_management_client.console import AllowedValuesAttributeConstraint, ConstraintType
...
if TEST_CONSOLE:
    ...
    def test_create_relation():
        try:
            entity = blueprint.create_entity("testaddrelation", entity_description="description")
        except:
            entity = blueprint.get_entity_definition_by_name("testaddrelation")
        entity.create_relation("testrelation", "testaddrelation", many_target_per_source=False, many_source_per_target=False, relation_description="description")
    ...
    def test_create_attribute():
        try:
            entity = blueprint.create_entity("testaddattribute", entity_description="description")
        except:
            entity = blueprint.get_entity_definition_by_name("testaddattribute")
        ...
        entity.create_attribute("testattribute", AttributeType.STRING, required=True, attribute_description="test attribute description")
        attribute = entity.get_attribute_definition_by_name("testattribute")
    ...
    def test_get_constraints():
        attribute = blueprint.get_entity_definitions()[0].attribute_definitions[0]
        assert len(attribute.get_constraints()) == 0
    
    def test_create_constraints():
        try:
            entity = blueprint.create_entity("contrained-entity", entity_description="description")
        except:
            entity = blueprint.get_entity_definition_by_name("contrained-entity")
        
        try:
            attribute = entity.create_attribute("allowed_values_attr", AttributeType.STRING)
            constraints = attribute.get_constraints()
            assert len(constraints) == 0
        except:
            attribute = entity.get_attribute_definition_by_name("allowed_values_attr")
            constraints = attribute.get_constraints()
        ...
        assert type(constraint) == AllowedValuesAttributeConstraint
    ...
    def test_search_options():
        try:
            entity = blueprint.create_entity("searchable-entity", entity_description="contains searchable attributes")
        except:
            entity = blueprint.get_entity_definition_by_name("searchable-entity")

        try:
            attribute = entity.create_attribute("searchable_string", AttributeType.STRING)
            search_options = attribute.get_search_options()
            assert len(search_options) == 0
        except:
            attribute = entity.get_attribute_definition_by_name("searchable_string")
            search_options = attribute.get_search_options()
        ...
        assert type(search_option) == ExactAttributeSearchOption
        ...
        assert type(search_option) == PrefixAttributeSearchOption
