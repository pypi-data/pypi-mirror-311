...
class JsonFileResource(inmanta_plugins.mitogen.abc.ResourceABC):
    fields = (
        "path",
        "permissions",
        "owner",
...
@inmanta.agent.handler.provider("fs::JsonFile", "")
class JsonFileHandler(inmanta_plugins.mitogen.abc.HandlerABC[JsonFileResource]):
