...
class ListDocumentClassificationJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/paginators/#listdocumentclassificationjobspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListDocumentClassifiersPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/paginators/#listdocumentclassifierspaginator)
    """
    def paginate(
...
class ListDominantLanguageDetectionJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/paginators/#listdominantlanguagedetectionjobspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListEndpointsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/paginators/#listendpointspaginator)
    """
    def paginate(
...
class ListEntitiesDetectionJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/paginators/#listentitiesdetectionjobspaginator)
    """
    def paginate(
        self,
...
class ListEntityRecognizersPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/paginators/#listentityrecognizerspaginator)
    """
    def paginate(
...
class ListKeyPhrasesDetectionJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/paginators/#listkeyphrasesdetectionjobspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListPiiEntitiesDetectionJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/paginators/#listpiientitiesdetectionjobspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListSentimentDetectionJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/paginators/#listsentimentdetectionjobspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListTopicsDetectionJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_comprehend/paginators/#listtopicsdetectionjobspaginator)
    """
    def paginate(
