...
class DescribeServicesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_pricing/paginators/#describeservicespaginator)
    """
    def paginate(
...
class GetAttributeValuesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_pricing/paginators/#getattributevaluespaginator)
    """
    def paginate(
...
class GetProductsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_pricing/paginators/#getproductspaginator)
    """
    def paginate(
...
class ListPriceListsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_pricing/paginators/#listpricelistspaginator)
    """
    def paginate(
