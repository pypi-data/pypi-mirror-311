...
class ForceView extends base_1.DOMWidgetView {
    ...
    buildGraphPropertiesTable(data) {
        const graphTable = (0, jquery_1.default)(this.graphPropertiesTable);
        let rows;
        if (data.hasOwnProperty("properties")) {
            rows = this.buildTableRows(data.properties);
            (0, jquery_1.default)(graphTable).empty();
            (0, jquery_1.default)(graphTable).append(...rows);
    ...
    setDetailsMessage(message) {
        (0, jquery_1.default)(this.emptyDetailsMessage).text(message);
    }
    /**
    ...
    buildActions() {
        ...
        (0, jquery_1.default)(this.detailsPanel).draggable(dragOptions);
        ...
        (0, jquery_1.default)(this.detailsPanel).resizable(resizeOptions);
