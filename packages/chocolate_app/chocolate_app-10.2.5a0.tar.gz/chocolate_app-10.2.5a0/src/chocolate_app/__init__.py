...
parser.add_argument(
    "-cv", "--video-codec", help="Video codec to use", default="libx264"
)
parser.add_argument("-ca", "--audio-codec", help="Audio codec to use", default="aac")
parser.add_argument("-f", "--ffmpeg-args", help="FFmpeg arguments to use")
...
FFMPEG_ARGS: list = ARGUMENTS.ffmpeg_args
