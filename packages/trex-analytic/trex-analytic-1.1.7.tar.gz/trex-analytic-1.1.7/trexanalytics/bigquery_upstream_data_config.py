...
def create_entitled_customer_voucher_upstream_for_merchant(customer_entitled_voucher):
    ...
    __create_upstream(data_json, merchant_acct, USER_VOUCHER_ENTITLED_TEMPLATE, MERCHANT_DATASET, final_table_name, streamed_datetime=streamed_datetime)
...
def create_revert_entitled_customer_voucher_upstream_for_merchant(customer_entitled_voucher):
    ...
    __create_upstream(data_json, merchant_acct, USER_VOUCHER_ENTITLED_REVERTED_TEMPLATE, MERCHANT_DATASET, final_table_name, streamed_datetime=streamed_datetime)    
...
def create_removed_customer_voucher_to_upstream_for_merchant(customer_entitled_voucher):
    ...
    __create_upstream(data_json, merchant_acct, USER_VOUCHER_REMOVED_TEMPLATE, MERCHANT_DATASET, final_table_name, streamed_datetime=streamed_datetime)
...
def create_redeemed_customer_voucher_to_upstream_for_merchant(customer_entitled_voucher):
    ...
    __create_upstream(data_json, merchant_acct, USER_VOUCHER_REDEEMED_TEMPLATE, MERCHANT_DATASET, final_table_name, streamed_datetime=streamed_datetime)
...
def create_revert_redeemed_customer_voucher_to_upstream_for_merchant(customer_entitled_voucher):
    ...
    __create_upstream(data_json, merchant_acct, USER_VOUCHER_REDEEMED_REVERTED_TEMPLATE, MERCHANT_DATASET, final_table_name, streamed_datetime=streamed_datetime)    
