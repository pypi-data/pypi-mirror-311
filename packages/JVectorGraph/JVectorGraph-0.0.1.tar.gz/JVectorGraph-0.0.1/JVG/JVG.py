...
class mpl_editor:
    ...
    def open_in_browser(self):
        ...
        file_path = os.path.join(self._package_path, 'vecedit.html')
        argument = "tmp.svg"  
        ...
        url_with_argument = f"http://localhost:8000/{os.path.basename(file_path)}?graph={urllib.parse.quote(argument)}"
