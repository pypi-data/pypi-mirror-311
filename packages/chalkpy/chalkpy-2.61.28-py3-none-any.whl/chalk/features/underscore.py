...
from chalk._gen.chalk.arrow.v1 import arrow_pb2
from chalk._gen.chalk.expression.v1 import expression_pb2 as expr_pb2
from chalk.features._encoding.converter import PrimitiveFeatureConverter, TPrimitive
...
def convert_pa_dtype_to_proto_expr(dtype: pa.DataType) -> expr_pb2.LogicalExprNode:
    """
    This is kind of a hack - use the 'null' literal for a dtype to convey the dtype information.
    """

    return expr_pb2.LogicalExprNode(
        literal_value=expr_pb2.ExprLiteral(
            # HACK: Using this to store a dtype. This is not really a scalar value.
            value=arrow_pb2.ScalarValue(null_value=PrimitiveFeatureConverter.convert_pa_dtype_to_proto_dtype(dtype)),
...
def convert_value_to_proto_expr(value: Any) -> expr_pb2.LogicalExprNode:
    ...
    elif isinstance(value, Underscore):
...
class UnderscoreRoot(Underscore):
    ...
    def _to_proto(self) -> expr_pb2.LogicalExprNode:
        return expr_pb2.LogicalExprNode(identifier=expr_pb2.Identifier(name="_"))
