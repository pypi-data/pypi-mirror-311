...
def execute_qlikcloud_task(appid, api_key):
    """
    ...
    tenant = dbutils.secrets.get("QLIK", "tenant")
    tenant_id = dbutils.secrets.get("QLIK", "tenant_id")
...
if __name__ == "__main__":
    app_id = sys.argv[1]
    api_key = dbutils.secrets.get("QLIK", "api_key")
