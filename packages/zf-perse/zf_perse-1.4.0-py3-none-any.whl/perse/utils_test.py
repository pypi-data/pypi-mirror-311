...
#     clean_up_beautiful_soup(soup, exclude_tags={"script", "style"})
#     assert "script" not in str(soup)
#     assert "style" not in str(soup)
#     assert "Content" in str(soup)
...
#     """
#     soup = BeautifulSoup(html, "html.parser")
#     clean_up_beautiful_soup(soup)
#     assert "img" in str(soup)
#     assert "test.jpg" in str(soup)
#     assert "empty" not in str(soup)
