...
def extract_content_tag(content: Union[str, BeautifulSoup], attribute: str, pattern: str) -> BeautifulSoup | None:
    """
    ...
    if soup.body:
        utils.extract_tag_with_content(soup.body, attribute, pattern)
