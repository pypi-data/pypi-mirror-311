...
class ListRuleGroupsNamespacesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_amp/paginators/#listrulegroupsnamespacespaginator)
    """
    def paginate(
        self,
...
class ListScrapersPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_amp/paginators/#listscraperspaginator)
    """
    def paginate(
...
class ListWorkspacesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_amp/paginators/#listworkspacespaginator)
    """
    def paginate(
