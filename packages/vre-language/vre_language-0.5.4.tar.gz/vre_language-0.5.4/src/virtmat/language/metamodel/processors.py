...
from virtmat.language.utilities.errors import raise_exception, StaticTypeError, error_handler
from virtmat.language.utilities.warnings import TextSUserWarning
from .function import function_call_processor
from .deferred import deferred_vartuple_processor
...
def general_reference_processor(obj):
    ...
    if not isinstance_m(obj.ref, classes):
...
def add_mod_processors(metamodel, constr_processors=True, io_processors=True,
    ...
    metamodel.register_model_processor(deferred_vartuple_processor)
