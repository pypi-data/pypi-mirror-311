...
def type_value(self):
    ...
    dct = {'name': name,
           'type': self.param.type_ and self.param.type_.__name__,
           'scalar': self.param.type_ and is_scalar_type(self.param.type_),
           'numeric': self.param.type_ and is_numeric_type(self.param.type_),
           'datatype': datatype}
