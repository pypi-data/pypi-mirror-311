...
def check_file_bc(fichier_py:Path):
    ...
    try:
        ...
        logging.error(_(f'The file {fichier_py} can not be impotred. Please check your code and if the file is encoded in UTF-8 or remove any accentuated character!'))
        return False
