...
def add_carbon(model, model_parameters, annualised_totex_def, time_step):
    """
    ...
    time_step : int
        The time step used for the energy system model.
    ...
    m.add_constraints(
        operation_total_carbon_emissions.sum(["area", "hour"]) <= p.carbon_goal,
