...
def export_obj(array, output_dir, file_name, voxel_size):
    ...
    default_voxel_color_map = {
        -11: [238, 242, 234],  # (light gray) 'plaster',
        -10: [56, 78, 84],  # (Dark blue) 'glass',
        -9: [147, 140, 114],  # (Light brown) 'stone',
        -8: [139, 149, 159],  # (Gray) 'metal',
        -7: [186, 187, 181],  # (Gray) 'concrete',
        -6: [248, 166, 2],  # (Orange) 'wood',
        -5: [81, 59, 56],  # (Pink) 'brick',
        -4: [255, 0, 102],  # (Pink) 'Landmark',
