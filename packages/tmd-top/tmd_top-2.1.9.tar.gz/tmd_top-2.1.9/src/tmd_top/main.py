        ...
        try:
            ...
            with ContentSwitcher(initial='details',classes="box",id="details_switcher",name="details_switcher"):
                ...
                with VerticalScroll(id="box_warning"):
                    ...
                    yield Checkbox("不再提醒",id="warning_checkbox")
                    yield Horizontal(
                        Button("[确定]",classes="yes_or_no_button",id="yes_button",variant="error"),
                        Button("[取消]",classes="yes_or_no_button",id="no_button",variant="primary")
                    )
            ...
            yield Button('[点击导出IP到当前路径下ip.txt文件]',classes='box',id='export_ip')
