...
const handler = async (req, res)=>{
    ...
    const result = await fetch(`${_kangas_config__WEBPACK_IMPORTED_MODULE_0__/* ["default"].apiUrl */ .Z.apiUrl}timestamp?${queryString}`);
...
var __webpack_exports__ = (__webpack_exec__(216202));
