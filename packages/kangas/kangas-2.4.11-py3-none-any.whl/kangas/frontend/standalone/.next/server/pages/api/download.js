...
const handler = async (req, res)=>{
    const queryString = (0,_kangas_lib_formatQueryArgs__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)({
        dgid: req.query.dgid
    });
    const result = await fetch(`${_kangas_config__WEBPACK_IMPORTED_MODULE_1__/* ["default"].apiUrl */ .Z.apiUrl}download?${queryString}`, {
        next: {
            revalidate: 100000
        }
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [726], () => (__webpack_exec__(514812)));
