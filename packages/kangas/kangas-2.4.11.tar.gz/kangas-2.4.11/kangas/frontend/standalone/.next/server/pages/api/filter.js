...
const handler = async (req, res)=>{
    const queryString = (0,_kangas_lib_formatQueryArgs__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)({
        dgid: req.query.dgid,
        timestamp: req.query.timestamp,
        whereExpr: req.query.where,
        computedColumns: req.query.computedColumns
    });
    const result = await fetch(`${_kangas_config__WEBPACK_IMPORTED_MODULE_0__/* ["default"].apiUrl */ .Z.apiUrl}verify-where?${queryString}`, {
        next: {
            revalidate: 1440
        }
    });
...
var __webpack_exports__ = (__webpack_exec__(663332));
