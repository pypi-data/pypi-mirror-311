...
class DomoAccountOAuth_Config_SnowflakeOauth(dmacnfg.DomoAccount_Config):
    ...
    def _from_json(cls, obj):
        return cls(client_id=obj["client-id"], secret=obj["client-secret"])
...
class DomoAccountOAuth_Config_JiraOnPremOauth(dmacnfg.DomoAccount_Config):
    ...
    @classmethod
    def _from_json(cls, obj):
        return cls(client_id=obj["client_id"], secret=obj["client_secret"])
...
# %% ../../nbs/classes/50_DomoAccount_OAuth.ipynb 12
@patch_to(DomoAccount_OAuth)
