...
# %% auto 0
__all__ = ['Account_GET_Error', 'get_accounts', 'get_oauth_accounts', 'Account_NoMatch', 'get_account_by_id',
           'get_oauth_account_by_id', 'get_account_config', 'get_oauth_account_config', 'Account_CRUD_Error',
           'Account_CreateParams_Error', 'generate_create_account_body', 'create_account', 'delete_account',
           'generate_create_oauth_account_body', 'create_oauth_account', 'delete_oauth_account', 'Account_Config_Error',
           'update_account_config', 'update_oauth_account_config', 'update_account_name', 'update_oauth_account_name',
           'get_account_accesslist', 'get_oauth_account_accesslist', 'ShareAccount', 'ShareAccount_V1_AccessLevel',
           'ShareAccount_AccessLevel', 'Account_Share_Error', 'Account_AlreadyShared_Error', 'share_account',
           'share_oauth_account', 'share_account_v1']
...
def generate_create_account_body(account_name, data_provider_type, config):
    return {
...
async def create_account(
    ...
    if not create_body and not (account_name and data_provider_type and config):
        raise Account_CreateParams_Error(
            message="if not passing complete create_body must pass account_name,data_provider_type, and config"
        )

    create_body = create_body or generate_create_account_body(
...
async def delete_account(
    ...
    if not res.is_success:
        raise Account_CRUD_Error(
            entity_id=account_id,
            res=res,
            message=f"unable to delete account {res.response}",
        )
