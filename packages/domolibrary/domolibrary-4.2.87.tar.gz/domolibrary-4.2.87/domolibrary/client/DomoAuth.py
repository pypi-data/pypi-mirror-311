...
class DomoAuth:
    ...
    async def print_is_token(self, debug_api : bool = False,  token_name=None) -> bool:
        self.token_name = token_name or self.token_name

        if not self.token:
            await self.get_auth_token(debug_api = debug_api)
...
class DomoDeveloperAuth(DomoAuth):
    ...
    def __init__(self, domo_client_id, domo_client_secret, token_name: str = None,  domo_instance :str = None):
