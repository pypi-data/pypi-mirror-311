...
async def get(
    ...
    if self.is_hide_system_groups is None:
        await self.get_is_system_groups_visible(
            session=session,
            debug_api=debug_api,
