...
async def upsert_domo_group(
    ...
    is_search_system_accounts : bool = True,
    debug_api : bool = False) -> dmdg.DomoGroup:
    ...
    domo_group_owners = await search_domo_groups_by_name(auth = auth,
...
async def search_or_upsert_domo_group(auth,
                                  group_name,
                                  upsert_if_not_exist : bool = True, 
                                  group_type = dmdg.GroupType_Enum["CLOSED"].value,
                                  debug_api :bool = False,
                                  is_search_system_accounts : bool = True) -> dmdg.DomoGroup:
    try:
        domo_groups =  await search_domo_groups_by_name(group_names=[group_name],
                                                auth=auth, 
                                                is_search_system_accounts =is_search_system_accounts,
                                               )
...
async def share_domo_account_with_domo_group(
    ...
    return await domo_account._share_v2(
