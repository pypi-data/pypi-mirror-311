        ...
        try:
            if self._has_change(uri, **data):
                ...
                if not sort_keys:
                    ...
                    if not (sort_keys := SortKeyFinder.find_sort_key(stream=[data])):
                ...
                for exists in existing2:
                    existing_sort_blueprint = build_dict(exists, sort_keys)
                ...
                resuming_info = {k: kw[k] for k in kw.get(SORT_KEY, [])}
