...
from granslate.utils import rshift
...
class TokenAcquirer(object):
    ...
    async def _update(self):  # sourcery skip: low-code-quality, raise-specific-error
        """update tkk"""
    ...
    def acquire(self, text):  # sourcery skip: low-code-quality
        a = []
