...
[aiobotocore 2.15.2](https://pypi.org/project/aiobotocore/) compatible with
...
- `types-aiobotocore-lite[full]` - Type annotations for all 387 services in one
  package (recommended).
- `types-aiobotocore-lite[all]` - Type annotations for all 387 services in
  separate packages.
