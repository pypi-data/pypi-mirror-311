...
setup(
    name="sportnews-api",
    version="0.1.1",  # Incrémentez la version pour la nouvelle publication
    author="Stefen",  # Votre nom réel
    author_email="votre.email@domain.com",  # Votre email professionnel
    description="SDK Python officiel pour l'API SportNews - Accédez aux actualités sportives en temps réel",
