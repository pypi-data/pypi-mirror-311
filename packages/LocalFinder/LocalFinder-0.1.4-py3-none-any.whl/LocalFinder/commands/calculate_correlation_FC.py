...
from utils import localPearson_and_FC, localWeightedPearson_and_FC, localSpearman_and_FC, localWeightedSpearman_and_FC, localMI_and_FC
...
def main(args=None):
    if args is None:
        ...
        parser.add_argument('--method', type=str, default='localPearson_and_FC', help='Method to use for processing (e.g., localPearson_and_FC)')
        parser.add_argument('--method_params', type=str, default='{}', help='Method-specific parameters in JSON format')
    ...
    method_functions = {
        ...
        'localSpearman_and_FC': localPearson_and_FC,
        'localWeightedSpearman_and_FC': localWeightedPearson_and_FC,
