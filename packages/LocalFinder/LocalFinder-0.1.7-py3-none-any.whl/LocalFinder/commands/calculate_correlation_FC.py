...
def main(args=None):
    if args is None:
        ...
        parser.add_argument('--method', type=str, choices=[
            'localPearson_and_FC', 'localWeightedPearson_and_FC', 'localSpearman_and_FC',
            'localWeightedSpearman_and_FC', 'localMI_and_FC'
        ], default='localPearson_and_FC', help='Method to use for processing (e.g., localPearson_and_FC)')
