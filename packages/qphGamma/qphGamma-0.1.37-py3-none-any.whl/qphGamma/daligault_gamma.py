...
class DaligaultGamma:
    ...
    def get_gamma(self):
        ...
        # 1/fs
        E_mu_list = self.E - get_mu(self.n, self.theta, self.theta_cutoff) * J_to_eV

        E_gamma = np.array([E_mu_list, gamma_list]).T  # eV and 1/fs
        #! BR add mu - remove this...
        return E_gamma, get_mu(self.n, self.theta, self.theta_cutoff) * J_to_eV
