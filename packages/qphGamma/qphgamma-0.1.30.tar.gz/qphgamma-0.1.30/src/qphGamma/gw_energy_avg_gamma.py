...
class GWAvgGamma:
    ...
    def __init__(self, file, dos_file=None, n=-1, core_E=-50) -> None:
        ...
        Args:
            ...
            n (int, optional): scf step, defaults to -1.
            core_E (float, optional): cutoff (below) energy in eV that gets rid of core states - especially useful for integration
        ...
        gw_data = GWGamma(file, self.n, self.core_E)
