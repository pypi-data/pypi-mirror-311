...
class Command(BaseCommand):
    ...
    def handle(self, options: argparse.Namespace) -> None:
       ...
       # Obtiene la carpeta anterior al directorio actual
        ...
        print("el flutter bootstrap ya se crea con el build3, tengan cuidado", end="")
        ...
        manifestandroid = os.path.join(parent_dir, 'mi_template', 'docs_adicionales', 'app', 'AndroidManifest.xml')
        ...
        copiar_archivo(manifestandroid, flutter_manifestandroid)
