...
TEMPLATE_PARAMS = {
    ...
    "target_column": "class",
    "feature_list": ['apol', 'balabanj', 'bcut2d_chghi', 'bcut2d_chglo', 'bcut2d_logphi', 'bcut2d_logplow', 'bcut2d_mrhi', 'bcut2d_mrlow', 'bcut2d_mwhi', 'bcut2d_mwlow', 'bertzct', 'bpol', 'chi0', 'chi0n', 'chi0v', 'chi1', 'chi1n', 'chi1v', 'chi2n', 'chi2v', 'chi3n', 'chi3v', 'chi4n', 'chi4v', 'estate_vsa1', 'estate_vsa10', 'estate_vsa11', 'estate_vsa2', 'estate_vsa3', 'estate_vsa4', 'estate_vsa5', 'estate_vsa6', 'estate_vsa7', 'estate_vsa8', 'estate_vsa9', 'exactmolwt', 'fpdensitymorgan1', 'fpdensitymorgan2', 'fpdensitymorgan3', 'fr_al_coo', 'fr_al_oh', 'fr_al_oh_notert', 'fr_aldehyde', 'fr_alkyl_carbamate', 'fr_alkyl_halide', 'fr_allylic_oxid', 'fr_amide', 'fr_amidine', 'fr_aniline', 'fr_ar_coo', 'fr_ar_n', 'fr_ar_nh', 'fr_ar_oh', 'fr_arn', 'fr_aryl_methyl', 'fr_azide', 'fr_azo', 'fr_barbitur', 'fr_benzene', 'fr_benzodiazepine', 'fr_bicyclic', 'fr_c_o', 'fr_c_o_nocoo', 'fr_c_s', 'fr_coo', 'fr_coo2', 'fr_diazo', 'fr_dihydropyridine', 'fr_epoxide', 'fr_ester', 'fr_ether', 'fr_furan', 'fr_guanido', 'fr_halogen', 'fr_hdrzine', 'fr_hdrzone', 'fr_hoccn', 'fr_imidazole', 'fr_imide', 'fr_imine', 'fr_isocyan', 'fr_isothiocyan', 'fr_ketone', 'fr_ketone_topliss', 'fr_lactam', 'fr_lactone', 'fr_methoxy', 'fr_morpholine', 'fr_n_o', 'fr_ndealkylation1', 'fr_ndealkylation2', 'fr_nh0', 'fr_nh1', 'fr_nh2', 'fr_nhpyrrole', 'fr_nitrile', 'fr_nitro', 'fr_nitro_arom', 'fr_nitro_arom_nonortho', 'fr_nitroso', 'fr_oxazole', 'fr_oxime', 'fr_para_hydroxylation', 'fr_phenol', 'fr_phenol_noorthohbond', 'fr_phos_acid', 'fr_phos_ester', 'fr_piperdine', 'fr_piperzine', 'fr_priamide', 'fr_prisulfonamd', 'fr_pyridine', 'fr_quatn', 'fr_sh', 'fr_sulfide', 'fr_sulfonamd', 'fr_sulfone', 'fr_term_acetylene', 'fr_tetrazole', 'fr_thiazole', 'fr_thiocyan', 'fr_thiophene', 'fr_unbrch_alkane', 'fr_urea', 'fractioncsp3', 'hallkieralpha', 'heavyatomcount', 'heavyatommolwt', 'kappa1', 'kappa2', 'kappa3', 'labuteasa', 'maxabsestateindex', 'maxabspartialcharge', 'maxestateindex', 'maxpartialcharge', 'minabsestateindex', 'minabspartialcharge', 'minestateindex', 'minpartialcharge', 'mollogp', 'molmr', 'molwt', 'nacid', 'naromatom', 'narombond', 'nbase', 'nhohcount', 'nocount', 'nrot', 'numaliphaticcarbocycles', 'numaliphaticheterocycles', 'numaliphaticrings', 'numaromaticcarbocycles', 'numaromaticheterocycles', 'numaromaticrings', 'numhacceptors', 'numhdonors', 'numheteroatoms', 'numradicalelectrons', 'numrotatablebonds', 'numsaturatedcarbocycles', 'numsaturatedheterocycles', 'numsaturatedrings', 'numvalenceelectrons', 'peoe_vsa1', 'peoe_vsa10', 'peoe_vsa11', 'peoe_vsa12', 'peoe_vsa13', 'peoe_vsa14', 'peoe_vsa2', 'peoe_vsa3', 'peoe_vsa4', 'peoe_vsa5', 'peoe_vsa6', 'peoe_vsa7', 'peoe_vsa8', 'peoe_vsa9', 'q_c_max', 'q_c_min', 'q_h_max', 'q_h_min', 'q_kurtosis', 'q_kurtosis_x_q_max', 'q_kurtosis_x_q_mean', 'q_kurtosis_x_q_median', 'q_kurtosis_x_q_min', 'q_kurtosis_x_q_skew', 'q_kurtosis_x_q_span', 'q_kurtosis_x_q_std', 'q_kurtosis_2', 'q_max', 'q_max_x_q_mean', 'q_max_x_q_median', 'q_max_x_q_min', 'q_max_x_q_skew', 'q_max_x_q_span', 'q_max_x_q_std', 'q_max_2', 'q_mean', 'q_mean_x_q_median', 'q_mean_x_q_min', 'q_mean_x_q_skew', 'q_mean_x_q_span', 'q_mean_x_q_std', 'q_mean_2', 'q_median', 'q_median_x_q_min', 'q_median_x_q_skew', 'q_median_x_q_span', 'q_median_x_q_std', 'q_median_2', 'q_min', 'q_min_x_q_skew', 'q_min_x_q_span', 'q_min_x_q_std', 'q_min_2', 'q_n_max', 'q_n_min', 'q_o_max', 'q_o_min', 'q_p_max', 'q_p_min', 'q_s_max', 'q_s_min', 'q_skew', 'q_skew_x_q_span', 'q_skew_x_q_std', 'q_skew_2', 'q_span', 'q_span_x_q_std', 'q_span_2', 'q_std', 'q_std_2', 'qed', 'ringcount', 'rotratio', 'slogp_vsa1', 'slogp_vsa10', 'slogp_vsa11', 'slogp_vsa12', 'slogp_vsa2', 'slogp_vsa3', 'slogp_vsa4', 'slogp_vsa5', 'slogp_vsa6', 'slogp_vsa7', 'slogp_vsa8', 'slogp_vsa9', 'smr_vsa1', 'smr_vsa10', 'smr_vsa2', 'smr_vsa3', 'smr_vsa4', 'smr_vsa5', 'smr_vsa6', 'smr_vsa7', 'smr_vsa8', 'smr_vsa9', 'tpsa', 'vsa_estate1', 'vsa_estate10', 'vsa_estate2', 'vsa_estate3', 'vsa_estate4', 'vsa_estate5', 'vsa_estate6', 'vsa_estate7', 'vsa_estate8', 'vsa_estate9'],
    "model_metrics_s3_path": "s3://ideaya-sageworks-bucket/models/training/pka-a1-class-0-walden-poly2-class",
