...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CLOUDSERVICE.methods_by_name['create']._serialized_options = b'\202\323\344\223\002\036\"\034/inventory/v1/cloud-services'
  _CLOUDSERVICE.methods_by_name['update']._options = None
  _CLOUDSERVICE.methods_by_name['update']._serialized_options = b'\202\323\344\223\0020\032./inventory/v1/cloud-service/{cloud_service_id}'
  _CLOUDSERVICE.methods_by_name['delete']._options = None
  _CLOUDSERVICE.methods_by_name['delete']._serialized_options = b'\202\323\344\223\0020*./inventory/v1/cloud-service/{cloud_service_id}'
  _CLOUDSERVICE.methods_by_name['get']._options = None
  _CLOUDSERVICE.methods_by_name['get']._serialized_options = b'\202\323\344\223\0020\022./inventory/v1/cloud-service/{cloud_service_id}'
  _CLOUDSERVICE.methods_by_name['list']._options = None
  _CLOUDSERVICE.methods_by_name['list']._serialized_options = b'\202\323\344\223\002E\022\034/inventory/v1/cloud-servicesZ%\"#/inventory/v1/cloud-services/search'
  _CLOUDSERVICE.methods_by_name['stat']._options = None
  _CLOUDSERVICE.methods_by_name['stat']._serialized_options = b'\202\323\344\223\002#\"!/inventory/v1/cloud-services/stat'
  _CLOUDSERVICEREFERENCE._serialized_start=199
  _CLOUDSERVICEREFERENCE._serialized_end=266
  _CREATESERVICEREQUEST._serialized_start=269
  _CREATESERVICEREQUEST._serialized_end=715
  _UPDATECLOUDSERVICEREQUEST._serialized_start=718
  _UPDATECLOUDSERVICEREQUEST._serialized_end=1169
  _PINCLOUDSERVICEDATAREQUEST._serialized_start=1171
  _PINCLOUDSERVICEDATAREQUEST._serialized_end=1258
  _CLOUDSERVICEREQUEST._serialized_start=1260
  _CLOUDSERVICEREQUEST._serialized_end=1326
  _GETCLOUDSERVICEREQUEST._serialized_start=1328
  _GETCLOUDSERVICEREQUEST._serialized_end=1411
  _CLOUDSERVICEQUERY._serialized_start=1414
  _CLOUDSERVICEQUERY._serialized_end=1780
  _CLOUDSERVICEINFO._serialized_start=1783
  _CLOUDSERVICEINFO._serialized_end=2376
  _CLOUDSERVICESINFO._serialized_start=2378
  _CLOUDSERVICESINFO._serialized_end=2480
  _CLOUDSERVICESTATQUERY._serialized_start=2482
  _CLOUDSERVICESTATQUERY._serialized_end=2605
  _CLOUDSERVICE._serialized_start=2608
  _CLOUDSERVICE._serialized_end=3534
