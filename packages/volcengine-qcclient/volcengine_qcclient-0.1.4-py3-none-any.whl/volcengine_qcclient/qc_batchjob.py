...
class QcBatchJob:
            ...
            for file_name in os.listdir(from_dir):
                if file_name.endswith('.xyz'):
                    ...
                    with open(file_path, 'r') as file:
                        ...
                        self.molecules.append(xyz_content)
    ...
    def submit(self, task_type: str, task_config: dict) -> List[str]:
        qc_tasks = []
        for molecule in self.molecules:
            qc_tasks.append({
                "MoleculeXyzData": encode_base64(molecule),
