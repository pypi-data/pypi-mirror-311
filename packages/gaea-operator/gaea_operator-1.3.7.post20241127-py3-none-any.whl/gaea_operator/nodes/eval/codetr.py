...
from gaea_operator.config import CoDETRConfig
...
def codetr_eval(args):
    ...
    # 4. 生成评估配置文件
    CoDETRConfig(windmill_client=windmill_client, tracker_client=tracker_client).write_eval_config(
