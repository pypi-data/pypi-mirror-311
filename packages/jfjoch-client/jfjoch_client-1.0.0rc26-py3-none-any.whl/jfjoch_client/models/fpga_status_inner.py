...
class FpgaStatusInner(BaseModel):
    ...
    idle: StrictBool
    __properties: ClassVar[List[str]] = ["pci_dev_id", "serial_number", "fw_version", "base_mac_addr", "eth_link_count", "eth_link_status", "power_usage_W", "fpga_temp_C", "hbm_temp_C", "packets_udp", "packets_sls", "idle"]
