...
class TestDefaultApi(unittest.TestCase):
    ...
    def test_roi_box_get(self) -> None:
        """Test case for roi_box_get

        Get box ROIs
        """
        pass

    def test_roi_box_put(self) -> None:
        """Test case for roi_box_put

        Upload box ROIs
        """
        pass

    def test_roi_circle_get(self) -> None:
        """Test case for roi_circle_get

        Get circular ROI
        """
        pass

    def test_roi_circle_put(self) -> None:
        """Test case for roi_circle_put
