...
class JfjochStatistics(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["detector", "detector_list", "detector_settings", "image_format_settings", "instrument_metadata", "data_processing_settings", "measurement", "broker", "fpga", "calibration", "zeromq_preview", "zeromq_metadata", "pixel_mask"]
