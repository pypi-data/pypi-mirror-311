...
class TestSqlUtil:
    ...
    def test_generate_select_sql(self):
        print(generate_select_sql('ncpcs_nlp', 'nc_medical_record_extract'))

    def test_generate_insert_sql(self):
        print(generate_insert_sql('ncpcs_nlp', 'nc_dataset'))

    def test_generate_batch_insert_sql(self):
        print(generate_batch_insert_sql('ncpcs_nlp', 'nc_dataset_distribution'))
