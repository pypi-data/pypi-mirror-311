...
STEPS = OrderedDict({
    ...
    "Fortifai is running...": {"Success": ["Terminate Application: Set Exit Flag", "Shutdown app command received"], "Failed": []},
    "Fortifai is exiting...": {"Success": ["Fortifai stopped...", "Terminate Application: Force Interrupt", "Shutdown app command received"], "Failed": []}
})
STEPS_LIST = []
