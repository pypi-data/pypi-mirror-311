...
import ImagePreview from './ImagePreview-Da558AqD.js';
import { B as Block, S as Static, U as UploadText, g as Empty, f as Image, b as StreamingBar, e as BlockLabel, h as IconButtonWrapper, i as IconButton, M as Maximize, _ as Clear, k as SelectSource, ab as Webcam$2 } from './2-DuF4BbEW.js';
import { U as Upload } from './ModifyUpload-D6pNkPjc.js';
...
const ImageUploader = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(BlockLabel, "BlockLabel").$$render(
      ...
      default: () => {
        return `${value?.url && !active_streaming ? `${show_fullscreen_button ? `${validate_component(IconButton, "IconButton").$$render(
          $$result,
          {
            Icon: Maximize,
          ...
          {},
          {}
        )}` : ``} ${``} ${validate_component(IconButton, "IconButton").$$render($$result, { Icon: Clear, label: "Remove Image" }, {}, {})}` : ``}`;
      }
    })} <div class="${[
...
//# sourceMappingURL=Index22-C0O_wT9N.js.map
