...
import { e as BlockLabel, f as Image, g as Empty, h as IconButtonWrapper, i as IconButton, D as Download, M as Maximize, a5 as Minimize, o as ShareButton, _ as Clear, u as uploadToHuggingFace, t as Play } from './2-DuF4BbEW.js';
import { M as ModifyUpload } from './ModifyUpload-D6pNkPjc.js';
...
const Gallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}` : `<div class="gallery-container"${add_attribute("this", gallery_container, 0)}>${selected_media && allow_preview ? `<button class="${["preview svelte-842rpi", mode === "minimal" ? "minimal" : ""].join(" ").trim()}">${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
      return `${show_download_button ? `${validate_component(IconButton, "IconButton").$$render(
        ...
        {},
        {}
      )}` : ``} ${show_share_button ? `<div class="icon-button">${validate_component(ShareButton, "ShareButton").$$render(
        $$result,
        {
          i18n,
          value: resolved_value,
...
//# sourceMappingURL=Gallery--cz1mQ5L.js.map
