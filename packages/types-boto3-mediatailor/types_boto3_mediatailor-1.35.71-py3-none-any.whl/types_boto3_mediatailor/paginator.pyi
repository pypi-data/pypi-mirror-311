...
class GetChannelSchedulePaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediatailor/paginators/#getchannelschedulepaginator)
    """
    def paginate(
...
class ListAlertsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediatailor/paginators/#listalertspaginator)
    """
    def paginate(
...
class ListChannelsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediatailor/paginators/#listchannelspaginator)
    """
    def paginate(
...
class ListLiveSourcesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediatailor/paginators/#listlivesourcespaginator)
    """
    def paginate(
...
class ListPlaybackConfigurationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediatailor/paginators/#listplaybackconfigurationspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListPrefetchSchedulesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediatailor/paginators/#listprefetchschedulespaginator)
    """
    def paginate(
...
class ListSourceLocationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediatailor/paginators/#listsourcelocationspaginator)
    """
    def paginate(
...
class ListVodSourcesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediatailor/paginators/#listvodsourcespaginator)
    """
    def paginate(
