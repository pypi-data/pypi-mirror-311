...
from regscale.integrations.commercial.veracode import veracode
...
model = import_command_with_timing("regscale.core.app.internal.model_editor", "model")
...
criticality_updater = import_command_with_timing(
    "regscale.integrations.public.criticality_updater", "criticality_updater"
)
...
durosuite = import_command_with_timing("regscale.integrations.commercial.durosuite", "durosuite")
...
ibm = import_command_with_timing("regscale.integrations.commercial.ibm", "ibm")
...
tenable = import_command_with_timing("regscale.integrations.commercial.sap.tenable.click", "tenable")
...
stig_mapper = import_command_with_timing("regscale.integrations.commercial.stig_mapper", "stig_mapper")
...
tenable = import_command_with_timing("regscale.integrations.commercial.tenablev2.click", "tenable")
wiz = import_command_with_timing("regscale.integrations.commercial.wizv2.click", "wiz")
