...
from regscale.core.app.public.fedramp.properties import parse_and_post_property
from regscale.core.app.utils.api_handler import APIHandler
from regscale.models.regscale_models.asset import Asset
from regscale.models.regscale_models.properties import Properties
    ...
    try:
        ...
        for inventory_item in inventory_items:
            ...
            if implemented_components:
                # item["implemented_components"]["components"] = []
                item["components"] = []
                ...
                for imp_component in implemented_components:
                    ...
                    # module = comp.get("module") if comp else None
