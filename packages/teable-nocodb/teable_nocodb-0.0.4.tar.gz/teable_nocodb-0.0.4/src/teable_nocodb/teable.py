...
class Table:
    ...
    def to_dict(
        self,
    ) -> dict[str, str | list[dict[str, str | dict[str, list[dict[str, str]]]]]]:
        return {
            "name": self.name,
...
class SingleSelectOptions:
    def __init__(self, choices: list[dict[str, str]], **kwargs) -> None:
...
class DateOptions:
    def __init__(
        self, date: str, time: str = "None", timezone: str = "utc", **kwargs
    ) -> None:
        self.date = date
        self.time = time
...
class Field:
    def __init__(
        ...
        options: dict[str, Any] | SingleSelectOptions | DateOptions,
