...
PROTOBUF_EXPORT extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_xla_2fservice_2fgpu_2fmodel_2fhlo_5fop_5fprofile_2eproto;
namespace xla {
namespace gpu {
...
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_EXPORT ::xla::gpu::DeviceHloInstructionProfiles* Arena::CreateMaybeMessage<::xla::gpu::DeviceHloInstructionProfiles>(Arena*);
template<> PROTOBUF_EXPORT ::xla::gpu::DeviceHloInstructionProfiles_EntriesEntry_DoNotUse* Arena::CreateMaybeMessage<::xla::gpu::DeviceHloInstructionProfiles_EntriesEntry_DoNotUse>(Arena*);
template<> PROTOBUF_EXPORT ::xla::gpu::HloInstructionProfile* Arena::CreateMaybeMessage<::xla::gpu::HloInstructionProfile>(Arena*);
template<> PROTOBUF_EXPORT ::xla::gpu::HloInstructionProfileList* Arena::CreateMaybeMessage<::xla::gpu::HloInstructionProfileList>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace xla {
namespace gpu {
...
class PROTOBUF_EXPORT HloInstructionProfile final :
...
class PROTOBUF_EXPORT HloInstructionProfileList final :
...
class PROTOBUF_EXPORT DeviceHloInstructionProfiles final :
