...
class ExtendedKalmanFilterEstimationConfiguration(EstimationConfiguration):
    """
    Configuration for Extended Kalman Filter estimation
    """ # noqa: E501
    ...
    extended_kalman_filter_configuration: Optional[ExtendedKalmanFilterConfiguration] = Field(default=None, alias="extendedKalmanFilterConfiguration")
    __properties: ClassVar[List[str]] = ["estimatorType", "orbitEstimationRequest", "dragCoefficientEstimationRequest", "reflectivityCoefficientEstimationRequest", "satelliteClockOffsetEstimationRequest", "thrustScaleFactorsEstimationRequest", "extendedKalmanFilterConfiguration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtendedKalmanFilterEstimationConfiguration from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of extended_kalman_filter_configuration
        if self.extended_kalman_filter_configuration:
            _dict['extendedKalmanFilterConfiguration'] = self.extended_kalman_filter_configuration.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtendedKalmanFilterEstimationConfiguration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "extendedKalmanFilterConfiguration": ExtendedKalmanFilterConfiguration.from_dict(obj["extendedKalmanFilterConfiguration"]) if obj.get("extendedKalmanFilterConfiguration") is not None else None
        })
        return _obj
