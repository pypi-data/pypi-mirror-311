...
class DeprecatedKalmanResult(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["outputOsculatingOrbits", "outputMeanOrbits", "outputDatedCovarianceMatrices", "outputModelParameters", "outputResiduals", "finalUncertainties"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeprecatedKalmanResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeprecatedKalmanResult from a dict"""
        if obj is None:
            return None
