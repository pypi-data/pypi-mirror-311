...
class AttitudeLaw(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[EarthOrientedManeuverAttitudeLaw, InterpolatedLocalFrameAttitudeLaw, LocalFrameAttitudeLaw, NadirPointingLaw, SunEnhancedManeuverAttitudeLaw, SunPointingLaw]]:
        ...
        if object_type ==  'InterpolatedLocalFrameAttitudeLaw':
            return import_module("spacetower_orbit_determination_python_client.models.interpolated_local_frame_attitude_law").InterpolatedLocalFrameAttitudeLaw.from_dict(obj)
        if object_type ==  'LocalFrameAttitudeLaw':
            return import_module("spacetower_orbit_determination_python_client.models.local_frame_attitude_law").LocalFrameAttitudeLaw.from_dict(obj)
