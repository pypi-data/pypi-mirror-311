...
class NumericalAprioriResidualsComputationRequestCommonFields(BaseModel):
    """
    NumericalAprioriResidualsComputationRequestCommonFields
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["measurements", "normalizeResiduals", "data", "simulationConfiguration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NumericalAprioriResidualsComputationRequestCommonFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NumericalAprioriResidualsComputationRequestCommonFields from a dict"""
        if obj is None:
            return None
