...
class DatedAprioriResiduals(BaseModel):
    """
    Dated list of residual datasets with field descriptions
    """ # noqa: E501
    residuals: Optional[List[List[Union[StrictFloat, StrictInt]]]] = None
    ...
    __properties: ClassVar[List[str]] = ["residuals", "dates", "normalizationFlag", "description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatedAprioriResiduals from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatedAprioriResiduals from a dict"""
        if obj is None:
            return None
