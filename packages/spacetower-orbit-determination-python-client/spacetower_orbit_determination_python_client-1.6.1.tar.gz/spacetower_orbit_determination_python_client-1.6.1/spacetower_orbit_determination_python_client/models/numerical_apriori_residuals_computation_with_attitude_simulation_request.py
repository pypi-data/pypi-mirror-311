...
class NumericalAprioriResidualsComputationWithAttitudeSimulationRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["measurements", "normalizeResiduals", "data", "simulationConfiguration", "initialGuess", "maneuverSchedule", "attitudeSequence"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NumericalAprioriResidualsComputationWithAttitudeSimulationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NumericalAprioriResidualsComputationWithAttitudeSimulationRequest from a dict"""
        if obj is None:
            return None
