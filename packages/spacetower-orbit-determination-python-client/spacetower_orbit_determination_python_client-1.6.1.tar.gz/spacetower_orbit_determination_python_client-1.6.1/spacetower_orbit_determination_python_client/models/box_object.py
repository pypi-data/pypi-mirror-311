...
class BoxObject(SpaceObject):
    ...
    __properties: ClassVar[List[str]] = ["mass", "dragCoefficient", "propulsionSystem", "clockOffset", "spaceObjectType", "xDimension", "yDimension", "zDimension", "radiationCoefficients", "radiationCorrectionFactor", "solarArrayGeometry"]
