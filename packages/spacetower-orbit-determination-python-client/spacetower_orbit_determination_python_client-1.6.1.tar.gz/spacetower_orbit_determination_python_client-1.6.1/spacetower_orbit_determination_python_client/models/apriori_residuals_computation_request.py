...
class AprioriResidualsComputationRequest(BaseModel):
    """
    AprioriResidualsComputationRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["measurements", "normalizeResiduals", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AprioriResidualsComputationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AprioriResidualsComputationRequest from a dict"""
        if obj is None:
            return None
