...
class BatchResiduals(BaseModel):
    """
    Residuals from batch least squares estimation
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["dates", "normalizationFlag", "rejectionStatus", "description", "residuals"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchResiduals from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchResiduals from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "dates": obj.get("dates"),
            "normalizationFlag": obj.get("normalizationFlag"),
            ...
            "residuals": Residuals.from_dict(obj["residuals"]) if obj.get("residuals") is not None else None
        })
        return _obj
