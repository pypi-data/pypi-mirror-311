...
class OutputCovarianceConfiguration(BaseModel):
    """
    Configuration for output the estimated final orbital covariances. 
    """ # noqa: E501
    orbit_type: CovarianceOrbitType = Field(alias="orbitType")
    anomaly_type: Optional[AnomalyType] = Field(default=None, alias="anomalyType")
    frame_id: Optional[CartesianCovarianceFrameId] = Field(default=None, alias="frameId")
    __properties: ClassVar[List[str]] = ["orbitType", "anomalyType", "frameId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OutputCovarianceConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OutputCovarianceConfiguration from a dict"""
        if obj is None:
            return None
