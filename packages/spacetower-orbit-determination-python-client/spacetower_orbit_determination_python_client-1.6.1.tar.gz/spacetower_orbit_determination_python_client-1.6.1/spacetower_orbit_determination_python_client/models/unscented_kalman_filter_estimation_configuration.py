...
class UnscentedKalmanFilterEstimationConfiguration(EstimationConfiguration):
    ...
    __properties: ClassVar[List[str]] = ["estimatorType", "orbitEstimationRequest", "dragCoefficientEstimationRequest", "reflectivityCoefficientEstimationRequest", "satelliteClockOffsetEstimationRequest", "thrustScaleFactorsEstimationRequest", "unscentedKalmanFilterConfiguration"]
