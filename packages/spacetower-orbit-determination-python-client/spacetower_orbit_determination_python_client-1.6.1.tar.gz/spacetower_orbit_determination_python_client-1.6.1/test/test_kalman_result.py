...
class TestKalmanResult(unittest.TestCase):
    """KalmanResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KalmanResult:
        """Test KalmanResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KalmanResult`
        """
        model = KalmanResult()
        if include_optional:
            return KalmanResult(
