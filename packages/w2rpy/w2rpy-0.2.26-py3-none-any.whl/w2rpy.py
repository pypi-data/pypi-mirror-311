...
def create_REM(dem, xs, output, Zcol=None, sample_dist=3, smooth_window=5, buffer=1000, limits=[-50, 50], method='min', vb=None, wse_path=None, save_xs=None):
    """
...
def pebble_count(photos, obj_size_mm, method='rapid'):
    """
    ...
    def draw_polygon(image):
        ...
        props = regionprops_table(mask_arr, properties=('major_axis_length', 'minor_axis_length'))
        ref_obj_pixels = props['major_axis_length'][0]
    
        return ref_obj_pixels,mask_arr
    ...
    for photo_file in photos:
        ...
        ref_pixels,ref_mask = draw_polygon(image)
