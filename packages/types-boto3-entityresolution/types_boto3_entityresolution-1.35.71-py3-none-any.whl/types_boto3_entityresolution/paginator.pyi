...
class ListIdMappingJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_entityresolution/paginators/#listidmappingjobspaginator)
    """
    def paginate(
...
class ListIdMappingWorkflowsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_entityresolution/paginators/#listidmappingworkflowspaginator)
    """
    def paginate(
...
class ListIdNamespacesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_entityresolution/paginators/#listidnamespacespaginator)
    """
    def paginate(
...
class ListMatchingJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_entityresolution/paginators/#listmatchingjobspaginator)
    """
    def paginate(
...
class ListMatchingWorkflowsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_entityresolution/paginators/#listmatchingworkflowspaginator)
    """
    def paginate(
...
class ListProviderServicesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_entityresolution/paginators/#listproviderservicespaginator)
    """
    def paginate(
...
class ListSchemaMappingsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_entityresolution/paginators/#listschemamappingspaginator)
    """
    def paginate(
