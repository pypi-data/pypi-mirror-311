...
class LoggedArtifactAsset(object):
    ...
    def download(
        ...
        Returns:
            ArtifactAsset: The artifact asset downloaded
...
class Artifact(object):
    def __init__(
        ...
        Args:
            name (str): The artifact name. Exceeding 100 characters length will cause an exception.
            artifact_type (str): The artifact-type, for example `dataset`.
            version (str): The version number to create. If not provided, a new version number
                will be created automatically.
            aliases (Iterable[str]): Some aliases to attach to the future Artifact
