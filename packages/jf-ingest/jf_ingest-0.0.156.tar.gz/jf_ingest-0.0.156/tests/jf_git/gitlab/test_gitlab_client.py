...
from tests.jf_git.gitlab.utils import EXPECTED_AUTH_HEADER, TEST_BASE_GQL_URL, TEST_BASE_URL, TEST_COMPANY_SLUG, TEST_TOKEN, get_fixture_data, spoof_organizations_through_gql, spoof_repositories_through_gql
...
def test_get_organizations_with_gql(client: GitlabClient, requests_mock: requests_mock.Mocker):
    ...
    organizations = [o for o in client.get_organizations()]
...
def test_get_repositories_with_gql(client: GitlabClient, requests_mock: requests_mock.Mocker):
    ...
    repos = [o for o in client.get_repos(group_full_path='')]
