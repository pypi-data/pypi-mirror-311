...
from doipy.dtr_utils import get_connection, get_service_id
...
def move_fdo(user_input: dict):
    ...
    service_id_source, ip_source, port_source = get_connection(service_id_source)
    service_id_destination = get_service_id(fdo_service_ref_destination)
    service_id_destination, ip_destination, port_destination = get_connection(service_id_destination)
