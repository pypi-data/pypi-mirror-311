...
from doipy.constants import DOIPOperation, DOType, DOTypeIdentifier, ResponseStatus
...
def create(target_id: str, ip: str, port: int, do_type: str = DOType.DO.value, do_name: str = 'Digital Object',
           do_identifier: str = None, bitsq: Path = None, metadata: dict = None, username: str = None,
    ...
    message_2 = {
        ...
        'attributes': {
            'content': {
                'id': '',
                'name': do_name,
                DOTypeIdentifier.DO_STATUS.value: 'created'
            }
        }
    }
