...
class ListCertificateAuthoritiesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_acm_pca/paginators/#listcertificateauthoritiespaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListPermissionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_acm_pca/paginators/#listpermissionspaginator)
    """
    def paginate(
...
class ListTagsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_acm_pca/paginators/#listtagspaginator)
    """
    def paginate(
