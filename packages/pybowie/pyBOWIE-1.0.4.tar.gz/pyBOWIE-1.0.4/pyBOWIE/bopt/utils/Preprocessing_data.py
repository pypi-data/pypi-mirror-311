...
def X_new_scaling(x_new_tau, d_nc, d_ni, d_nq, x_l, x_u, int_val, cat_val, reducer, inverter_transform, inverter, problem_type):
    ...
    if reducer == "no":
        if problem_type == "Continuous":
            ...
            x_new = U_scaling(x_new_tau, d_nc, d_ni, d_nq, x_l, x_u, int_val, cat_val, problem_type)
    else:
