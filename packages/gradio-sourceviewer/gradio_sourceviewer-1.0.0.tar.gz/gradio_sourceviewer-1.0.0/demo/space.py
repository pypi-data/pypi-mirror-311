...
""", elem_classes=["md-custom"], header_links=True)
    ...
    gr.ParamViewer(value=_docs["SourceViewer"]["members"]["__init__"], linkify=['WaveformOptions'])


    gr.Markdown("### Events")
    gr.ParamViewer(value=_docs["SourceViewer"]["events"], linkify=['Event'])
...
def predict(
    ...
    return value
```
""", elem_classes=["md-custom", "SourceViewer-user-fn"], header_links=True)
