...
class QuantBook(QuantConnect.Algorithm.QCAlgorithm):
    ...
    @overload
    def universe_history(self, universe: typing.Any, start: typing.Union[datetime.datetime, datetime.date], end: typing.Optional[datetime.datetime] = None, func: typing.Any = None, date_rule: QuantConnect.Scheduling.IDateRule = None) -> typing.Any:
        """
        Will return the universe selection data and will optionally perform selection
