...
def _generate_query(
    ...
    try:
        accessibility_tree = get_page_accessibility_tree(page, include_hidden=include_hidden)
        process_iframes(page, accessibility_tree, include_hidden=include_hidden)
