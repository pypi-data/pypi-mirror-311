...
async def _get_frame_accessibility_tree(
    ...
    accessibility_tree = await get_page_accessibility_tree(frame_context, include_hidden)

    return accessibility_tree


async def get_page_accessibility_tree(context: Union[Page, Frame], include_hidden: bool) -> dict:
    """
