...
class FineTuneConfig(BaseModel):
    ...
    trainer_dir: str = Field(default="/mnt/persistent-disk/test/", description="Training directory path")
    export_dir: str = Field(default="/mnt/persistent-disk/test/hf_export", description="Export directory path")
...
class FineTuneStoragePaths:
    ...
    def tune_path(user_id: str, tune_id: str, include_bucket: bool = False) -> str:
        if include_bucket:
            return f"gs://{Config.GCS_BUCKET_NAME}/{FineTuneStoragePaths.base_path(user_id)}/tune_jobs/{tune_id}"
        else:
