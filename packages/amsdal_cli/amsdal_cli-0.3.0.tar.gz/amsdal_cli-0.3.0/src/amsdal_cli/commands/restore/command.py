...
def _restore_state_db(cli_config: CliConfig, config_path: Path | None) -> None:
    ...
    for table_ref, schema in _get_user_schemas(lakehouse_connection, class_object_ref, class_object_meta_ref):
        ...
        for item in _get_all_latest_data(lakehouse_connection, table_ref):
            ...
            item['_metadata']['address']['class_version'] = glue.Version.LATEST.value
            item['_metadata']['address']['object_version'] = glue.Version.LATEST.value
            item['_metadata']['class_schema_reference']['ref']['class_version'] = glue.Version.LATEST.value
            item['_metadata']['class_schema_reference']['ref']['object_version'] = glue.Version.LATEST.value

            if item['_metadata'].get('transaction'):
                item['_metadata']['transaction']['class_version'] = glue.Version.LATEST.value
                item['_metadata']['transaction']['object_version'] = glue.Version.LATEST.value

            if item['_metadata'].get('class_meta_schema_reference'):
                item['_metadata']['class_meta_schema_reference']['ref']['class_version'] = glue.Version.LATEST.value
                item['_metadata']['class_meta_schema_reference']['ref']['object_version'] = glue.Version.LATEST.value
