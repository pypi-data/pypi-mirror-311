...
class AssetActiveWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_iotsitewise/waiters/#assetactivewaiter)
    """
...
class AssetModelActiveWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_iotsitewise/waiters/#assetmodelactivewaiter)
    """
...
class AssetModelNotExistsWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_iotsitewise/waiters/#assetmodelnotexistswaiter)
    """
    def wait(
...
class AssetNotExistsWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_iotsitewise/waiters/#assetnotexistswaiter)
    """
...
class PortalActiveWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_iotsitewise/waiters/#portalactivewaiter)
    """
...
class PortalNotExistsWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_iotsitewise/waiters/#portalnotexistswaiter)
    """
