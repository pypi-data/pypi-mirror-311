...
class AdminOrganizationResponseModel(BaseModel):
    """
    AdminOrganizationResponseModel
    """ # noqa: E501
    message: Optional[StrictStr] = None
    organizations: Optional[OrganizationFields] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizations": OrganizationFields.from_dict(obj["organizations"]) if obj.get("organizations") is not None else None,
