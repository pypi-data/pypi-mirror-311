...
class AdminImageAdminResponseImage(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["created_at", "description", "id", "is_public", "labels", "name", "openstack_id", "organizations", "region_id", "region_name", "size", "type", "version"]
