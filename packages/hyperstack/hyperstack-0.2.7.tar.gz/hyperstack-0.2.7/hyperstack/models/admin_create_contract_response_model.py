...
class AdminCreateContractResponseModel(BaseModel):
    """
    AdminCreateContractResponseModel
    """ # noqa: E501
    contract: Optional[CreateContractFields] = None
    message: Optional[StrictStr] = None
    status: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["contract", "message", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contract": CreateContractFields.from_dict(obj["contract"]) if obj.get("contract") is not None else None,
