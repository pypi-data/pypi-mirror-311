...
class AdminFlavorResourcesList(BaseModel):
    """
    AdminFlavorResourcesList
    """ # noqa: E501
    flavors: Optional[List[AdminFlavorResource]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "flavors": [AdminFlavorResource.from_dict(_item) for _item in obj["flavors"]] if obj.get("flavors") is not None else None,
