...
class AdminOrganizationResourceList(BaseModel):
    """
    AdminOrganizationResourceList
    """ # noqa: E501
    message: Optional[StrictStr] = None
    organizations: Optional[List[AdminOrganizationResources]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizations": [AdminOrganizationResources.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None,
