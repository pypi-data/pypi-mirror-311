...
class TestInstancesAdmin(unittest.TestCase):
    """InstancesAdmin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstancesAdmin:
        ...
        # uncomment below to create an instance of `InstancesAdmin`
        """
        model = InstancesAdmin()
        if include_optional:
