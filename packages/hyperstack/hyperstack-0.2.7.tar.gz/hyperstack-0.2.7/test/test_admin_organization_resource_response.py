...
class TestAdminOrganizationResourceResponse(unittest.TestCase):
    """AdminOrganizationResourceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminOrganizationResourceResponse:
        """Test AdminOrganizationResourceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminOrganizationResourceResponse`
        """
        model = AdminOrganizationResourceResponse()
        if include_optional:
            return AdminOrganizationResourceResponse(
                message = '',
                organization = hyperstack.models.admin_organization_resources.AdminOrganizationResources(
                    environments = [
    ...
    def testAdminOrganizationResourceResponse(self):
        """Test AdminOrganizationResourceResponse"""
