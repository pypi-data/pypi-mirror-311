...
class TestInstanceAdminFields(unittest.TestCase):
    """InstanceAdminFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstanceAdminFields:
        """Test InstanceAdminFields
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstanceAdminFields`
        """
        model = InstanceAdminFields()
        if include_optional:
    ...
    def testInstanceAdminFields(self):
        """Test InstanceAdminFields"""
