...
class Adminthresholdpostpayload(BaseModel):
    """
    Adminthresholdpostpayload
    """ # noqa: E501
    threshold: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The minimum credit balance required to maintain access to resources.")
