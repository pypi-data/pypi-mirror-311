...
class FlavorDetailResponse(BaseModel):
    """
    FlavorDetailResponse
    """ # noqa: E501
    flavor: Optional[AdminFlavorDetailFields] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "flavor": AdminFlavorDetailFields.from_dict(obj["flavor"]) if obj.get("flavor") is not None else None,
