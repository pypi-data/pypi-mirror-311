...
class GetContractEventsResponseModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contract_events", "count", "message", "status"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.contract_events:
            for _item_contract_events in self.contract_events:
                if _item_contract_events:
                    _items.append(_item_contract_events.to_dict())
