...
class FlavorAdminResponse(BaseModel):
    """
    FlavorAdminResponse
    """ # noqa: E501
    flavor: Optional[FlavorAdminResponseFlavors] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "flavor": FlavorAdminResponseFlavors.from_dict(obj["flavor"]) if obj.get("flavor") is not None else None,
