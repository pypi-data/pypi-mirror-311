...
class AdminOrganizationsResponseModel(BaseModel):
    """
    AdminOrganizationsResponseModel
    """ # noqa: E501
    message: Optional[StrictStr] = None
    organization_count: Optional[StrictInt] = None
    organizations: Optional[List[OrganizationFields]] = None
    status: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["message", "organization_count", "organizations", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organization_count": obj.get("organization_count"),
