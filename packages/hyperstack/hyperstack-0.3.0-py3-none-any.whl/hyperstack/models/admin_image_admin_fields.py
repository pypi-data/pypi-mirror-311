...
class AdminImageAdminFields(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["created_at", "description", "id", "is_public", "labels", "name", "openstack_id", "region_id", "region_name", "size", "type", "version"]
