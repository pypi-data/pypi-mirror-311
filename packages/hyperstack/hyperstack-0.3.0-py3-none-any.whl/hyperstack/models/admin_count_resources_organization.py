...
class AdminCountResourcesOrganization(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["organization_id", "total_clusters", "total_containers", "total_instances", "total_volumes"]
