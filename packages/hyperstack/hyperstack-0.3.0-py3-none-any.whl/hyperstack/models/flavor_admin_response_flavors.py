...
class FlavorAdminResponseFlavors(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["cpu", "created_at", "description", "disk", "ephemeral", "flavors", "gpu", "gpu_count", "id", "is_custom", "is_public", "labels", "name", "openstack_id", "order", "organizations", "projects", "ram", "region", "region_id", "status"]
