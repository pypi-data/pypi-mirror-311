...
class BillingApi:
    ...
    @validate_call
    def get_user_current_billing_contract(
        self,
        contract_ids: Annotated[Optional[StrictStr], Field(description="Comma separated list of contract IDs")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """get_user_current_billing_contract

        User will receive the latest pricing per hour and other latest metrics for contracts. This data will include 'description', gpu_type','infrahub_id', 'status', 'incurred_bill', 'price_per_hour'

        :param contract_ids: Comma separated list of contract IDs
        :type contract_ids: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_user_current_billing_contract_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ContractBillingHistoryResponseModel",
            '401': "ErrorResponseModel",
            '403': "ErrorResponseModel",
            '404': "ErrorResponseModel",
            '500': None,
    ...
    @validate_call
    def get_user_current_billing_contract_with_http_info(
        self,
        contract_ids: Annotated[Optional[StrictStr], Field(description="Comma separated list of contract IDs")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContractBillingHistoryResponseModel]:
        """get_user_current_billing_contract
    ...
    @validate_call
    def get_user_current_billing_contract_without_preload_content(
        self,
        contract_ids: Annotated[Optional[StrictStr], Field(description="Comma separated list of contract IDs")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_user_current_billing_contract_serialize(
        self,
        contract_ids,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/billing/billing/history/contract/current',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
