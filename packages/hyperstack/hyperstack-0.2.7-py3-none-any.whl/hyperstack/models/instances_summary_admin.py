...
class InstancesSummaryAdmin(BaseModel):
    """
    InstancesSummaryAdmin
    """ # noqa: E501
    instances: Optional[List[InstancesSummaryFields]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instances": [InstancesSummaryFields.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None,
