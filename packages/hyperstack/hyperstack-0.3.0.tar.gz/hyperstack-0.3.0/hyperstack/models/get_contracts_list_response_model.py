...
class GetContractsListResponseModel(BaseModel):
    """
    GetContractsListResponseModel
    """ # noqa: E501
    contracts: Optional[List[AdminContractFields]] = None
    count: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    status: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["contracts", "count", "message", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contracts": [AdminContractFields.from_dict(_item) for _item in obj["contracts"]] if obj.get("contracts") is not None else None,
            "count": obj.get("count"),
