...
class AdminOrganizationResources(BaseModel):
    """
    AdminOrganizationResources
    """ # noqa: E501
    environments: Optional[List[AdminEnvrionmentResources]] = None
    organization_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["environments", "organization_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "environments": [AdminEnvrionmentResources.from_dict(_item) for _item in obj["environments"]] if obj.get("environments") is not None else None,
