...
class AdminOrganizationsSummaryResponseModel(BaseModel):
    """
    AdminOrganizationsSummaryResponseModel
    """ # noqa: E501
    message: Optional[StrictStr] = None
    organizations: Optional[List[AdminOrganizationSummaryFields]] = None
    status: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["message", "organizations", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizations": [AdminOrganizationSummaryFields.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None,
