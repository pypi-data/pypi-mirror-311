...
class InstanceAdminFields(BaseModel):
    """
    InstanceAdminFields
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["contract_id", "created_at", "environment", "fixed_ip", "flavor", "floating_ip", "floating_ip_status", "host", "id", "image", "keypair", "labels", "locked", "name", "openstack_id", "os", "power_state", "security_rules", "status", "vm_state", "volume_attachments"]
