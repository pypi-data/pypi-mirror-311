...
class TestResourceLevelBillingHistory(unittest.TestCase):
    """ResourceLevelBillingHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceLevelBillingHistory:
        """Test ResourceLevelBillingHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourceLevelBillingHistory`
        """
        model = ResourceLevelBillingHistory()
        if include_optional:
            return ResourceLevelBillingHistory(
                billing_history = [
    ...
    def testResourceLevelBillingHistory(self):
        """Test ResourceLevelBillingHistory"""
