...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "support@learngual.com")
...
class TransformTemplateContext:
    ...
    def process_meta(
        ...
        """
        print(f"{plain_text = }")
        print(f"{self.extract_patterns(plain_text).items() = }")
        mapping = {
    ...
    def send_email(self, emails: list[str] | str, context={}) -> None:
        """Endpoint to send email

        Args:
            emails (list[str] | str): _description_
