...
class UserModel(MODEL):
    ...
    login: Mapped[str]    = mapped_column(sqlalchemy.String(50), sqlalchemy.CheckConstraint('login = lower(login)', name='login_lowercase'), unique = True, index = True)
    fullname: Mapped[str]           = mapped_column(sqlalchemy.String(100))
    email: Mapped[str]              = mapped_column(sqlalchemy.String(250), sqlalchemy.CheckConstraint('email = lower(email)', name='email_lowercase'))
    organization: Mapped[str]       = mapped_column(sqlalchemy.String(250))
    roles: Mapped[list[str]]        = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String(20), dimensions = 1), default = [])
...
class FilterModel(MODEL):  # pylint: disable=locally-disabled,too-many-instance-attributes
    ...
    group_id: Mapped[int] = mapped_column(sqlalchemy.Integer, sqlalchemy.ForeignKey('groups.id', onupdate = "CASCADE", ondelete = "CASCADE"))
    ...
    type: Mapped[str]                = mapped_column(sqlalchemy.Enum(*REPORTING_FILTERS, name='filter_types'), default = REPORTING_FILTER_BASIC)
    ...
    detectors: Mapped[list[str]]     = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions = 1), default = [])
    categories: Mapped[list[str]]    = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions = 1), default = [])
    event_classes: Mapped[list[str]] = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions=1), default=[])
    sources: Mapped[list[str]]       = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions = 1), default = [])
    targets: Mapped[list[str]]       = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions=1), default=[])
    protocols: Mapped[list[str]]     = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions=1), default=[])
...
class EventClassModel(MODEL):  # pylint: disable=locally-disabled,too-many-instance-attributes
    ...
    displayed_main: Mapped[list[str]]   = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions=1), default=[])
    displayed_source: Mapped[list[str]] = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions=1), default=[])
    displayed_target: Mapped[list[str]] = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions=1), default=[])
    ...
    last_update: Mapped[Optional[datetime.datetime]] = mapped_column(sqlalchemy.DateTime, default=datetime.datetime.utcnow, onupdate=datetime.datetime.utcnow, index=True)
...
class SettingsReportingModel(MODEL):  # pylint: disable=locally-disabled,too-few-public-methods
    ...
    emails_info: Mapped[list[str]] = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions = 1), default = [])
    emails_low: Mapped[list[str]] = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions = 1), default = [])
    emails_medium: Mapped[list[str]] = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions = 1), default = [])
    emails_high: Mapped[list[str]] = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions = 1), default = [])
    emails_critical: Mapped[list[str]] = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions = 1), default = [])
...
class EventReportModel(MODEL):
    ...
    mail_to: Mapped[list[str]] = mapped_column(sqlalchemy.dialects.postgresql.ARRAY(sqlalchemy.String, dimensions = 1), default = [])
