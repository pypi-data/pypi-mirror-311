...
class Client:
    """Sunbird dcTrack API client version 1.4.0 in Python"""
    ...
    def getModelsByNameAndMakeID(self, modelName: str, makeId: int):
        """Search for a model using the model name and the make ID. Returns a list of models with basic information."""
        return self.__request('GET', '/api/v2/dcimoperations/search/models/' + str(modelName) + '/' + str(makeId) + '?')
