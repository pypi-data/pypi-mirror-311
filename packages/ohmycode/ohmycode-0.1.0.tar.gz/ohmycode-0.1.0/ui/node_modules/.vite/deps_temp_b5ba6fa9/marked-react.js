import {
  require_react
} from "./chunk-XOCSTAM6.js";
import {
  __toESM
} from "./chunk-ZR7N7HH5.js";

// ../node_modules/marked-react/dist/marked-react.js
...
var ReactParser = class {
  ...
  parseInline(tokens = []) {
    return tokens.map((token) => {
      switch (token.type) {
        case "text": {
          return this.renderer.text(unescape2(token.text));
        }
        case "strong": {
        ...
        case "codespan": {
          return this.renderer.codespan(unescape2(token.text));
        }
        case "link": {
...
var _ReactRenderer_instances;
var _ReactRenderer_elId;
var _ReactRenderer_options;
var _ReactRenderer_h;
var _ReactRenderer_incrementElId;
var ReactRenderer = class {
  constructor(options2 = {}) {
    ...
    __classPrivateFieldSet(this, _ReactRenderer_options, options2, "f");
...
_ReactRenderer_elId = /* @__PURE__ */ new WeakMap(), _ReactRenderer_options = /* @__PURE__ */ new WeakMap(), _ReactRenderer_instances = /* @__PURE__ */ new WeakSet(), _ReactRenderer_h = function _ReactRenderer_h2(el, children = null, props = {}) {
  const elProps = {
    key: `marked-react-${this.elementId}`
  };
  __classPrivateFieldGet(this, _ReactRenderer_instances, "m", _ReactRenderer_incrementElId).call(this);
  return (0, import_react.createElement)(el, Object.assign(Object.assign({}, props), elProps), children);
}, _ReactRenderer_incrementElId = function _ReactRenderer_incrementElId2() {
...
var Markdown = (props) => {
  ...
  const options2 = Object.assign(Object.assign({}, defaultProps), props);
  const { current: marked2 } = (0, import_react.useRef)((_a = options2.instance) !== null && _a !== void 0 ? _a : new Marked());
  const lexerOptions = {
    breaks: options2.breaks,
    gfm: options2.gfm
  };
  const markdownString = (_c = (_b = options2.value) !== null && _b !== void 0 ? _b : options2.children) !== null && _c !== void 0 ? _c : "";
  const tokens = options2.isInline ? marked2.Lexer.lexInline(markdownString, lexerOptions) : marked2.lexer(markdownString, lexerOptions);
  const parserOptions = {
  ...
  const parser2 = new ReactParser(parserOptions);
  const children = options2.isInline ? parser2.parseInline(tokens) : parser2.parse(tokens);
