...
var addNode = __name((level, id, descr, type, shapeData) => {
  ...
  if (shapeData !== void 0) {
    ...
    if (doc == null ? void 0 : doc.icon) {
      node.icon = doc == null ? void 0 : doc.icon;
    }
    if (doc == null ? void 0 : doc.assigned) {
      node.assigned = doc == null ? void 0 : doc.assigned;
    }
    if (doc == null ? void 0 : doc.ticket) {
      node.ticket = doc == null ? void 0 : doc.ticket;
    }
...
//# sourceMappingURL=kanban-definition-KMT3NSR2-ZC6UMBVW.js.map
