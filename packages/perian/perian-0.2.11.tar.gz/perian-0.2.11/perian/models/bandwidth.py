...
class Bandwidth(BaseModel):
    """
    Bandwidth class representing the bandwidth information.
    """ # noqa: E501
    speed: Optional[StrictStr] = '0.0'
    maximum: Optional[StrictStr] = '0.0'
    minimum: Optional[StrictStr] = '0.0'
    unit: Optional[BandwidthUnits] = None
    sla: Optional[BandwidthSla] = None
    limit: Optional[BandwidthLimits] = None
    __properties: ClassVar[List[str]] = ["speed", "maximum", "minimum", "unit", "sla", "limit"]
