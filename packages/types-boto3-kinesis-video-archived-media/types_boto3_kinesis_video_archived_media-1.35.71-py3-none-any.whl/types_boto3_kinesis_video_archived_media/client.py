...
class KinesisVideoArchivedMediaClient(BaseClient):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis_video_archived_media/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/kinesis-video-archived-media.html#KinesisVideoArchivedMedia.Client)
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis_video_archived_media/client/#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis_video_archived_media/client/#can_paginate)
        """
    ...
    def generate_presigned_url(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis_video_archived_media/client/#generate_presigned_url)
        """
    ...
    def close(self) -> None:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis_video_archived_media/client/#close)
        """
    ...
    def get_clip(self, **kwargs: Unpack[GetClipInputRequestTypeDef]) -> GetClipOutputTypeDef:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis_video_archived_media/client/#get_clip)
        """
    ...
    def get_dash_streaming_session_url(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis_video_archived_media/client/#get_dash_streaming_session_url)
        """
    ...
    def get_hls_streaming_session_url(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis_video_archived_media/client/#get_hls_streaming_session_url)
        """
    ...
    def get_images(self, **kwargs: Unpack[GetImagesInputRequestTypeDef]) -> GetImagesOutputTypeDef:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis_video_archived_media/client/#get_images)
        """
    ...
    def get_media_for_fragment_list(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis_video_archived_media/client/#get_media_for_fragment_list)
        """
    ...
    def list_fragments(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis_video_archived_media/client/#list_fragments)
        """
    ...
    def get_paginator(self, operation_name: Literal["get_images"]) -> GetImagesPaginator:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesis_video_archived_media/client/#get_paginator)
        """
