...
AMPLAPI AMPL_ERRORINFO *AMPL_SetErrorHandler(AMPL *ampl, void *errorhandler,
                                             ErrorHandlerCbPtr callback);
AMPLAPI void *AMPL_GetOutputHandler(AMPL *ampl);
AMPLAPI void *AMPL_GetErrorHandler(AMPL *ampl);
