...
class AMPL {
  ...
  */
  ...
  void setErrorHandler(ErrorHandler* errorhandler) {
    ...
    AMPL_CALL_CPP(AMPL_SetErrorHandler(ampl_, errorhandler, myCallback));
  }
  ...
  OutputHandler* getOutputHandler() const {
    return static_cast<OutputHandler*>(AMPL_GetOutputHandler(ampl_));
  }
  ...
  ErrorHandler* getErrorHandler() const {
    return static_cast<ErrorHandler*>(AMPL_GetErrorHandler(ampl_));
  }
