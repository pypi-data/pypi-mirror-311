...
#export OMPI_ALLOW_RUN_AS_ROOT=1 && \
#cd $CSMDATA && \
#bash /p/scratch/CESMDATAROOT/inputdata/usp/usp.sh --ATMDOM_FILE {ATMDOM_FILE} \
#--SURF '{SURF}' \
...
#""",
#    "singularity": "{input_path}:/p/scratch/CESMDATAROOT/inputdata {output_path}:/p/scratch/CESMDATAROOT/Archive/lnd/hist {log_path}:/p/scratch/CESMDATAROOT/CaseOutputs {scripts_path}:/p/scripts "
#
#}
