...
class ComponentDeletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_proton/waiters/#componentdeletedwaiter)
    """
...
class ComponentDeployedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_proton/waiters/#componentdeployedwaiter)
    """
...
class EnvironmentDeployedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_proton/waiters/#environmentdeployedwaiter)
    """
...
class EnvironmentTemplateVersionRegisteredWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_proton/waiters/#environmenttemplateversionregisteredwaiter)
    """
    def wait(
        self,
        **kwargs: Unpack[
...
class ServiceCreatedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_proton/waiters/#servicecreatedwaiter)
    """
...
class ServiceDeletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_proton/waiters/#servicedeletedwaiter)
    """
...
class ServiceInstanceDeployedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_proton/waiters/#serviceinstancedeployedwaiter)
    """
    def wait(
...
class ServicePipelineDeployedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_proton/waiters/#servicepipelinedeployedwaiter)
    """
...
class ServiceTemplateVersionRegisteredWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_proton/waiters/#servicetemplateversionregisteredwaiter)
    """
    def wait(
        self,
...
class ServiceUpdatedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_proton/waiters/#serviceupdatedwaiter)
    """
