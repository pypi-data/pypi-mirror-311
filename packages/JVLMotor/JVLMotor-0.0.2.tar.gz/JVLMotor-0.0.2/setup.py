...
setup(
    ...
    version="0.0.2",        # Define your version
    ...
    install_requires=["ea_psu_controller==1.1.0",
                        ...
                        "pyserial==3.5",
                        "pyuac==0.0.3",
                        "pywinauto==0.6.8"],    # List any dependencies here
    ...
    long_description="Documentation is available upon request. Please contact JVL A/S maintainer for more information.", 
