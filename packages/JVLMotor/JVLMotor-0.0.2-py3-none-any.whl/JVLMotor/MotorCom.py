...
from .Protocols.EthernetIPProtocol import *
from .Protocols.ProfinetIOProtocol import *
from .Protocols.EtherCATRegistersProtocol import *
from .Protocols.EtherCATDSPProtocol import *
    ...
    def __init__(self,motor="MAC",com_type="Serial",protocol="MacTalk",
        ...
        if protocol == "MacTalk":
            ...
            if io_mode == "Registers" or io_mode == "Reg" or io_mode == "JVL":
                ...
                self.real_time = True
            if io_mode == "Driver" or io_mode == "DSP" or io_mode == "CiA" or io_mode == "402":
