...
class BotAliasAvailableWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lexv2_models/waiters/#botaliasavailablewaiter)
    """
...
class BotAvailableWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lexv2_models/waiters/#botavailablewaiter)
    """
...
class BotExportCompletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lexv2_models/waiters/#botexportcompletedwaiter)
    """
...
class BotImportCompletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lexv2_models/waiters/#botimportcompletedwaiter)
    """
...
class BotLocaleBuiltWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lexv2_models/waiters/#botlocalebuiltwaiter)
    """
...
class BotLocaleCreatedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lexv2_models/waiters/#botlocalecreatedwaiter)
    """
...
class BotLocaleExpressTestingAvailableWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lexv2_models/waiters/#botlocaleexpresstestingavailablewaiter)
    """
...
class BotVersionAvailableWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lexv2_models/waiters/#botversionavailablewaiter)
    """
