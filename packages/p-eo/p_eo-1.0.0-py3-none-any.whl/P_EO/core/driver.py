...
class WebDriverManager:
    ...
    @property
    def chrome(self):
        return ChromeDriverManager(path=self.__driver_path, version=self.__version).install()

    @property
    def firefox(self):
        return GeckodriverManager(path=self.__driver_path, version=self.__version).install()
