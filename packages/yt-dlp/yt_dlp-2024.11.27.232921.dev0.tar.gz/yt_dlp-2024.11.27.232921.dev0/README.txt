...
-   player_client: Clients to extract video data from. The main clients
    ...
    ios_creator); and mweb, mediaconnect, android_vr, web_safari,
    web_embedded, tv and tv_embedded with no variants. By default,
    ios,mweb is used, and web_creator is added as needed for age-gated
    videos when account age verification is required. Similarly, the
    ...
    work with authentication. You can use all to use all the clients,
    and default for the default clients. You can prefix a client with -
    to exclude it, e.g. youtube:player_client=all,-web
