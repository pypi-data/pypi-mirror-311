...
def scatter(x, y, **kwargs):
    """ 全局函数，模拟 plt.scatter """
    fig_id = _get_current_fig_id()  # 获取当前图形 ID
    current_axes = _self_figures[fig_id].axes_list[-1]  # 获取当前活动的 MatAxes 对象
    return current_axes.scatter(x, y, **kwargs)  # 调用 MatAxes 的 scatter 方法
