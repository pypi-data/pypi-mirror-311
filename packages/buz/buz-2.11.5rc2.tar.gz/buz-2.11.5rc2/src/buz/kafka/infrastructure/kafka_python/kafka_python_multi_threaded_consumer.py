...
class KafkaPythonMultiThreadedConsumer:
    ...
    __DEFAULT_SESSION_TIMEOUT_MS = 1000 * 10
    ...
    def pull_keep_alive(self) -> None:
        # https://docs.confluent.io/platform/current/installation/configuration/consumer-configs.html#max-poll-interval-ms
        # Here we are executing a polling without consume messages, to reset the max-poll-interval
