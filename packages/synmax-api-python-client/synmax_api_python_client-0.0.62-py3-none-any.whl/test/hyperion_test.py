...
access_token = ""
client = HyperionApiClient(access_token=access_token, local_server=False)
...
def test_rigs():
    ...
    for _state in states:
        payload = ApiPayload(
            start_date="2016-01-01", end_date="2022-01-31", state_code=_state
        )
...
def test_frac_crews():
    payload = ApiPayload(start_date="2024-01-01", end_date="2024-12-02")
...
def test_production_by_well():
    ...
    payload = ApiPayload(
        start_date="2023-01-01", end_date="2024-08-01", sub_region="SW PA"
    )
