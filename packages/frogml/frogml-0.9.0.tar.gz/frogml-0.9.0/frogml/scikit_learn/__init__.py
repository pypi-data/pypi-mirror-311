...
_DEFAULT_SCIKIT_LEARN_SERIALIZED_TYPE = "joblib"
...
def log_model(
    ...
    with tempfile.TemporaryDirectory() as target_dir:
        full_model_path = _get_full_model_path(
            ...
            model_name=model_name,
            serialized_type=_DEFAULT_SCIKIT_LEARN_SERIALIZED_TYPE,
        )
        ...
        _log_model_to_artifactory(
            ...
            serialization_format=_DEFAULT_SCIKIT_LEARN_SERIALIZED_TYPE,
            repository=repository,
            namespace=namespace,
            version=version,
            properties=properties,
