...
class NumericalExtrapolationWithAttitudeSimulationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["targetDate", "outputConfiguration", "data", "initialCovarianceMatrix", "initialOrbit", "simulationConfiguration", "attitudeSequence", "maneuverSchedule", "spaceObject", "ephemerisGenerationRequests", "eventGenerationRequests"]
