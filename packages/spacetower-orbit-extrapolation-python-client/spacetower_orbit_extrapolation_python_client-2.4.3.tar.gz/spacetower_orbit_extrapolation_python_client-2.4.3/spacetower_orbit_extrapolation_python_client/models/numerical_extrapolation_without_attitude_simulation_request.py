...
class NumericalExtrapolationWithoutAttitudeSimulationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["targetDate", "outputConfiguration", "data", "initialCovarianceMatrix", "initialOrbit", "simulationConfiguration", "maneuverSchedule", "spaceObject", "ephemerisGenerationRequests", "eventGenerationRequests"]
