...
class BuildProjConfig:
    ...
    def enable_snake_case_enums(self):
        """Return True/False whether enums should be snake case in source code. Default is false (all caps).

        Returns:
            (bool): True/False whether enums should be snake case in source code
        """
        return self._prj_cfg['ProjectInfo'].get('snakeCaseEnums', False)

    def enable_external_rte_headers(self):
        """Return True/False whether external RTE headers should be included in ext vars. Default is false.

        Returns:
            (bool): True/False whether external RTE headers should be included in ext vars
        """
        return self._prj_cfg['CodeGenerationConfig'].get('enableExternalRteHeaders', False)
