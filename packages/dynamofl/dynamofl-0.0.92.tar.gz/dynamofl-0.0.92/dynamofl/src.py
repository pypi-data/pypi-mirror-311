...
class DynamoFL:
    ...
    def create_guardrail_evaluation_test(  # pylint: disable=dangerous-default-value
        ...
        gpu: Optional[GPUSpecification] = None,
        enable_robustness_tests: Optional[bool] = False,
        grid: List[Dict[str, List[Union[str, float, int]]]] = [{}],
        **kwargs
    ) -> TestEntity:
        ...
        Args:
            ...
            dynamoguard_endpoint (str): Endpoint for the DynamoGuard policies.
            ...
            gpu (Optional[GPUSpecification]): GPU specification.
                Defaults to None.
            enable_robustness_tests (Optional[bool]): Robustness tests mode.
                Test a subset of the dataset (100 datapoints) on specific benign and simple malicious robustness perturbations.
            fast_mode (bool): Whether to use fast mode for the attack. Reduces
        ...
        common_attack_config = {
            "attack": Helpers.construct_dict_filtering_none_values(
                ...
                fast_mode=fast_mode,
                enable_robustness_tests=enable_robustness_tests,
            ),
        }
