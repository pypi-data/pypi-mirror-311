...
produceA = xp.var(vartype=xp.integer)
produceB = xp.var(vartype=xp.integer)

# Deviational variables
# There is a penalty for both under- and over-utilizing each department
surplus_wiring = xp.var()
deficit_wiring = xp.var()
surplus_assembly = xp.var()
deficit_assembly = xp.var()
# There is no penalty for surplus in profit or in production of product B, only for deficits
deficit_profit = xp.var()
deficit_productB = xp.var()
