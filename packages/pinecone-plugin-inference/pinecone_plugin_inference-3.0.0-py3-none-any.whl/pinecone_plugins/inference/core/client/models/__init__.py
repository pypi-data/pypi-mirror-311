...
from pinecone_plugins.inference.core.client.model.embedding_one_of import EmbeddingOneOf
from pinecone_plugins.inference.core.client.model.embedding_one_of1 import (
    EmbeddingOneOf1,
)
