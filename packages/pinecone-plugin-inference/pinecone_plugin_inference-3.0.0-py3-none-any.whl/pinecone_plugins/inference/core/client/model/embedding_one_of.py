...
class EmbeddingOneOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vector_type, values, *args, **kwargs):  # noqa: E501
        """EmbeddingOneOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, vector_type, values, *args, **kwargs):  # noqa: E501
        """EmbeddingOneOf - a model defined in OpenAPI
