...
from ngcbpc.constants import UMASK_GROUP_OTHERS_READ_EXECUTE
...
from ngcbpc.tracing import GetTracer
...
from ngcbpc.util.file_utils import get_cli_config_dir, mkdir_path
from ngcbpc.util.utils import format_org_team, get_current_user_version, MaskGranter
...
# AioHttpClientInstrumentor().instrument() #opentelemetry#instrumentation#aiohttp_client#AioHttpClientInstrumentor
                ...
                with ProcessPoolExecutor(max_workers=NGC_CLI_MAX_CONCURRENCY) as executor:
                    with GetTracer() as tracer:
                        async with start_as_current_span_async(
                            tracer, self.operation_name, end_on_exit=True
                        ) as parent_scope:
                            try:
