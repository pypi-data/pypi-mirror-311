...
from ngcbpc.api.utils import add_scheme, default_headers
...
class Authentication:  # noqa: D101
    ...
    def _get_token(
        ...
        if starfleet_authentication:
            ...
            login_url = device_login_response.loginUrl
            session_key = device_login_response.sessionKey
            expires_in = device_login_response.expiresIn or 86400
    ...
    def get_login_url_and_session_key(self, starfleet_kas_email):
        ...
        device_login_request = DeviceLoginRequest(body)
        ...
        try:
            ...
            response = traced_request(
                ...
                # timeout=REQUEST_TIMEOUT_SECONDS,
                json=device_login_request.toDict(),
            )
            return DeviceLoginResponse(response.json())
        except requests.ConnectionError:
    ...
    def get_sak_key_details(self, sak_key):
        ...
        sak_key_request = SakCallerInfoRequest({"credentials": sak_key})
        try:
        ...
        return SakCallerInfoResponse(response.json())
