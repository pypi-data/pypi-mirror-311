...
from ngcbpc.command.global_args import get_parent_parser
from ngcbpc.command.parser import SortingHelpFormatter
from ngcbpc.constants import CONFIG_TYPE, DISABLE_TYPE, ENABLE_TYPE, PRODUCTION_ENV
from ngcbpc.environ import NGC_CLI_SUPER_ADMIN_ENABLE
from ngcbpc.errors import InvalidArgumentError
from ngcbpc.tracing import trace_command
...
class CLICommand:
    ...
    # It has to be one ngcbpc.constants._FeatureType.
