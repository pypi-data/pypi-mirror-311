...
class Booking(genpy.Message):
  _md5sum = "fb13de8b03a6ecb200353c915645cc1f"
...
"""
  __slots__ = ['booking_id','status','start','end','agent_reg','flight_mode','actions','allocations_options']
  _slot_types = ['uint32','uint32','uint64','uint64','uint64','uint32','digitaleye_msgs/Action[]','digitaleye_msgs/BookingAllocations[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       booking_id,status,start,end,agent_reg,flight_mode,actions,allocations_options
