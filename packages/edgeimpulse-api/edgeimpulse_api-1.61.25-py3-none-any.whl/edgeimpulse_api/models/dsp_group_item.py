...
class DSPGroupItem(BaseModel):
    ...
    __properties = ["name", "value", "defaultValue", "type", "help", "param", "selectOptions", "readonly", "shouldShow", "showIf", "invalidText", "section", "multiline", "required", "hint", "placeholder"]
    ...
    def section_validate_enum(cls, v):
        ...
        if v not in ('advanced', 'augmentation'):
            raise ValueError("must validate the enum values ('advanced', 'augmentation')")
        return v
