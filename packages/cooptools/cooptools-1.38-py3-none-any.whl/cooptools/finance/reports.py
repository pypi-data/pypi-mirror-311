...
class PivotProfileType(CoopEnum):
    DATESTAMP_ACCOUNT__CATEGORY = 1
    ACCOUNT_CATEGORY__DATESTAMP = 2
    DATESTAMP__CATEGORY = 3
    CATEGORY__DATESTAMP = 4
    DATESTAMP__ACCOUNT = 5
    DATESTAMP = 6
    ACCOUNT_SUBACCOUNT_CATEGORY__DATESTAMP = 7
...
def amount_pivot_by_month_and_sub(
...
if __name__ == "__main__":
    ...
    def t_pivot_01():
        df = amount_pivot_by_month_and_sub(
