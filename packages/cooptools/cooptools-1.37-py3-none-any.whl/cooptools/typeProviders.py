...
TypeProvider = StringProvider | StringByIndexProvider | StringChoiceProvider | IntProvider | FloatProvider | DictProvider | \
    FilePathProvider | DataFrameProvider | BoolProvider | DateTimeProvider
