...
from sentineltoolbox.resources.data import MAPPING_LEGACY_SEMANTIC_TO_DPR
            ...
            for child in input:
                if child.tag == "List_of_Alternatives":
                    ...
                    for adf in child.findall("Alternative"):
                        ...
                        if adf_type not in MAPPING_LEGACY_SEMANTIC_TO_DPR.keys():
                            print(f"Warning: {adf_type} not configured. It is removed")
                            continue
                        if MAPPING_LEGACY_SEMANTIC_TO_DPR[adf_type]:
                            adf_type = MAPPING_LEGACY_SEMANTIC_TO_DPR[adf_type]
