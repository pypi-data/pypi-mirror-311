...
def convert_adf_safe(adf_type: str, input_path: PathFsspec) -> DataTree[Any]:
    ...
    """
    xdt: DataTree[Any] = datatree.DataTree(name="root_adf")
...
def _convert_SL_2_CFM_to_FRPCM(input_path, xdt):
    ...
    datatree.DataTree(name="gas_flare", parent=xdt, data=gas_flare)
    datatree.DataTree(name="volcano", parent=xdt, data=volcano)
    ...
    if adf_type == "VSWCD":
        ...
        for input_path in input_paths:
            ...
            for nc_file in input_path.glob("*.nc4"):
                dt_legacy = datatree.open_datatree(nc_file)
                ...
                datatree.DataTree(name=group, parent=xdt, data=ds)
    elif adf_type == "FRPPA":
        ...
        for input_path in input_paths:
            for nc_file in input_path.glob("*.nc"):
                ...
                datatree.DataTree(name=band + view[0], parent=xdt, data=ds)
