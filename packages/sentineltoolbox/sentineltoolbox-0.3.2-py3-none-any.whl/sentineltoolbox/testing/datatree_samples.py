...
def create_datatree_sample_diff(**kwargs: Any) -> DataTree[Any]:
    """
...
def create_datatree_for_autodoc_tests() -> DataTree[Any]:
    xdt: DataTree[Any] = DataTree(name="SAMPLE")
    xdt.attrs = {"description": "Sample EOPF EOProduct"}
