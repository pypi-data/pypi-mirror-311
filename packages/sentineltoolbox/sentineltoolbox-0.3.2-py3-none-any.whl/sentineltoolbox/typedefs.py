...
DataTreeNode: TypeAlias = xr.DataArray | DataTree[Any]
...
T_ContainerWithAttributes: TypeAlias = DataTree[Any] | Dataset | EOProduct
...
def is_container_with_attributes(obj: Any) -> bool:
    return isinstance(obj, (DataTree, Dataset)) or is_eoproduct(obj)
...
class DataTreeVisitor:
    def visit_node(self, root: DataTree[Any], path: str, obj: DataTree[Any]) -> None:
        pass

    def visit_dataarray(self, root: DataTree[Any], path: str, obj: xarray.DataArray) -> None:
        pass

    def visit_attrs(self, root: DataTree[Any], path: str, obj: dict[Hashable, Any]) -> None:
        pass

    def is_applicable(self, xdt: DataTree[Any]) -> bool:
        return True
