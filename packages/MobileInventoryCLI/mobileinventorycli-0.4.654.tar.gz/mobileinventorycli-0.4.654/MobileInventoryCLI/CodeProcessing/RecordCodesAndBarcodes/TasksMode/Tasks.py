...
from MobileInventoryCLI.CodeProcessing.RecordCodesAndBarcodes.OSMTools import *
...
""")
    ...
    def __init__(self,engine,parent,init_only=False):
        ...
        for num,i in enumerate(fields):
            for code in [True,None]:
                for od in ["asc","desc"]:
                    ...
                    count+=1
        self.options["OSMTools"]={
                    'cmds':["#"+str(count),"osmt","open street map tools","osm tools",],
                    'desc':f'tools to use with sqlite3 version of OpenStreetMap Data obtained from osm2sqlite map.db map.xml',
                    'exec':GeoMapClass,
                    }
        count+=1
