...
REQUIREMENTS = {
    "ImpactAssessment": {
        "impacts": [{
            "@type": "Indicator",
            "value": "",
            "methodModel": {"@type": "Term", "@id": "recipe2016Individualist"}
        }]
    }
}
RETURNS = {
...
LOOKUPS = {
    "characterisedIndicator": "speciesYearIndividualistDamageToFreshwaterEcosystemsReCiPe2016"
}
TERM_ID = 'damageToFreshwaterEcosystemsSpeciesYear'
