...
REQUIREMENTS = {
    "ImpactAssessment": {
        "impacts": [{
            "@type": "Indicator",
            "value": "",
            "methodModel": {"@type": "Term", "@id": "lcImpactCertainEffects100Years"}
        }]
    }
}
RETURNS = {
...
LOOKUPS = {
    "characterisedIndicator": "pdfYearsDamageToFreshwaterEcosystemsLCImpact"
}
TERM_ID = 'damageToFreshwaterEcosystemsPdfYear'
