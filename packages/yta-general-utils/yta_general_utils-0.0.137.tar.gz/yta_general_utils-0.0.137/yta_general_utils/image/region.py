...
class Coordinate:
    ...
    def normalize(self):
        ...
        if not self._is_normalized:
            self.position = (
                Math.normalize(self.x, NORMALIZATION_MIN_VALUE, NORMALIZATION_MAX_VALUE),
                Math.normalize(self.y, NORMALIZATION_MIN_VALUE, NORMALIZATION_MAX_VALUE)
            )
    ...
    def denormalize(self):
        ...
        if self._is_normalized:
            self.position = (
                Math.denormalize(self.x, NORMALIZATION_MIN_VALUE, NORMALIZATION_MAX_VALUE),
                Math.denormalize(self.y, NORMALIZATION_MIN_VALUE, NORMALIZATION_MAX_VALUE)
            )
