...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_xla_2fpjrt_2fcompile_5foptions_2eproto PROTOBUF_EXPORT
...
struct PROTOBUF_EXPORT TableStruct_xla_2fpjrt_2fcompile_5foptions_2eproto {
  static const uint32_t offsets[];
};
PROTOBUF_EXPORT extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_xla_2fpjrt_2fcompile_5foptions_2eproto;
namespace xla {
