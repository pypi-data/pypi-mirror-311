...
if (ispin == 2):
   for nspin in range(1,(2+1)):
      ...
      if (nspin == 1):
         number = 0
         VTemp = outcar.readline(); VTemp = outcar.readline(); VTemp = outcar.readline()
      if (nspin == 2):
         number = 0
         VTemp = outcar.readline(); VTemp = outcar.readline(); VTemp = outcar.readline(); VTemp = outcar.readline()     
