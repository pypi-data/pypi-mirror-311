...
class ObjectExpr11(Decoder_1[str]):
...
string: Decoder_1[str] = ObjectExpr11()

class ObjectExpr12(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
...
char: Decoder_1[str] = ObjectExpr12()

class ObjectExpr15(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, str]
            out_arg: str = "00000000-0000-0000-0000-000000000000"
            def _arrow13(__unit: None=None) -> str:
                return out_arg

            def _arrow14(v: str) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_1(helpers.as_string(value_1), FSharpRef(_arrow13, _arrow14)), out_arg)
...
guid: Decoder_1[str] = ObjectExpr15()

class ObjectExpr16(Decoder_1[None]):
...
unit: Decoder_1[None] = ObjectExpr16()

class ObjectExpr19(Decoder_1[int8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow17(__unit: None=None) -> int8:
                return out_arg

            def _arrow18(v: int8) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 8, FSharpRef(_arrow17, _arrow18)), out_arg)
...
sbyte: Decoder_1[int8] = ObjectExpr19()

class ObjectExpr23(Decoder_1[uint8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow21(__unit: None=None) -> uint8:
                return out_arg

            def _arrow22(v: uint8) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 8, FSharpRef(_arrow21, _arrow22)), out_arg)
...
byte: Decoder_1[uint8] = ObjectExpr23()

class ObjectExpr26(Decoder_1[int16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow24(__unit: None=None) -> int16_1:
                return out_arg

            def _arrow25(v: int16_1) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 16, FSharpRef(_arrow24, _arrow25)), out_arg)
...
int16: Decoder_1[int16_1] = ObjectExpr26()

class ObjectExpr29(Decoder_1[uint16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow27(__unit: None=None) -> uint16_1:
                return out_arg

            def _arrow28(v: uint16_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 16, FSharpRef(_arrow27, _arrow28)), out_arg)
...
uint16: Decoder_1[uint16_1] = ObjectExpr29()

class ObjectExpr32(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            out_arg: int = 0
            def _arrow30(__unit: None=None) -> int:
                return out_arg

            def _arrow31(v: int) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 32, FSharpRef(_arrow30, _arrow31)), out_arg)
...
int_1: Decoder_1[int] = ObjectExpr32()

class ObjectExpr35(Decoder_1[uint32_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint32_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow33(__unit: None=None) -> uint32_1:
                return out_arg

            def _arrow34(v: uint32_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 32, FSharpRef(_arrow33, _arrow34)), out_arg)
...
uint32: Decoder_1[uint32_1] = ObjectExpr35()

class ObjectExpr38(Decoder_1[int64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow36(__unit: None=None) -> int64_1:
                return out_arg

            def _arrow37(v: int64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, False, 64, FSharpRef(_arrow36, _arrow37)), out_arg)
...
int64: Decoder_1[int64_1] = ObjectExpr38()

class ObjectExpr41(Decoder_1[uint64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow39(__unit: None=None) -> uint64_1:
                return out_arg

            def _arrow40(v: uint64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, True, 64, FSharpRef(_arrow39, _arrow40)), out_arg)
...
uint64: Decoder_1[uint64_1] = ObjectExpr41()

class ObjectExpr44(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_1):
            ...
            def _arrow42(__unit: None=None) -> int:
                return out_arg

            def _arrow43(v: int) -> None:
                nonlocal out_arg
                out_arg = v

            parse_result = (try_parse_4(helpers.as_string(value_1), FSharpRef(_arrow42, _arrow43)), out_arg)
...
bigint: Decoder_1[int] = ObjectExpr44()

class ObjectExpr45(Decoder_1[bool]):
...
bool_1: Decoder_1[bool] = ObjectExpr45()

class ObjectExpr46(Decoder_1[float]):
...
float_1: Decoder_1[float] = ObjectExpr46()

class ObjectExpr47(Decoder_1[float32_1]):
...
float32: Decoder_1[float32_1] = ObjectExpr47()

class ObjectExpr50(Decoder_1[Decimal]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Decimal, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_1):
            ...
            def _arrow48(__unit: None=None) -> Decimal:
                return out_arg

            def _arrow49(v: Decimal) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_5(helpers.as_string(value_1), FSharpRef(_arrow48, _arrow49)), out_arg)
...
decimal: Decoder_1[Decimal] = ObjectExpr50()

class ObjectExpr53(Decoder_1[Any]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            ...
            def _arrow51(__unit: None=None) -> Any:
                return out_arg

            def _arrow52(v: Any) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_6(helpers.as_string(value_1), FSharpRef(_arrow51, _arrow52)), out_arg)
...
datetime_local: Decoder_1[Any] = ObjectExpr53()

class ObjectExpr56(Decoder_1[Any]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, Any]
            out_arg: Any = create(0)
            def _arrow54(__unit: None=None) -> Any:
                return out_arg

            def _arrow55(v: Any) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_7(helpers.as_string(value_1), FSharpRef(_arrow54, _arrow55)), out_arg)
...
timespan: Decoder_1[Any] = ObjectExpr56()
...
def decode_maybe_null(helpers: IDecoderHelpers_1[Any], path: str, decoder: Decoder_1[Any], value_1: Any) -> FSharpResult_2[Any | None, tuple[str, ErrorReason_1[_JSONVALUE]]]:
    if helpers.is_null_value(value_1):
        ...
        if match_value.tag == 1:
            def _arrow57(__unit: None=None, helpers: Any=helpers, path: Any=path, decoder: Any=decoder, value_1: Any=value_1) -> tuple[str, ErrorReason_1[_JSONVALUE]]:
            ...
            return FSharpResult_2(1, _arrow57())
...
def optional(field_name: str, decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr58(Decoder_1[_VALUE_ | None]):
...
def map2(ctor: Callable[[_A, _B], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr59(Decoder_1[_OUTPUT_]):
...
def optional_at(field_names: FSharpList[str], decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr60(Decoder_1[_VALUE_ | None]):
...
def field(field_name: str, decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr61(Decoder_1[_VALUE_]):
...
def at(field_names: FSharpList[str], decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr62(Decoder_1[_VALUE_]):
...
def index(requested_index: int, decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr63(Decoder_1[_VALUE_]):
...
def option(decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr64(Decoder_1[_VALUE_ | None]):
...
def from_value(helpers: IDecoderHelpers_1[Any], decoder: Decoder_1[Any], value_1: Any) -> FSharpResult_2[Any, str]:
...
def list_1(decoder: Decoder_1[Any]) -> Decoder_1[FSharpList[Any]]:
    class ObjectExpr66(Decoder_1[FSharpList[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[FSharpList[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                ...
                while (error is None) if (i < len(tokens)) else False:
                    ...
                    if match_value.tag == 1:
                        def _arrow65(__unit: None=None) -> tuple[str, ErrorReason_1[__A_]]:
                        ...
                        x: tuple[str, ErrorReason_1[__A_]] | None = _arrow65()
                        error = x
...
def seq(decoder: Decoder_1[Any]) -> Decoder_1[IEnumerable_1[Any]]:
    class ObjectExpr68(Decoder_1[IEnumerable_1[_VALUE_]]):
                ...
                def folder(acc: FSharpResult_2[IEnumerable_1[_VALUE_], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[IEnumerable_1[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
                    ...
                    if acc.tag == 0:
                        ...
                        if match_value.tag == 0:
                            ...
                            def _arrow67(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                                return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])

                            return FSharpResult_2(1, _arrow67())
...
def array(decoder: Decoder_1[Any]) -> Decoder_1[Array[Any]]:
    class ObjectExpr70(Decoder_1[Array[_VALUE_]]):
                ...
                def folder(acc: FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
                    ...
                    if acc.tag == 0:
                        ...
                        if match_value.tag == 0:
                            ...
                            def _arrow69(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                                return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])

                            return FSharpResult_2(1, _arrow69())
...
class ObjectExpr71(Decoder_1[FSharpList[str]]):
...
keys: Decoder_1[FSharpList[str]] = ObjectExpr71()

def key_value_pairs(decoder: Decoder_1[Any]) -> Decoder_1[FSharpList[tuple[str, _VALUE]]]:
    class ObjectExpr72(Decoder_1[FSharpList[tuple[str, _VALUE_]]]):
...
def one_of(decoders: FSharpList[Decoder_1[Any]]) -> Decoder_1[Any]:
    class ObjectExpr73(Decoder_1[_VALUE_]):
...
def nil(output: Any | None=None) -> Decoder_1[Any]:
    class ObjectExpr74(Decoder_1[_A_]):
...
def succeed(output: Any | None=None) -> Decoder_1[Any]:
    class ObjectExpr75(Decoder_1[_A_]):
...
def fail(msg: str) -> Decoder_1[Any]:
    class ObjectExpr76(Decoder_1[_A_]):
...
def and_then(cb: Callable[[_A], Decoder_1[_B]], decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr77(Decoder_1[_B_]):
...
def all(decoders: FSharpList[Decoder_1[Any]]) -> Decoder_1[FSharpList[Any]]:
    class ObjectExpr78(Decoder_1[FSharpList[_A_]]):
...
def map(ctor: Callable[[_A], _OUTPUT], d1: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr79(Decoder_1[_OUTPUT_]):
...
def map3(ctor: Callable[[_A, _B, _C], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr80(Decoder_1[_OUTPUT_]):
...
def map4(ctor: Callable[[_A, _B, _C, _D], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr81(Decoder_1[_OUTPUT_]):
...
def map5(ctor: Callable[[_A, _B, _C, _D, _E], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr82(Decoder_1[_OUTPUT_]):
...
def map6(ctor: Callable[[_A, _B, _C, _D, _E, _F], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr83(Decoder_1[_OUTPUT_]):
...
def map7(ctor: Callable[[_A, _B, _C, _D, _E, _F, _G], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any], d7: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr84(Decoder_1[_OUTPUT_]):
...
def map8(ctor: Callable[[_A, _B, _C, _D, _E, _F, _G, _H], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any], d7: Decoder_1[Any], d8: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr85(Decoder_1[_OUTPUT_]):
...
def and_map(__unit: None=None) -> Callable[[Decoder_1[_A], Decoder_1[Callable[[_A], _B]]], Decoder_1[_B]]:
    def _arrow87(d: Decoder_1[_A]) -> Callable[[Decoder_1[Callable[[_A], _B]]], Decoder_1[_B]]:
        def _arrow86(d_1: Decoder_1[Callable[[_A], _B]]) -> Decoder_1[_B]:
...
def _expr92(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
class Getters_2(Generic[_JSONVALUE, _T]):
    def __init__(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> None:
        ...
        def _arrow89(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr88(IRequiredGetter):
        ...
        self.required: IRequiredGetter = _arrow89()
        def _arrow91(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr90(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow91()
...
def object(builder: Callable[[IGetters], _VALUE]) -> Decoder_1[Any]:
    class ObjectExpr93(Decoder_1[_VALUE_]):
