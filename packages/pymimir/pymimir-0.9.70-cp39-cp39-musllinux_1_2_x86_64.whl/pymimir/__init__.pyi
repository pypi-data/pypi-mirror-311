...
import typing
__all__ = ['ACTION_COSTS', 'ADL', 'ASSIGN', 'AStarAlgorithm', 'AStarAlgorithmEventHandlerBase', 'AStarAlgorithmStatistics', 'Abstraction', 'Action', 'ActionList', 'AssignOperatorEnum', 'Axiom', 'AxiomList', 'BinaryOperatorEnum', 'BlindHeuristic', 'BrFSAlgorithm', 'BrFSAlgorithmStatistics', 'CLOSED', 'CONDITIONAL_EFFECTS', 'CONSTRAINTS', 'Certificate2FWL', 'Certificate3FWL', 'Certificate4FWL', 'CertificateColorRefinement', 'ColorFunction', 'ColoredVertex', 'ConditionalEffect', 'DEAD_END', 'DECREASE', 'DERIVED_PREDICATES', 'DISJUNCTIVE_PRECONDITIONS', 'DIV', 'DURATIVE_ACTIONS', 'DebugAStarAlgorithmEventHandler', 'DebugBrFSAlgorithmEventHandler', 'DebugGroundedApplicableActionGeneratorEventHandler', 'DebugLiftedApplicableActionGeneratorEventHandler', 'DefaultAStarAlgorithmEventHandler', 'DefaultBrFSAlgorithmEventHandler', 'DefaultGroundedApplicableActionGeneratorEventHandler', 'DefaultIWAlgorithmEventHandler', 'DefaultLiftedApplicableActionGeneratorEventHandler', 'DefaultSIWAlgorithmEventHandler', 'DerivedAtom', 'DerivedAtomList', 'DerivedGroundAtom', 'DerivedGroundAtomList', 'DerivedGroundLiteral', 'DerivedGroundLiteralList', 'DerivedLiteral', 'DerivedLiteralList', 'DerivedPredicate', 'DerivedPredicateList', 'Domain', 'DomainList', 'EQUALITY', 'EXHAUSTED', 'EXISTENTIAL_PRECONDITIONS', 'EffectComplex', 'EffectComplexList', 'EffectSimple', 'EffectSimpleList', 'EmptyEdge', 'EmptyVertex', 'FAILED', 'FLUENTS', 'FaithfulAbstractStateVertex', 'FaithfulAbstraction', 'FaithfulAbstractionOptions', 'FaithfulAbstractionsOptions', 'FluentAtom', 'FluentAtomList', 'FluentGroundAtom', 'FluentGroundAtomList', 'FluentGroundLiteral', 'FluentGroundLiteralList', 'FluentLiteral', 'FluentLiteralList', 'FluentPredicate', 'FluentPredicateList', 'Function', 'FunctionExpression', 'FunctionExpressionBinaryOperator', 'FunctionExpressionFunction', 'FunctionExpressionList', 'FunctionExpressionMinus', 'FunctionExpressionMultiOperator', 'FunctionExpressionNumber', 'FunctionList', 'FunctionSkeleton', 'FunctionSkeletonList', 'GlobalFaithfulAbstractState', 'GlobalFaithfulAbstraction', 'GroundAction', 'GroundActionEdge', 'GroundActionList', 'GroundActionSpan', 'GroundActionsEdge', 'GroundFunction', 'GroundFunctionExpression', 'GroundFunctionExpressionBinaryOperator', 'GroundFunctionExpressionFunction', 'GroundFunctionExpressionList', 'GroundFunctionExpressionMinus', 'GroundFunctionExpressionMultiOperator', 'GroundFunctionExpressionNumber', 'GroundFunctionList', 'GroundedApplicableActionGenerator', 'IAStarAlgorithmEventHandler', 'IAlgorithm', 'IApplicableActionGenerator', 'IBrFSAlgorithmEventHandler', 'IGroundedApplicableActionGeneratorEventHandler', 'IHeuristic', 'IIWAlgorithmEventHandler', 'ILiftedApplicableActionGeneratorEventHandler', 'INCREASE', 'IN_PROGRESS', 'ISIWAlgorithmEventHandler', 'IWAlgorithm', 'IWAlgorithmStatistics', 'IndexGroupedVector', 'IsomorphismTypeCompressionFunction', 'LiftedApplicableActionGenerator', 'LiftedConjunctionGrounder', 'MAXIMIZE', 'MINIMIZE', 'MINUS', 'MUL', 'MultiOperatorEnum', 'NEGATIVE_PRECONDITIONS', 'NEW', 'NUMERIC_FLUENTS', 'NautyCertificate', 'NautyDenseGraph', 'NautySparseGraph', 'None', 'NumericFluent', 'NumericFluentList', 'OBJECT_FLUENTS', 'OPEN', 'OUT_OF_MEMORY', 'OUT_OF_TIME', 'Object', 'ObjectGraphPruningStrategy', 'ObjectGraphPruningStrategyEnum', 'ObjectList', 'OptimizationMetric', 'OptimizationMetricEnum', 'PDDLParser', 'PDDLRepositories', 'PLUS', 'PREFERENCES', 'Problem', 'ProblemColorFunction', 'ProblemList', 'QUANTIFIED_PRECONDITIONS', 'RequirementEnum', 'Requirements', 'SCALE_DOWN', 'SCALE_UP', 'SIWAlgorithm', 'SIWAlgorithmStatistics', 'SOLVED', 'STRIPS', 'SearchNodeStatus', 'SearchStatus', 'SimpleFluentEffect', 'State', 'StateList', 'StateRepository', 'StateSpace', 'StateSpaceOptions', 'StateSpacesOptions', 'StateSpan', 'StateVertex', 'StaticAtom', 'StaticAtomList', 'StaticDigraph', 'StaticGroundAtom', 'StaticGroundAtomList', 'StaticGroundLiteral', 'StaticGroundLiteralList', 'StaticLiteral', 'StaticLiteralList', 'StaticPredicate', 'StaticPredicateList', 'StaticScc', 'StaticVertexColoredDigraph', 'StringToDerivedPredicateMap', 'StringToFluentPredicateMap', 'StringToStaticPredicateMap', 'StripsActionEffect', 'StripsActionPrecondition', 'TIMED_INITIAL_LITERALS', 'TYPING', 'Term', 'TermList', 'TupleGraph', 'TupleGraphFactory', 'TupleGraphVertex', 'TupleGraphVertexIndexGroupedVector', 'TupleGraphVertexSpan', 'TupleIndexMapper', 'UNIVERSAL_PRECONDITIONS', 'UNSOLVABLE', 'Variable', 'VariableList', 'compute_certificate_2fwl', 'compute_certificate_3fwl', 'compute_certificate_4fwl', 'compute_certificate_color_refinement', 'create_object_graph']
class AStarAlgorithm(IAlgorithm):
    @typing.overload
    def __init__(self, applicable_action_generator: IApplicableActionGenerator, heuristic: IHeuristic) -> None:
        ...
    @typing.overload
    def __init__(self, applicable_action_generator: IApplicableActionGenerator, state_repository: StateRepository, heuristic: IHeuristic, event_handler: IAStarAlgorithmEventHandler) -> None:
        ...
...
class Action:
    ...
    def get_arity(self) -> int:
        ...
    def get_complex_effects(self) -> EffectComplexList:
        ...
...
class BrFSAlgorithm(IAlgorithm):
    @typing.overload
    def __init__(self, applicable_action_generator: IApplicableActionGenerator) -> None:
        ...
    @typing.overload
    def __init__(self, applicable_action_generator: IApplicableActionGenerator, state_repository: StateRepository, event_handler: IBrFSAlgorithmEventHandler) -> None:
        ...
...
class ConditionalEffect:
    ...
    def get_fluent_positive_condition(self) -> FlatIndexList:
        ...
    def get_simple_effect(self) -> SimpleFluentEffect:
        ...
...
class EffectComplex:
    ...
    def get_static_conditions(self) -> StaticLiteralList:
        ...
class EffectComplexList:
    __hash__: typing.ClassVar[None] = None
    def __bool__(self) -> bool:
        """
        Check whether the list is nonempty
        """
    def __contains__(self, x: EffectComplex) -> bool:
        """
        Return true the container contains ``x``
        """
    @typing.overload
    ...
    def __delitem__(self, arg0: slice) -> None:
        ...
        Delete list elements using a slice object
        """
    def __eq__(self, arg0: EffectComplexList) -> bool:
        ...
    @typing.overload
    def __getitem__(self, s: slice) -> EffectComplexList:
        """
        Retrieve list elements using a slice object
        """
    @typing.overload
    def __getitem__(self, arg0: int) -> EffectComplex:
        ...
    @typing.overload
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: EffectComplexList) -> None:
        """
        Copy constructor
        """
    @typing.overload
    ...
    def __len__(self) -> int:
        ...
    def __ne__(self, arg0: EffectComplexList) -> bool:
        ...
    def __repr__(self) -> str:
        """
        Return the canonical string representation of this list.
        """
    @typing.overload
    def __setitem__(self, arg0: int, arg1: EffectComplex) -> None:
        ...
    @typing.overload
    def __setitem__(self, arg0: slice, arg1: EffectComplexList) -> None:
        """
        Assign list elements using a slice object
        """
    def append(self, x: EffectComplex) -> None:
        """
        Add an item to the end of the list
        """
    def clear(self) -> None:
        ...
        Clear the contents
        """
    def count(self, x: EffectComplex) -> int:
        """
        Return the number of times ``x`` appears in the list
        """
    @typing.overload
    def extend(self, L: EffectComplexList) -> None:
        """
        Extend the list by appending all the items in the given list
        """
    @typing.overload
    def extend(self, L: typing.Iterable) -> None:
        ...
        Extend the list by appending all the items in the given list
        """
    def insert(self, i: int, x: EffectComplex) -> None:
        """
        Insert an item at a given position.
        """
    @typing.overload
    def pop(self) -> EffectComplex:
        """
        Remove and return the last item
        """
    @typing.overload
    def pop(self, i: int) -> EffectComplex:
        """
        Remove and return the item at index ``i``
        """
    def remove(self, x: EffectComplex) -> None:
        """
        Remove the first item from the list whose value is x. It is an error if there is no such item.
        """
class EffectSimple:
...
class FaithfulAbstraction:
    ...
    @staticmethod
    @typing.overload
    def create(problem: Problem, factories: PDDLRepositories, applicable_action_generator: IApplicableActionGenerator, state_repository: StateRepository, options: FaithfulAbstractionOptions = ...) -> FaithfulAbstraction | None:
        ...
    @staticmethod
    @typing.overload
    ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[Problem, PDDLRepositories, IApplicableActionGenerator, StateRepository]], options: FaithfulAbstractionsOptions = ...) -> list[FaithfulAbstraction]:
        ...
    def __str__(self) -> str:
        ...
...
class GlobalFaithfulAbstraction:
    ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[Problem, PDDLRepositories, IApplicableActionGenerator, StateRepository]], options: FaithfulAbstractionsOptions = ...) -> list[GlobalFaithfulAbstraction]:
        ...
    def __str__(self) -> str:
        ...
    def compute_pairwise_shortest_backward_state_distances(self) -> list[list[float]]:
...
class GroundAction:
    ...
    def get_object_indices(self) -> FlatIndexList:
        ...
    def get_strips_effect(self) -> StripsActionEffect:
        ...
    def get_strips_precondition(self) -> StripsActionPrecondition:
        ...
...
class GroundedApplicableActionGenerator(IApplicableActionGenerator):
    ...
    def __init__(self, problem: Problem, pddl_repositories: PDDLRepositories) -> None:
        ...
    @typing.overload
    def __init__(self, problem: Problem, pddl_repositories: PDDLRepositories, event_handler: IGroundedApplicableActionGeneratorEventHandler) -> None:
        ...
...
class IApplicableActionGenerator:
    ...
    def get_ground_actions(self) -> GroundActionList:
        ...
    def get_ground_axiom(self, axiom_index: int) -> ...:
        ...
    def get_ground_axioms(self) -> list[...]:
        ...
    def get_pddl_repositories(self) -> PDDLRepositories:
        ...
    def get_problem(self) -> Problem:
...
class IWAlgorithm(IAlgorithm):
    @typing.overload
    def __init__(self, applicable_action_generator: IApplicableActionGenerator, max_arity: int) -> None:
        ...
    @typing.overload
    def __init__(self, applicable_action_generator: IApplicableActionGenerator, max_arity: int, state_repository: StateRepository, brfs_event_handler: IBrFSAlgorithmEventHandler, iw_event_handler: IIWAlgorithmEventHandler) -> None:
        ...
...
class LiftedApplicableActionGenerator(IApplicableActionGenerator):
    ...
    def __init__(self, problem: Problem, pddl_repositories: PDDLRepositories) -> None:
        ...
    @typing.overload
    def __init__(self, problem: Problem, pddl_repositories: PDDLRepositories, event_handler: ILiftedApplicableActionGeneratorEventHandler) -> None:
        ...
class LiftedConjunctionGrounder:
    def __init__(self, problem: Problem, variables: VariableList, static_literals: StaticLiteralList, fluent_literals: FluentLiteralList, derived_literals: DerivedLiteralList, pddl_repositories: PDDLRepositories) -> None:
        ...
    def ground(self, state: State) -> tuple[list[ObjectList], tuple[list[StaticGroundLiteralList], list[FluentGroundLiteralList], list[DerivedGroundLiteralList]]]:
        ...
...
class SIWAlgorithm(IAlgorithm):
    ...
    def __init__(self, applicable_action_generator: IApplicableActionGenerator, max_arity: int) -> None:
        ...
    @typing.overload
    def __init__(self, applicable_action_generator: IApplicableActionGenerator, max_arity: int, state_repository: StateRepository, brfs_event_handler: IBrFSAlgorithmEventHandler, iw_event_handler: IIWAlgorithmEventHandler, siw_event_handler: ISIWAlgorithmEventHandler) -> None:
        ...
...
class StateSpace:
    ...
    @staticmethod
    @typing.overload
    def create(problem: Problem, factories: PDDLRepositories, applicable_action_generator: IApplicableActionGenerator, state_repository: StateRepository, options: StateSpaceOptions = ...) -> StateSpace | None:
        ...
    @staticmethod
    @typing.overload
    ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[Problem, PDDLRepositories, IApplicableActionGenerator, StateRepository]], options: StateSpacesOptions = ...) -> list[StateSpace]:
        ...
    def __str__(self) -> str:
        ...
    def compute_pairwise_shortest_backward_state_distances(self) -> list[list[float]]:
