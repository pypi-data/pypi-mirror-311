...
def track_event(
    ...
    try:
        ...
        # print(app_id, project_id, config.app_id)
    ...
    def decorator(fn):
        ...
        def wrapper(*args, **kwargs):
            if input_arg is not None:
                ...
                parsed_input = default_input_parser(args, kwargs)
...
def class_chain(name=None, user_id=None, user_props=None, tags=None, app_id=None):
    def decorator(fn):
        @wraps(fn)
        def wrapper(self, *args, **kwargs):
            ...
            return wrap(
                ...
                user_props=user_props,
                tags=tags,
                input_parser=method_input_parser,  
