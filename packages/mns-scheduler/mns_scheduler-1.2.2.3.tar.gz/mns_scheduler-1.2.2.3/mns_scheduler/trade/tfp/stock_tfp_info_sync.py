...
def sync_stock_tfp(str_day):
    ...
    if data_frame_util.is_not_empty(stock_tfp_df):
        ...
        # 根据条件设置新列'type'的值
        stock_tfp_df.loc[stock_tfp_df['sus_period'] == '停牌一天', 'type'] = '1'
        stock_tfp_df.loc[stock_tfp_df['sus_period'] == '盘中停牌', 'type'] = '2'
        stock_tfp_df.loc[stock_tfp_df['sus_period'] == '连续停牌', 'type'] = '3'
