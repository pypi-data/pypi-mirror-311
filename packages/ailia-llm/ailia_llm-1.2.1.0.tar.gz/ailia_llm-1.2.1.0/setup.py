...
scripts = []
for f in glob.glob("ailia_llm/*.py"):
    scripts.append(f)
...
if __name__ == "__main__":
    setup(
        ...
        package_data={"ailia_llm":find_libraries()},
