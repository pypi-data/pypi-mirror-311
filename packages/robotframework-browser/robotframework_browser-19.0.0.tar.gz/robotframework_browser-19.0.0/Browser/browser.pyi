...
class Browser(DynamicCore):
    ...
    def start_coverage(self, *, config_file: typing.Optional[os.PathLike] = None, coverage_type: CoverageType = CoverageType.all, folder: typing.Optional[str] = None, raw: bool = False, reportAnonymousScripts: bool = False, resetOnNavigation: bool = True): ...
