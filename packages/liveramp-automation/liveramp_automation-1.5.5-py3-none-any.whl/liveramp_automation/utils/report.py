...
class reportUtils:
    ...
    def upload_report_files_to_gcs_bucket(self,
                                          projectId="liveramp-eng-qa-reliability",
                                          bucketName=os.getenv("BUCKET_NAME","defalut_bucket"),
                                          pathName=os.getenv("BUCKET_PATH_NAME","defalut_bucket/default_path")):
        self.projectId = projectId
        self.bucketName = bucketName
        self.pathName = pathName
        BucketHelper(self.projectId, self.bucketName).upload_file(self.report_folder, self.pathName)
