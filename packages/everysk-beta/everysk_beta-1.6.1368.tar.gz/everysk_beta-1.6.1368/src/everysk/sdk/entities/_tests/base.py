...
class TestBaseEntity(TestCase):
    ...
    def test_load(self):
        ...
        expected_data = compress({'class_name': 'Query', 'method_name': 'load', 'self_obj': query.to_dict(add_class_path=True), 'params': {'offset': 5}}, protocol='gzip', serialize='json')
        mock_post.assert_called_with(url=self.api_url, headers=self.headers, timeout=httpx.Timeout(timeout=30, read=settings.EVERYSK_SDK_HTTP_DEFAULT_TIMEOUT), data=expected_data)
    ...
    def test_list(self):
        ...
        expected_data = compress({'class_name': 'Query', 'method_name': 'loads', 'self_obj': query.to_dict(add_class_path=True), 'params': {'limit': 10, 'offset': 5}}, protocol='gzip', serialize='json')
        mock_post.assert_called_with(url=self.api_url, headers=self.headers, timeout=httpx.Timeout(timeout=30, read=settings.EVERYSK_SDK_HTTP_DEFAULT_TIMEOUT), data=expected_data)
    ...
    def test_page(self):
        ...
        expected_data = compress({'class_name': 'Query', 'method_name': 'page', 'self_obj': query_class.to_dict(add_class_path=True), 'params': {'page_size': 10, 'page_token': 'page_token'}}, protocol='gzip', serialize='json')
    ...
    def test_pages(self):
        ...
        expected_data = compress({'class_name': 'Query', 'method_name': 'page', 'self_obj': query.to_dict(add_class_path=True), 'params': {'page_size': 10, 'page_token': {'__undefined__': None}}}, protocol='gzip', serialize='json')
    ...
    def test_script_query(self):
        expected_data = compress({'class_name': 'Script', 'method_name': 'inner_fetch', 'self_obj': {'_klass': 'Portfolio', '__class_path__': 'everysk.sdk.entities.script.Script'}, 'params': {'user_input': 'port_12456', 'variant': 'select', 'workspace': None}}, protocol='gzip', serialize='json')
        ...
        expected_data = compress({'class_name': 'Script', 'method_name': 'inner_fetch', 'self_obj': Portfolio.script.to_dict(add_class_path=True), 'params': {'user_input': 'port_12456', 'variant': 'select', 'workspace': None}}, protocol='gzip', serialize='json')
        mock_post.assert_called_with(url=self.api_url, headers=self.headers, timeout=httpx.Timeout(timeout=30, read=settings.EVERYSK_SDK_HTTP_DEFAULT_TIMEOUT), data=expected_data)
        self.assertIsInstance(result, Portfolio)
    ...
    def test_save(self):
        ...
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'save', 'self_obj': portfolio.to_dict(add_class_path=True), 'params': {}}, protocol='gzip', serialize='json')
    ...
    def test_delete(self):
        self.sample_portfolio_data['securities'] = []
        portfolio = Portfolio(**self.sample_portfolio_data)
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'delete', 'self_obj': portfolio.to_dict(add_class_path=True), 'params': {}}, protocol='gzip', serialize='json')
