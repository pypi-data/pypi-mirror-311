...
class PluginManifest(SubscriptableBaseModel):
    ...
    Constructs a Plugin Manifest, which identifies the application, describes how it can work, and defines any runtime code dependancies.
        ...
        :param bool inbound_results_uses_json: A flag to indicate whether or not the plugin returns inbound sync results in JSON format (RECORD_DATA column) or straight into OBJECT columns (RECORD_OBJECT column).
        :param bool outbound_results_uses_json: A flag to indicate whether or not the plugin returns outbound sync results in JSON format (RESULT column) or straight into OBJECT columns (RESULT_OBJECT column).
    """
    ...
    inbound_results_uses_json: bool = True
    outbound_results_uses_json: bool = True
