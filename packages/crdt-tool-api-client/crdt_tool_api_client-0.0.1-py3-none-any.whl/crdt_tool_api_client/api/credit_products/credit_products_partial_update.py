...
from ...models.patched_credit_product import PatchedCreditProduct
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedCreditProduct):
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[CreditProduct]:
    if response.status_code == 200:
        response_200 = CreditProduct.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedCreditProduct): Serializer for the CreditProduct model.
        body (PatchedCreditProduct): Serializer for the CreditProduct model.
        body (PatchedCreditProduct): Serializer for the CreditProduct model.
