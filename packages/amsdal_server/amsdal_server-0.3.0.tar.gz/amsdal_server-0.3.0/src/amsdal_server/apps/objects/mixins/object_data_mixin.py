    ...
    def get_metadata(
        ...
        *,
        ...
        return Metadata(
            ...
            class_schema_reference=build_class_schema_reference(item.__class__.__name__, item.__class__),
            class_meta_schema_reference=build_class_meta_schema_reference(
                item.__class__.__name__,
                item.object_id,
            ),
            class_schema_type=class_manager.resolve_schema_type(item.__class__.__name__),
        )
