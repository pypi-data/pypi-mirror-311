...
from djangoAccessPointPackage.django_access_point.models.custom_field import CUSTOM_FIELD_STATUS
    ...
    def _check_custom_field_options_model(self):
        if not self.custom_field_options_model:
            raise ImproperlyConfigured(
                "Django Access Point: 'custom_field_options_model' must be defined in the child class."
            )