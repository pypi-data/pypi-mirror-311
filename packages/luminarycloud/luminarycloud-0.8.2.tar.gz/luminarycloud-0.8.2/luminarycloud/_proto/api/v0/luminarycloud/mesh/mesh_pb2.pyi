...
class MeshGenerationParams(google.protobuf.message.Message):
    ...
    """Whether to add refinement boxes"""
    ...
    def HasField(self, field_name: typing_extensions.Literal["body_x_axis", b"body_x_axis", "body_y_axis", b"body_y_axis"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["add_refinement", b"add_refinement", "bl_params", b"bl_params", "body_x_axis", b"body_x_axis", "body_y_axis", b"body_y_axis", "model_params", b"model_params", "proximity_layers", b"proximity_layers", "refine_params", b"refine_params", "volume_params", b"volume_params"]) -> None: ...
