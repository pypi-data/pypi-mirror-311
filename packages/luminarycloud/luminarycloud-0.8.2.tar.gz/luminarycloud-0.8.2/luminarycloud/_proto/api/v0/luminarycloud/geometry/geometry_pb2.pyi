...
class Geometry(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "deleted", b"deleted", "id", b"id", "last_version_id", b"last_version_id", "name", b"name", "uses_tags", b"uses_tags"]) -> None: ...
...
class TessellationData(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cad_metadata", b"cad_metadata", "data", b"data", "feature_id", b"feature_id", "geometry_version_id", b"geometry_version_id", "lcn_meta", b"lcn_meta", "meta_data", b"meta_data"]) -> None: ...
...
class CreateGeometryRequest(google.protobuf.message.Message):
    ...
    """
    url: builtins.str
    """Required. Url of the source CAD file. File must have been uploaded to the
    ...
    """
    uses_tags: builtins.bool
    """Whether this geometry uses Tags (vs Surface Groups)."""
    def __init__(
        self,
        *,
        project_id: builtins.str = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["name", b"name", "project_id", b"project_id", "scaling", b"scaling", "url", b"url", "uses_tags", b"uses_tags", "wait", b"wait"]) -> None: ...
