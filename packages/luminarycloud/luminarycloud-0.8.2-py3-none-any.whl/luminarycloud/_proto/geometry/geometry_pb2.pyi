...
class Import(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["geometry_url", b"geometry_url", "scaling", b"scaling"]) -> None: ...
...
class Shrinkwrap(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["body", b"body", "mode", b"mode", "resolution_max", b"resolution_max", "resolution_min", b"resolution_min"]) -> None: ...
...
class Farfield(google.protobuf.message.Message):
    ...
    def bodies(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
        """Bodies to be subtracted from create body. If empty, it is supposed that all
        bodies are to be subtracted.
        """
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bodies", b"bodies", "create", b"create", "keep_source_bodies", b"keep_source_bodies", "keep_tool_bodies", b"keep_tool_bodies"]) -> None: ...
...
class Feature(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["boolean", b"boolean", "create", b"create", "delete", b"delete", "farfield", b"farfield", "import", b"import", "imprint", b"imprint", "operation", b"operation", "pattern", b"pattern", "shrinkwrap", b"shrinkwrap", "transform", b"transform"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["boolean", b"boolean", "create", b"create", "delete", b"delete", "farfield", b"farfield", "feature_name", b"feature_name", "id", b"id", "import", b"import", "imprint", b"imprint", "operation", b"operation", "pattern", b"pattern", "shrinkwrap", b"shrinkwrap", "transform", b"transform"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["operation", b"operation"]) -> typing_extensions.Literal["import", "create", "delete", "boolean", "imprint", "transform", "shrinkwrap", "farfield", "pattern"] | None: ...
