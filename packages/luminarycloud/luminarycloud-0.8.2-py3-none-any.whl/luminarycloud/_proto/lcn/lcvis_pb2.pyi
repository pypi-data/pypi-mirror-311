...
class CustomExpression(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___CustomExpression = CustomExpression

class CustomExpressions(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    EXPRESSIONS_FIELD_NUMBER: builtins.int
    @property
    def expressions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CustomExpression]: ...
    def __init__(
        self,
        *,
        expressions: collections.abc.Iterable[global___CustomExpression] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["expressions", b"expressions"]) -> None: ...

global___CustomExpressions = CustomExpressions
