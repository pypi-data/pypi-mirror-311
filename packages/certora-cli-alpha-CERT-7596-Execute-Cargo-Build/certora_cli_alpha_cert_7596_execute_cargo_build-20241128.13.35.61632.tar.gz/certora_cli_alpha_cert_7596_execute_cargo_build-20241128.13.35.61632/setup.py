...
setuptools.setup(
    name="certora-cli-alpha-CERT-7596_Execute_Cargo_Build",
    version="20241128.13.35.061632",
    author="Certora",
    author_email="support@certora.com",
    description="Runner for the Certora Prover",
    long_description="Commit 94bbe01.                    Build and Run scripts for executing the Certora Prover on Solidity smart contracts.",
    long_description_content_type="text/markdown",
    url="https://pypi.org/project/certora-cli-alpha-CERT-7596_Execute_Cargo_Build",
