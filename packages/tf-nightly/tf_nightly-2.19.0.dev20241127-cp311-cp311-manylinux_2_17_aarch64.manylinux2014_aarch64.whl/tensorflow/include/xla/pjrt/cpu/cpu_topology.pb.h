...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_xla_2fpjrt_2fcpu_2fcpu_5ftopology_2eproto PROTOBUF_EXPORT
...
struct PROTOBUF_EXPORT TableStruct_xla_2fpjrt_2fcpu_2fcpu_5ftopology_2eproto {
  static const uint32_t offsets[];
};
PROTOBUF_EXPORT extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_xla_2fpjrt_2fcpu_2fcpu_5ftopology_2eproto;
namespace xla {
...
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_EXPORT ::xla::CpuTopologyProto* Arena::CreateMaybeMessage<::xla::CpuTopologyProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::CpuTopologyProto_CpuDevice* Arena::CreateMaybeMessage<::xla::CpuTopologyProto_CpuDevice>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace xla {

// ===================================================================

class PROTOBUF_EXPORT CpuTopologyProto_CpuDevice final :
...
class PROTOBUF_EXPORT CpuTopologyProto final :
