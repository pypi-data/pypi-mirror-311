...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(1) SKipDmaInfoTrack FLATBUFFERS_FINAL_CLASS {
 private:
 ...
 public:
  ...
  SKipDmaInfoTrack(const akida::fb::SkipDmaIdent &_ident, uint8_t _skip_length)
      : ident_(_ident),
...
FLATBUFFERS_STRUCT_END(SKipDmaInfoTrack, 5);
...
struct ProgramInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<const akida::fb::SKipDmaInfoTrack *> *skipdma_track() const {
    return GetPointer<const flatbuffers::Vector<const akida::fb::SKipDmaInfoTrack *> *>(VT_SKIPDMA_TRACK);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_SKIPDMA_TRACK) &&
           verifier.VerifyVector(skipdma_track()) &&
...
struct ProgramInfoBuilder {
  ...
  void add_skipdma_track(flatbuffers::Offset<flatbuffers::Vector<const akida::fb::SKipDmaInfoTrack *>> skipdma_track) {
    fbb_.AddOffset(ProgramInfo::VT_SKIPDMA_TRACK, skipdma_track);
  }
...
inline flatbuffers::Offset<ProgramInfo> CreateProgramInfo(
    ...
    flatbuffers::Offset<flatbuffers::Vector<const akida::fb::SKipDmaInfoTrack *>> skipdma_track = 0,
    const akida::fb::TrackSpan *dummy_header = nullptr) {
  ProgramInfoBuilder builder_(_fbb);
  builder_.add_dummy_header(dummy_header);
  builder_.add_skipdma_track(skipdma_track);
...
inline flatbuffers::Offset<ProgramInfo> CreateProgramInfoDirect(
    ...
    flatbuffers::Offset<akida::fb::LearningLayerInfo> learning_layer = 0,
    const std::vector<akida::fb::SKipDmaInfoTrack> *skipdma_track = nullptr,
    const akida::fb::TrackSpan *dummy_header = nullptr) {
  ...
  auto skipdma_track__ = skipdma_track ? _fbb.CreateVectorOfStructs<akida::fb::SKipDmaInfoTrack>(*skipdma_track) : 0;
