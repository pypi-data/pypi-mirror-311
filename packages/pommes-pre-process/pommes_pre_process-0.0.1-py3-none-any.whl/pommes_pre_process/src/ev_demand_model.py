...
def sum_exogenous_demand_and_electric_vehicle_demand(
    ...
    return aligned_exo_demand_xr + aligned_ev_demand_xr_filled
...
def create_total_consumption_xarray_dataset(
    ...
    for dataarray in [area_ev_fleet_xr, total_ev_consumption_xr]:
        consumption_per_million_ev_xr = add_dataarray_to_dataset(
            consumption_per_million_ev_xr, dataarray
        )

    return consumption_per_million_ev_xr
