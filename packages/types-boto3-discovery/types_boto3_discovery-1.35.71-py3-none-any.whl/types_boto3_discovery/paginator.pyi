...
class DescribeAgentsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_discovery/paginators/#describeagentspaginator)
    """
    def paginate(
...
class DescribeContinuousExportsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_discovery/paginators/#describecontinuousexportspaginator)
    """
    def paginate(
        self,
...
class DescribeExportConfigurationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_discovery/paginators/#describeexportconfigurationspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class DescribeExportTasksPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_discovery/paginators/#describeexporttaskspaginator)
    """
    def paginate(
...
class DescribeImportTasksPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_discovery/paginators/#describeimporttaskspaginator)
    """
    def paginate(
...
class DescribeTagsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_discovery/paginators/#describetagspaginator)
    """
    def paginate(
...
class ListConfigurationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_discovery/paginators/#listconfigurationspaginator)
    """
    def paginate(
