...
class ScientificSpinBox(QtWidgets.QDoubleSpinBox):
    ...
    def debugEditingFinished(self) -> None:
        _logger.debug("Intercepted event: emmited editingFinished")
        pass

    def debugValueChanged(self, value: str) -> None:
        _logger.debug(f"Intercepted event: emmited valueChanged, {value=},  stack1={inspect.stack()[1][3]}, stack2={inspect.stack()[2][3]}")
        pass
    ...
    def debugBaseValueChanged(self, value: PintInterface.ValueType) -> None:
        _logger.debug(f"Intercepted event: emmited baseValueChanged, {value=}, stack1={inspect.stack()[1][3]}, stack2={inspect.stack()[2][3]}")
        pass
    ...
    def onEditingFinished(self) -> None:
        ...
        old_base_quantity = self._baseQuantity
        ...
        # Emit custom signals
        if old_base_quantity != self._baseQuantity:
            self.baseQuantityChanged.emit(self.baseQuantity)
    ...
    def setBaseValue(self, value: PintInterface.ValueType | float) -> None:
