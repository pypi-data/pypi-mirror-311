...
class FleetActiveWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_deadline/waiters/#fleetactivewaiter)
    """
...
class JobCreateCompleteWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_deadline/waiters/#jobcreatecompletewaiter)
    """
...
class LicenseEndpointDeletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_deadline/waiters/#licenseendpointdeletedwaiter)
    """
    def wait(
...
class LicenseEndpointValidWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_deadline/waiters/#licenseendpointvalidwaiter)
    """
    def wait(
...
class QueueFleetAssociationStoppedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_deadline/waiters/#queuefleetassociationstoppedwaiter)
    """
    def wait(
        self,
...
class QueueSchedulingBlockedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_deadline/waiters/#queueschedulingblockedwaiter)
    """
...
class QueueSchedulingWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_deadline/waiters/#queueschedulingwaiter)
    """
