...
class HctlFormula:
    ...
    @staticmethod
    def mk_hybrid(op: HybridOperator, state_variable: str, inner: HctlFormula, domain: str | None = None) -> HctlFormula: ...
    @staticmethod
    ...
    def as_hybrid_in(self) -> Optional[tuple[HybridOperator, str, str, HctlFormula]]: ...
