...
from docknet.clients import DeploymentClient, FileClient
...
from docknet.operations import ExtensionOperations, ServiceOperations
from docknet.operations.components import ComponentOperations
from docknet.schema import ExtensibleOperations, Extension, ExtensionInput, Service
from docknet.schema.deployment import DeploymentType, ServiceInput
from docknet.schema.extension import (
    CORE_EXTENSION_ID,
...
def map_service_to_extension(service: Service, user_id: str) -> Extension:
    ...
    if service.metadata:
        ...
        endpoint_prefix = f"{config.settings.DOCKNET_BASE_URL}/projects/{project_id}/services/{deployment_id}/access/"
