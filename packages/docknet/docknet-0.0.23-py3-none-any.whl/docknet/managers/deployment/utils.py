...
from docknet.operations import AuthOperations, SystemOperations
from docknet.operations.components import ComponentOperations
from docknet.schema import (
    AccessLevel,
    ClientValueError,
    TokenType,
    UnauthenticatedError,
)
from docknet.schema.auth import TokenPurpose
...
from docknet.utils import auth_utils, id_utils
from docknet.utils.auth_utils import parse_userid_from_resource_name
...
_ENV_VARIABLE_DOCKNET_BASE_URL = "DOCKNET_BASE_URL"
_ENV_VARIABLE_DOCKNET_API_ENDPOINT = "DOCKNET_API_ENDPOINT"
_ENV_VARIABLE_DOCKNET_API_TOKEN = "DOCKNET_API_TOKEN"
_ENV_VARIABLE_DOCKNET_SERVICE_URL = "DOCKNET_SERVICE_URL"
_ENV_VARIABLE_DOCKNET_DEPLOYMENT_NAME = "DOCKNET_DEPLOYMENT_NAME"
...
def get_default_environment_variables(
    ...
    default_environment_variables = {
        _ENV_VARIABLE_DOCKNET_DEPLOYMENT_NAME: deployment_id,
        _ENV_VARIABLE_DOCKNET_BASE_URL: settings.DOCKNET_BASE_URL,
        _ENV_VARIABLE_DOCKNET_API_ENDPOINT: settings.DOCKNET_API_ENDPOINT,
    }
    ...
    if compute_resources:
        ...
        if compute_resources.max_volume_size is not None:
            default_environment_variables["DOCKNET_MAX_VOLUME_SIZE_MB"] = str(
...
def replace_template_string(
    ...
    For example, if `template = "{env.DOCKNET_BASE_URL}"` and `values = { "{env.DOCKNET_BASE_URL}": "some-value" } }`, the result will be
    `"some-value"`
