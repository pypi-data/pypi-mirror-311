...
from docknet.schema import CoreOperations, SystemInfo, SystemStatistics
...
from docknet.schema.system import IMAGE_NAME_PARAM, AllowedImageInfo
...
def display_register_admin_form(
    ...
    route = os.path.join(
        config.settings.DOCKNET_BASE_URL,
