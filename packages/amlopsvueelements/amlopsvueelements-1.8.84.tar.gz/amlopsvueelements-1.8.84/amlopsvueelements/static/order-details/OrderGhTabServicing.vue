<template>
  <div class="w-full h-auto flex flex-col gap-2">
    ...
    <div class="servicing-step bg-white w-full border border-transparent rounded-md">
      <div
        class="servicing-step-header flex justify-between items-center py-[0.75rem] px-[0.75rem]"
      >
        <div class="servicing-step-header-name">Client Documents</div>
        <div class="servicing-step-header-actions flex gap-4">
      ...
      <div v-if="mockDocuments.length" class="servicing-step-content w-full flex flex-col">
        <div class="servicing-step-content-header-wrap w-full flex items-center">
          <div class="servicing-step-content-col w-3/12">
            <div class="servicing-step-content-col-header px-[0.75rem] py-[0.5rem]">Type</div>
          </div>
          <div class="servicing-step-content-col w-2/12">
            <div class="servicing-step-content-col-header px-[0.75rem] py-[0.5rem]">Name</div>
          </div>
          <div class="servicing-step-content-col w-2/12">
            <div class="servicing-step-content-col-header px-[0.75rem] py-[0.5rem]">Entity</div>
          </div>
          <div class="servicing-step-content-col w-2/12">
            <div class="servicing-step-content-col-header px-[0.75rem] py-[0.5rem]">Valid From</div>
          </div>
          <div class="servicing-step-content-col w-2/12">
            <div class="servicing-step-content-col-header px-[0.75rem] py-[0.5rem]">Valid To</div>
          </div>
          <div class="servicing-step-content-col w-1/12">
            <div class="servicing-step-content-col-header px-[0.75rem] py-[0.5rem]">&nbsp;</div>
          </div>
        </div>
        <div
          v-for="(document, index) in mockDocuments"
          :key="index"
          class="servicing-step-content-data-wrap selected-supplier w-full flex items-center"
        >
          <div class="servicing-step-content-col w-3/12">
            <div class="servicing-step-content-col-data px-[0.75rem] py-[0.5rem]">
              {{ document.type }}
            </div>
          </div>
          <div class="servicing-step-content-col w-2/12">
...
const mockDocuments = ref([
  {
    ...
    name: 'Proof of Tax Reg',
    entity: 'Luxaviation',
    valid_from: new Date().toLocaleDateString('en-CA'),
    valid_to: new Date().toLocaleDateString('en-CA')
  },
  {
    type: 'AOC Ops Specification',
    name: 'Latest Ops Spec',
    entity: '84-0001 (Beechcraft C-12U)',
    valid_from: new Date().toLocaleDateString('en-CA'),
    valid_to: new Date().toLocaleDateString('en-CA')
  }
]);
