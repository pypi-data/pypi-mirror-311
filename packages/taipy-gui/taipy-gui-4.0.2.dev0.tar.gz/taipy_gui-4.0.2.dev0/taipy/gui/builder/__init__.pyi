...
class navbar(_Control):
    ...
    def __init__(
        ...
        *,
        ...
        """Creates a navbar element.\n\nParameters\n----------\n\nlov\n  The list of pages. The keys should be:\n  \n  * page id (start with "/")\n  * or full URL\n  \n  The values are labels. See the [section on List of Values](https://docs.taipy.io/en/develop/manuals/userman/gui/viselements/generic/navbar/../../../../../../userman/gui/binding/#list-of-values) for more details.\n\nactive (dynamic)\n  Indicates if this component is active.  \n  An inactive component allows no user interaction.\n\nid\n  The identifier that is assigned to the rendered HTML component.\n\nproperties\n  Bound to a dictionary that contains additional properties for this element.\n\nclass_name (dynamic)\n  The list of CSS class names that are associated with the generated HTML Element.  \n  These class names are added to the default `taipy-navbar` class name.\n\nhover_text (dynamic)\n  The information that is displayed when the user hovers over this element.\n\n"""  # noqa: E501
        ...
