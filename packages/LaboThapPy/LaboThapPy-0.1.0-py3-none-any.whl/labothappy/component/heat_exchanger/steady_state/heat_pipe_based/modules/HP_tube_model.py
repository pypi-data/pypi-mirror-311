...
from labothappy.component.heat_exchanger.sizing.heat_pipe_HTX.modules.HP_internal import Delta_P_v, thermal_res_esdu
from labothappy.component.heat_exchanger.sizing.heat_pipe_HTX.modules.HP_h_coeffs import radiative_coeff, external_flow_inline_bank, pool_boiling, external_flow_staggered_bank, ext_conv_boil #, h_cond_Th66, external_flow_finnedtubebank
