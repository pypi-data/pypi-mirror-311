...
from promptflow._utils.logger_utils import flow_logger as logger
...
def send_post_request(endpoint: str, headers: dict, payload: dict):
    """
...
def llm_tool(
    ...
    try:
        ...
        logger.error(f"Unknown error in llm_tool: {e}")
        return response_json
