...
class Tool(ABC):
    ...
    def check_params(self):
        ...
        if not getattr(self, "name", None) or not getattr(self, "description", None) and not getattr(self, "parameters",
                                                                                                     None):
            raise TypeError(f"{self.__class__.__name__} required parameters 'name', 'description' and 'parameters'.")
