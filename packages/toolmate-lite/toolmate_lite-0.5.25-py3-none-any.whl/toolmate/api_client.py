...
from toolmate import config, transformText, wrapText, startSpinning, stopSpinning, readTextFile, print3, getPygmentsStyle, showErrors
...
parser.add_argument('-mo', '--maximumoutput', action='store', dest='maximumoutput', help="override maximum output tokens for a single request; accepts non-negative integers; unaccepted values will be ignored without notification")
