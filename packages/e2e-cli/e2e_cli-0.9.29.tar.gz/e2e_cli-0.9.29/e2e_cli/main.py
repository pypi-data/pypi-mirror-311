...
class Main:
    ...
    def faas(self, parser):
        ...
        faas_init.add_argument('--lang', choices=LANGUAGE_OPTIONS, metavar="", help=f"language options allowed are - {LANGUAGE_OPTIONS_STR}")
        faas_init.add_argument('--name', metavar="", help=f"This is your function name.")
        ...
        faas_deploy.add_argument('--name', metavar="", help=f"This is your function name.")
        ...
        faas_redeploy.add_argument('--name', metavar="", help=f"This is your function name.")
        ...
        faas_destroy.add_argument('--name', metavar="", help=f"This is your function name.")
