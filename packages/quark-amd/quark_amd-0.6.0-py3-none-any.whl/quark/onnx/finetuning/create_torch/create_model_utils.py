...
NormalizationOperations = ("InstanceNormalization", "VitisInstanceNormalization")
ActivationMapping = {
...
FixNeuronOps = ("FixNeuron", "BFPFixNeuron")
...
class ONNXModelParser(object):
    ...
    def _dtype_to_qrange(self) -> Dict[Any, Tuple[int, int]]:
    ...
    def _parse_qdq_quant_info(
    ...
    ) -> Union[Tuple[NDArray[np.float32], NDArray[Any], NDArray[Any], NDArray[Any], int, bool], None]:
        ...
        return (scale, zero_point, min_q, max_q, ch_axis, q_folded)
    ...
    def get_inputs_qinfo(
        self, node: NodeProto
    ) -> List[Union[Tuple[NDArray[np.float32], NDArray[Any], NDArray[Any], NDArray[Any], int, bool], Dict[str, Any],
                    None]]:
        """ Get the quantization info of each input for the node """
        qinfos: List[Union[Tuple[NDArray[np.float32], NDArray[Any], NDArray[Any], NDArray[Any], int, bool],
