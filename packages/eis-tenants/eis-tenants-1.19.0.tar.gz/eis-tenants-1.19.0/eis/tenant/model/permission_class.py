...
class PermissionClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, module, entity, action, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """PermissionClass - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, module, entity, action, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """PermissionClass - a model defined in OpenAPI
