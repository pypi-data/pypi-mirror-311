...
class RoleClass(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'label': (str,),  # noqa: E501
            'permissions': ([PermissionClass],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, id, description, label, permissions, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """RoleClass - a model defined in OpenAPI
        ...
        Args:
            ...
            permissions ([PermissionClass]): Permissions associated with the role.
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, id, description, label, permissions, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """RoleClass - a model defined in OpenAPI
