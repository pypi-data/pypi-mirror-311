...
class Operation:
    ...
    AudioSpaceById = "fYAuJHiY3TmYdBmrRtIKhA", "AudioSpaceById"
    AudioSpaceSearch = (
    ...
    UserByRestId = "GazOglcBvgLigl3ywt6b3Q", "UserByRestId"
    UsersByRestIds = "OJBgJQIrij6e3cjqQ3Zu1Q", "UsersByRestIds"
    UserMedia = "YqiE3JL1KNgf9nSljYdxaA", "UserMedia"
    ...
    TweetStats = "EvbTkPDT-xQCfupPu0rWMA", "TweetStats"
    Likes = "nXEl0lfN_XSznVMlprThgQ", "Likes"
    Followers = "pd8Tt1qUz1YWrICegqZ8cw", "Followers"
    Following = "wjvx62Hye2dGVvnvVco0xA", "Following"
