...
from oakemu.machines.zxspectrum.z80 import Z80
...
class ZXSpectrum:
    ...
    def __getstate__(self):
        state = {
            "_zx": bytes(DotNetStateSerializer.SaveState(self._zx)),
        }
        return state

    def __setstate__(self, state):
        self._zx = DotNetZXSpectrum.Create48k()
        DotNetStateSerializer.LoadState[DotNetZXSpectrum](self._zx, state["_zx"])
