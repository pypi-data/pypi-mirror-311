...
Dio = {
    "CN": {
        ...
        "logfile": "DS-PAW.log文件路径（包含文件名和后缀）: ",
    ...
    "EN": {
        ...
        "logfile": "DS-PAW.log file path (including file name and suffix): ",
        "xyzfilename": "xyz trajectory file path: ",
        "asfilename": "as structure file path: ",
...
Dselect = {
    "CN": [
        ...
        "是否将插值链另外保存成xyz或者json文件（用于可视化）？ (y/n): ",
