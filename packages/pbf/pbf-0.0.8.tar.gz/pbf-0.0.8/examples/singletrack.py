...
tstate0 = pbf.makeThermalState(tsetup, grid, srefinement=2)
tsetup.setConvectionRadiationBC(tstate0)

mstate0 = pbf.makeMechanicalState(msetup, grid)

tstate1 = pbf.computeThermalProblem(tsetup, tstate0, timestep, dur)  # 3 * dur)  # tstate1, mstate1 =
