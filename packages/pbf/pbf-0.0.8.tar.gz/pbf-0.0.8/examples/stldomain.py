...
grid = pbf.createMesh(domainMin, domainMax, elementSize * 2 ** nrefinements, layerHeight)

# setup process simulation
setup = pbf.ProcessSimulation(grid)
setup.setMaterials({"powder": pbf.makePowder(IN625), "structure": IN625, "baseplate": IN625, "air": pbf.makeAir()})
...
tstate0 = pbf.makeThermalState(tsetup, grid, part=domain, srefinement=3)
