...
class ObservationResult(BaseModel):
    ...
    solar_phase_angle: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="solarPhaseAngle", description="BETA: the solar phase angle in degrees at the time of observation")
    solar_eq_phase_angle: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="solarEqPhaseAngle", description="BETA: the solar equatorial phase angle in degrees at the time of observation")
