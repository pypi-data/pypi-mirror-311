...
from .quant_norm_ops import QInstanceNorm2d
...
def convert_norm(node: onnx.NodeProto, layer_params: List[Any],
                 layer_qinfos: List[Any]) -> Tuple[QInstanceNorm2d, None]:
    """Use to convert norm (Instance Norm) ONNX node to Torch module.
       This function supports onnx's Instance Norm from 6.
    ...
    layer: Union[QInstanceNorm2d, type[QInstanceNorm2d]] = QInstanceNorm2d  # Should be compatiable with 1d and 3d
