...
class Config(ConfigBase):
    ...
    def to_dict(self) -> Dict[str, Any]:
        config_dict: Dict[str, Any] = {
            ...
            "exclude": self.exclude if len(self.exclude) > 0 else None,
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> Config:
        ...
        if config_dict["layer_type_quant_config"] is not None and len(config_dict["layer_type_quant_config"]) > 0:
            raise NotImplementedError("Config.from_dict currently does not support loading `layer_type_quant_config`.")
