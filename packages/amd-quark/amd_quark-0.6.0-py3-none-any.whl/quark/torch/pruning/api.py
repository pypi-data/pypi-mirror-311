...
from quark.torch.algorithm.api import apply_advanced_pruning_algo
import logging
...
class ModelPruner:
    ...
    def pruning_model(
        ...
        Parameters:
            model (nn.Module): The PyTorch model to be quantized. This model should be already trained and ready for pruning.
        ...
        # Step1[optional]: Apply Advanced pruning algo such as osscar ...
        model = self._apply_advanced_pruning_algo(model, dataloader)

        # Step2[optional]: pruning model ...
