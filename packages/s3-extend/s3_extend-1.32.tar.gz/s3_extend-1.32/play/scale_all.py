...
class PBR(threading.Thread):
    """
    Picoboard data reader. This program will normalize all analog value to be
    ...
    To
    enable line feeds and carriage returns, start the program with a single
    ...
    def analog_scaling(self, value, snd=False):
        """
        scale the normal analog input range of 0-1023 to 0-100
        :param value:
        :param snd: sound sensor or not
        :return:
        """
        if snd:
            input_low = 1023
