...
class DescribeReservedElasticsearchInstanceOfferingsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_es/paginators/#describereservedelasticsearchinstanceofferingspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class DescribeReservedElasticsearchInstancesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_es/paginators/#describereservedelasticsearchinstancespaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class GetUpgradeHistoryPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_es/paginators/#getupgradehistorypaginator)
    """
    def paginate(
...
class ListElasticsearchInstanceTypesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_es/paginators/#listelasticsearchinstancetypespaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListElasticsearchVersionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_es/paginators/#listelasticsearchversionspaginator)
    """
    def paginate(
        self,
