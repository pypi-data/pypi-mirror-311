...
with gr.Blocks() as demo:
    ...
    hide_controls = gr.Checkbox(value=True, label="Hide Controls")
    ...
    pce = PointCloudEditor(up_axis="Y", forward_axis="-Z", visible=False)
    ...
    hide_controls.change(fn=lambda x: gr.update(visible=not x), inputs=hide_controls, outputs=pce)
