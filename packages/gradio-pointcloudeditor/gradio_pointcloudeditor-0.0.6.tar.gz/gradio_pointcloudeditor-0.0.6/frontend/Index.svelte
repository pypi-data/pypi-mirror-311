<script lang="ts">
	...
	function handleScaling(event: MouseEvent) {
		...
		if (scaleStartPoint) {
			...
			const newScaleX = scale_locks.x ? currentScale.x : dragStartScale.x * scaleX;
			const newScaleY = scale_locks.y ? currentScale.y : dragStartScale.y * scaleY;
			const newScaleZ = scale_locks.z ? currentScale.z : dragStartScale.z * scaleZ;
