...
class PointCloudEditor(Component):
    ...
    def __init__(
        ...
        **kwargs
        ...
        Parameters:
            ...
            right_axis: The axis to use as "right" direction (default: "X")
    ...
    def get_config(self):
        """Returns the configuration for the frontend component."""
