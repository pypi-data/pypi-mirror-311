...
class LocationServicePlacesV2Client(BaseClient):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_geo_places/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/geo-places.html#LocationServicePlacesV2.Client)
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_geo_places/client/#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_geo_places/client/#can_paginate)
        """
    ...
    def generate_presigned_url(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_geo_places/client/#generate_presigned_url)
        """
    ...
    def close(self) -> None:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_geo_places/client/#close)
        """
    ...
    def autocomplete(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_geo_places/client/#autocomplete)
        """
    ...
    def geocode(self, **kwargs: Unpack[GeocodeRequestRequestTypeDef]) -> GeocodeResponseTypeDef:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_geo_places/client/#geocode)
        """
    ...
    def get_place(self, **kwargs: Unpack[GetPlaceRequestRequestTypeDef]) -> GetPlaceResponseTypeDef:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_geo_places/client/#get_place)
        """
    ...
    def reverse_geocode(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_geo_places/client/#reverse_geocode)
        """
    ...
    def search_nearby(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_geo_places/client/#search_nearby)
        """
    ...
    def search_text(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_geo_places/client/#search_text)
        """
    ...
    def suggest(self, **kwargs: Unpack[SuggestRequestRequestTypeDef]) -> SuggestResponseTypeDef:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_geo_places/client/#suggest)
        """
