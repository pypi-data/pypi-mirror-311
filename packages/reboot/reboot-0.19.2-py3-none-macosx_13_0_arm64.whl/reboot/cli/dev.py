    ...
    while True:
        ...
        if (
            ...
            if is_application_serving:
                ...
                terminal.info(
                    f"  Your API is available at {address}\n"
                    "\n"
                    f"  You can use '{protocol}://{address}' as the `url` for an `ExternalContext`\n"
                    "\n"
...
async def __dev_run(
    ...
    *,
    ...
    if args.local_envoy:
        ...
        env[ENVVAR_REBOOT_LOCAL_ENVOY] = 'false'
    ...
    env[ENVVAR_RBT_CLOUD_GATEWAY_ADDRESS] = args.cloud_cell_address
    env[ENVVAR_RBT_CLOUD_GATEWAY_SECURE_CHANNEL
