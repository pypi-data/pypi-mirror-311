...
if reboot.version.REBOOT_VERSION != "0.19.2":
    raise ImportError(
        "This code was generated for Reboot version '0.19.2', but the "
...
class SortedMapServicerMiddleware(reboot.aio.internals.middleware.Middleware):
        ...
        *,
        ...
        self._specified_errors_by_service_method_name: dict[str, list[str]] = {
            'rbt.std.collections.v1.SortedMapMethods.Get': [
                'rbt.std.collections.v1.sorted_map_pb2.KeyNotFoundError',
            ],
    ...
    async def Insert(
        ...
        if authoritative_consensus != self.consensus_id:
            ...
            stub = rbt.std.collections.v1.sorted_map_pb2_grpc.SortedMapMethodsStub(channel)
            call = stub.Insert(
                request=request,
...
class SortedMap:
    ...
    class GetAborted(reboot.aio.aborted.Aborted):
        ...
        @classmethod
        def is_declared_error(cls, message: google.protobuf.message.Message) -> bool:
            if message.DESCRIPTOR.full_name == 'rbt.std.collections.v1.KeyNotFoundError':
                return True
            return False
