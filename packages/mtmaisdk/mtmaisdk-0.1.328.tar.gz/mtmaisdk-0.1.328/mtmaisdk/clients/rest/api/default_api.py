...
class DefaultApi:
    ...
    async def chat_hellostream(
        ...
        _param = self._chat_hellostream_serialize(
    ...
    @validate_call
    async def chat_hellostream_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def chat_hellostream_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _chat_hellostream_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/chat/hellostream',
