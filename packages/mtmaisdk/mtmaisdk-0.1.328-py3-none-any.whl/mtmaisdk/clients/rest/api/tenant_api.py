...
class TenantApi:
    ...
    async def tenant_get_tasks(
        ...
        _param = self._tenant_get_tasks_serialize(
            tenant=tenant,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def tenant_get_tasks_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def tenant_get_tasks_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        _request_timeout: Union[
            None,
    ...
    def _tenant_get_tasks_serialize(
        self,
        tenant,
        _request_auth,
        _content_type,
