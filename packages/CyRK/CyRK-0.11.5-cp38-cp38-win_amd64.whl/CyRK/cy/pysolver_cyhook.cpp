...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("call_diffeq_from_cython", (void (*)(void))call_diffeq_from_cython, "void (PyObject *, DiffeqMethod)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initpysolver_cyhook(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initpysolver_cyhook(void)
#else
...
#endif
{
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("pysolver_cyhook", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_pysolver_cyhook(void)", 0);
