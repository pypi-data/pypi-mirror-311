...
with open(os.path.join(here, '/Users/meetjethwa/Development/FixMessage/fixparser/README.md'), encoding='utf-8') as f:
    long_description = f.read()

with open(os.path.join(here, '/Users/meetjethwa/Development/FixMessage/fixparser/CHANGELOG.txt'), encoding='utf-8') as f:
    changelog = f.read()
