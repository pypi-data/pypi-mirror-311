...
from llm_team.config.project_secrets import ANTHROPIC_API_KEY
from llm_team.telemetry.agent_telemetry import LLMAgentTelemetry
    ...
    def __post_init__(self):
        if not self.api_key:
            if ANTHROPIC_API_KEY:
                ...
                raise ValueError(
                    "No Anthropic API key was provided. You can either pass the key as the argument `api_key`, or set it as the environment variable `ANTHROPIC_API_KEY`."
                )
