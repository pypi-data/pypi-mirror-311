...
def show_ascii_art():
    ...
    formatter.print_panel(text, "Swarms CLI")
...
def main():
    ...
    parser.add_argument(
        "--task",
        metavar="TASK",  # Added metavar
        type=str,        # Keep type=str
    ...
    parser.add_argument(
        "--model_name",
        metavar="MODEL", # Added metavar
        type=str,        # Keep type=str
        default="gpt-4o", # Default value
        help="Model to run your autoswarm with! Uses LiteLLM, by default gpt-4",
