...
class PROFileManager:
    """
    Handles the reading and interpretation of VASP's PROCAR file.
    ...
    Attributes:
        file_location (str): Path to the PROCAR file.
        name (str): Optional descriptive name for the PROCAR data set.
