...
class Metadata_builder(PartitionManager):
    def __init__(self, file_location: str = None, name: str = None, **kwargs):
        """
        Initialize the MetadataBuilder instance.

        Parameters:
            file_location (str): The location of the file containing the data.
            name (str): The name of the partition or data set.
        """
