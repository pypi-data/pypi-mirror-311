...
class WaitForReplicationSetActiveWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ssm_incidents/waiters/#waitforreplicationsetactivewaiter)
    """
    def wait(
...
class WaitForReplicationSetDeletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ssm_incidents/waiters/#waitforreplicationsetdeletedwaiter)
    """
    def wait(
