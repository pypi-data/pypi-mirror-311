...
class ListConfigurationSetsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ses/paginators/#listconfigurationsetspaginator)
    """
    def paginate(
...
class ListCustomVerificationEmailTemplatesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ses/paginators/#listcustomverificationemailtemplatespaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListIdentitiesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ses/paginators/#listidentitiespaginator)
    """
    def paginate(
...
class ListReceiptRuleSetsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ses/paginators/#listreceiptrulesetspaginator)
    """
    def paginate(
...
class ListTemplatesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ses/paginators/#listtemplatespaginator)
    """
    def paginate(
