...
setup(name='heaserver',
      ...
      install_requires=[
          ...
          'jsonschema~=4.23.0',
          'jsonmerge~=1.9.2',
          'requests~=2.31.0',  # version 2.32.* is incompatible with docker (https://github.com/docker/docker-py/issues/3256)
          'types-requests>=2.32.0.20241016',  # Should be set at same version as requests.
          'boto3~=1.35.45',
          'botocore~=1.35.45',
          'boto3-stubs[essential,sts,account,organizations,iam]~=1.35.45',
          'botocore-stubs[essential]~=1.35.45',
          'freezegun~=1.5.1',
          'regex~=2024.9.11',
          'aio-pika==9.4.3',
          'simpleeval~=1.0.0',
