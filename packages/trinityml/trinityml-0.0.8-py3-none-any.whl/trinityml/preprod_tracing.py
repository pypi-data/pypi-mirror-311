...
def record(experiment_name=None,questions=None, contexts=None, generated_prompts=None, answers=None, ground_truths=None, model_temperature=None, top_k=None, model_name=None, prompt_template=None,model_provider=None,API_key=None,maxToken=None,top_p=None,system_prompt=None,user_prompt=None,llm_endpoint=None,promptName=None):
    ...
    if not model_name or not prompt_template or not model_provider or not API_key or not promptName:
        print("Model parameters (name, top_k, prompt_template, temperature, model_providers, top_p, API_key, total_output_token_count) are required. Please make sure you have provided all the necessary parameters.")
        return
    secret_key = None
    public_key = None
    host = None
