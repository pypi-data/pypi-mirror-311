...
setup(
    ...
    packages=find_packages(include=['forkEntropy', 'forkEntropy.*', 'forkEntropyTest', 'forkEntropyTest.*']),
    classifiers=[
    ...
    platforms=["all"],
    package_data={
        'forkEntropyTest.testData.commitChanges': ['*.json'],  
        'forkEntropyTest.testData.downloaded_PRrawdata': ['*.json'],
    }
)
