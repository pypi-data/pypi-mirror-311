...
class DescribeAccessPointsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_efs/paginators/#describeaccesspointspaginator)
    """
    def paginate(
...
class DescribeFileSystemsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_efs/paginators/#describefilesystemspaginator)
    """
    def paginate(
...
class DescribeMountTargetsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_efs/paginators/#describemounttargetspaginator)
    """
    def paginate(
...
class DescribeReplicationConfigurationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_efs/paginators/#describereplicationconfigurationspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class DescribeTagsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_efs/paginators/#describetagspaginator)
    """
    def paginate(
