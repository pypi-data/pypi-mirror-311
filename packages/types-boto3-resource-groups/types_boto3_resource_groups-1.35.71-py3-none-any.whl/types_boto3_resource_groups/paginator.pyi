...
class ListGroupResourcesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_resource_groups/paginators/#listgroupresourcespaginator)
    """
    def paginate(
...
class ListGroupingStatusesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_resource_groups/paginators/#listgroupingstatusespaginator)
    """
    def paginate(
...
class ListGroupsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_resource_groups/paginators/#listgroupspaginator)
    """
    def paginate(
...
class ListTagSyncTasksPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_resource_groups/paginators/#listtagsynctaskspaginator)
    """
    def paginate(
...
class SearchResourcesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_resource_groups/paginators/#searchresourcespaginator)
    """
    def paginate(
