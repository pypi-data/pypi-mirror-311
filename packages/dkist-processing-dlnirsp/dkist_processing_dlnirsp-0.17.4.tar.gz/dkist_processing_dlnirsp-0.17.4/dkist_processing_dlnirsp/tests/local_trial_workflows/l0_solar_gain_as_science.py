...
from dkist_processing_dlnirsp.tests.local_trial_workflows.e2e_dev_mockers import SetObserveExpTime
from dkist_processing_dlnirsp.tests.local_trial_workflows.e2e_dev_mockers import (
...
from dkist_processing_dlnirsp.tests.local_trial_workflows.e2e_helpers import LoadSolarGainAsScience
...
def main(
    ...
    with ManualProcessing(
        ...
        if load_solar_gain_as_science:
            manual_processing_run.run_task(task=LoadSolarGainAsScience)
        else:
