...
class DescribeAddressesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_snowball/paginators/#describeaddressespaginator)
    """
    def paginate(
...
class ListClusterJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_snowball/paginators/#listclusterjobspaginator)
    """
    def paginate(
...
class ListClustersPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_snowball/paginators/#listclusterspaginator)
    """
    def paginate(
...
class ListCompatibleImagesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_snowball/paginators/#listcompatibleimagespaginator)
    """
    def paginate(
...
class ListJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_snowball/paginators/#listjobspaginator)
    """
    def paginate(
...
class ListLongTermPricingPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_snowball/paginators/#listlongtermpricingpaginator)
    """
    def paginate(
