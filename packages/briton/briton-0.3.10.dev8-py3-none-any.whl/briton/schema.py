...
class ModelInput(BaseModel):
    ...
    class Tool(BaseModel):
        ...
        def json_schema(self) -> Dict[str, Any]:
            parameters_without_definitions = self.function.parameters.copy()
            parameters_without_definitions.pop("definitions", None)

            return {
                "type": "object",
                "properties": {
                    "name": {"const": self.function.name},
                    "parameters": parameters_without_definitions,
                },
        ...
        def definitions(self) -> Dict[str, Any]:
            return self.function.parameters.get("definitions", {})
    ...
    def output_json_schema(self) -> Optional[Dict[str, Any]]:
        ...
        if tools is not None:
            ...
            for tool in tools:
                for name, definition in tool.definitions.items():
