...
class MultiOutputRandomForestModel(ClassicalModel):
    ...
    def __init__(self,
        ...
        if model is None:
            ...
            model = MultiOutputRegressor(RandomForestRegressor(
                **kwargs)) if mode == "regression" else MultiOutputClassifier(
    ...
    def get_n_most_important_features(self,
        ...
        for i, _ in enumerate(self.model.estimators_):
            all_feature_importances.append(
                pd.DataFrame(self.model.estimators_[i].feature_importances_,
