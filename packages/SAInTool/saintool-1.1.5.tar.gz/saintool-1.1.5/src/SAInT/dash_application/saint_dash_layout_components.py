...
def create_tabs(console, graph,
    ...
    model_definition_options = [
        ...
        {"label": "Decision Tree", "value": "dt_model_selected"},
        {"label": "Support Vector Machine", "value": "svm_model_selected"},
    ...
    models_definition_button_div = DashDiv(id="models-configuration-button-div",
                                        content=[
                                            DashIconButton(label="Add", class_name="fa fa-plus", id="add_model_button")
                                        ],
                                        width="100%",
                                        visible=True)
