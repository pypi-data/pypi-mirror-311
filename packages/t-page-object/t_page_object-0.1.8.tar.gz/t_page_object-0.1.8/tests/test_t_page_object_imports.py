...
class TestTPageObject(unittest.TestCase):
    ...
    def test_base_classes(self):
        ...
        try:
            from t_page_object.base_element import BaseElement  # noqa
            from t_page_object.base_page import BasePage  # noqa
            from t_page_object.base_app import BaseApp  # noqa
