...
class BasePage(ABC):
    ...
    def wait_page_load(self, timeout=None) -> None:
        ...
        """
        if timeout and self.verification_element:
            self.verification_element.wait_element_load(timeout)
        elif self.verification_element:
