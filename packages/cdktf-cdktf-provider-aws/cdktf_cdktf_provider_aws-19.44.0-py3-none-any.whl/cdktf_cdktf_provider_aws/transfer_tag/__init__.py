...
Refer to the Terraform Registry for docs: [`aws_transfer_tag`](https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/transfer_tag).
'''
...
class TransferTag(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/transfer_tag aws_transfer_tag} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param key: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/transfer_tag#key TransferTag#key}.
        :param resource_arn: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/transfer_tag#resource_arn TransferTag#resource_arn}.
        :param value: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/transfer_tag#value TransferTag#value}.
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing TransferTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/transfer_tag#import import section} in the documentation of this resource for the id to use
