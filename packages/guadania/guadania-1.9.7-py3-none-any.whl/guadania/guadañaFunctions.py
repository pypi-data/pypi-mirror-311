...
def compliance_section_by_policy(prismasession, complianceStandard, accountName = None, accountGroup = None, return_json=False):
...
def historic(prismasession: PrismaSession, complianceStandard, cloudAccounts= None, accountGroups = None):
    ...
    if cloudAccounts:
        ...
        for account in cloudAccounts:
            tmp = pd.json_normalize(prisma.get_standard_compliance_statistics_trend(prismasession, selected_id, account))
