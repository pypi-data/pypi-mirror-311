...
class EBSClient(BaseClient):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ebs/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ebs.html#EBS.Client)
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ebs/client/#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ebs/client/#can_paginate)
        """
    ...
    def generate_presigned_url(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ebs/client/#generate_presigned_url)
        """

    def close(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ebs/client/close.html)
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ebs/client/#close)
        """
    ...
    def complete_snapshot(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ebs/client/#complete_snapshot)
        """
    ...
    def get_snapshot_block(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ebs/client/#get_snapshot_block)
        """
    ...
    def list_changed_blocks(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ebs/client/#list_changed_blocks)
        """
    ...
    def list_snapshot_blocks(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ebs/client/#list_snapshot_blocks)
        """
    ...
    def put_snapshot_block(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ebs/client/#put_snapshot_block)
        """
    ...
    def start_snapshot(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ebs/client/#start_snapshot)
        """
