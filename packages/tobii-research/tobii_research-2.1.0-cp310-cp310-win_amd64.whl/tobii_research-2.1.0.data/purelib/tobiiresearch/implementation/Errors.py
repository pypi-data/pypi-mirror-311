...
class EyeTrackerFeatureDeprecatedError(Exception):
    '''Is thrown if the requested feature has been deprecated. The feature no longer returns a value and will
...
def _on_error_raise_exception(value):
    ...
    elif status == __TobiiProStatus.deprecated:
        raise EyeTrackerFeatureDeprecatedError("This feature has been deprecated")
    else:
