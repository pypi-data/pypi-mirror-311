...
class DatasetApi:
    ...
    def get_dataset_by_id(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the dataset to retrieve")],
        ...
        :param id: The ID of the dataset to retrieve (required)
        :type id: int
    ...
    def get_datasets_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDatasets200Response]:
        """Get Datasets by User ID
    ...
    def _get_datasets_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/user/datasets',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
