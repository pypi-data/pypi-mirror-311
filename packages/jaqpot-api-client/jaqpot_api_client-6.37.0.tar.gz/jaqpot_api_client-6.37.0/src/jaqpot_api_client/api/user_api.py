...
class UserApi:
    ...
    def get_user(
        self,
        username: Annotated[StrictStr, Field(description="The ID of the user to retrieve")],
        ...
        :param username: The ID of the user to retrieve (required)
        :type username: str
    ...
    def _get_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/users/{username}',
