...
class ModelApi:
    ...
    def archive_model(
        self,
        model_id: Annotated[StrictInt, Field(description="The ID of the model to archive")],
    ...
    def archive_model_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ArchiveModel200Response]:
        """Archive a model
    ...
    def _archive_model_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/models/{modelId}/archive',
    ...
    def get_archived_models(
        ...
        _param = self._get_archived_models_serialize(
            page=page,
            size=size,
            sort=sort,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_archived_models_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        size: Optional[StrictInt] = None,
        sort: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def get_archived_models_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        size: Optional[StrictInt] = None,
        sort: Optional[List[StrictStr]] = None,
    ...
    def _get_archived_models_serialize(
        self,
        page,
        size,
        sort,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/user/archived-models',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_legacy_model_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/models/legacy/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_shared_models_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/user/shared-models',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def partially_update_model(
        ...
        :param id: (required)
        :type id: int
        :param partially_update_model_request: (required)
        :type partially_update_model_request: PartiallyUpdateModelRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._partially_update_model_serialize(
            id=id,
            partially_update_model_request=partially_update_model_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _partially_update_model_serialize(
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/v1/models/{id}/partial',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def predict_with_model(
        ...
        :param model_id: The ID of the model to use for prediction (required)
        :type model_id: int
    ...
    def _predict_with_model_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/models/{modelId}/predict',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def predict_with_model_csv(
        ...
        :param model_id: The ID of the model to use for prediction (required)
        :type model_id: int
        :param dataset_csv: (required)
        :type dataset_csv: DatasetCSV
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _predict_with_model_csv_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/models/{modelId}/predict/csv',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _search_models_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/models/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def unarchive_model(
        self,
        model_id: Annotated[StrictInt, Field(description="The ID of the model to unarchive")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> UnarchiveModel200Response:
        """Unarchive a model

        Unarchives a previously archived model. This will cancel any scheduled deletion.

        :param model_id: The ID of the model to unarchive (required)
        :type model_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._unarchive_model_serialize(
            model_id=model_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def unarchive_model_with_http_info(
        self,
        model_id: Annotated[StrictInt, Field(description="The ID of the model to unarchive")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UnarchiveModel200Response]:
        """Unarchive a model
    ...
    @validate_call
    def unarchive_model_without_preload_content(
        self,
        model_id: Annotated[StrictInt, Field(description="The ID of the model to unarchive")],
        _request_timeout: Union[
            None,
    ...
    def _unarchive_model_serialize(
        self,
        model_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/models/{modelId}/unarchive',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
