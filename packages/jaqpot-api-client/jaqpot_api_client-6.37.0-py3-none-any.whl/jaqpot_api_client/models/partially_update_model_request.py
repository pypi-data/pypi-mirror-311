...
class PartiallyUpdateModelRequest(BaseModel):
    ...
    shared_with_organization_ids: Optional[List[StrictInt]] = Field(default=None, alias="sharedWithOrganizationIds")
    __properties: ClassVar[List[str]] = ["name", "description", "visibility", "task", "tags", "sharedWithOrganizationIds"]
