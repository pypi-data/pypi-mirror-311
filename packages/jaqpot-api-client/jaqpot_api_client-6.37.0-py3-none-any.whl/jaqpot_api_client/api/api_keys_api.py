...
class ApiKeysApi:
    ...
    def create_api_key(
        self,
        api_key: Annotated[ApiKey, Field(description="Payload to create a new API key")],
        ...
        :param api_key: Payload to create a new API key (required)
        :type api_key: ApiKey
    ...
    def _create_api_key_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/user/api-keys',
    ...
    def delete_api_key(
        self,
        key: Annotated[StrictStr, Field(description="The API key to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _delete_api_key_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/user/api-keys/{key}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_api_keys_for_user(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetAllApiKeysForUser200ResponseInner]:
        ...
        _param = self._get_all_api_keys_for_user_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[GetAllApiKeysForUser200ResponseInner]",
            '401': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_all_api_keys_for_user_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetAllApiKeysForUser200ResponseInner]]:
        """Get All API Keys for the User
    ...
    @validate_call
    def get_all_api_keys_for_user_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_all_api_keys_for_user_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def update_api_key(
        self,
        key: Annotated[StrictStr, Field(description="The API key to update")],
        update_api_key_request: Annotated[UpdateApiKeyRequest, Field(description="Payload to update API key metadata")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param key: The API key to update (required)
        :type key: str
        :param update_api_key_request: Payload to update API key metadata (required)
