...
class FeatureApi:
    ...
    def partially_update_model_feature(
        self,
        model_id: Annotated[StrictInt, Field(description="The ID of the model containing the feature")],
        feature_id: Annotated[StrictInt, Field(description="The ID of the feature to update")],
