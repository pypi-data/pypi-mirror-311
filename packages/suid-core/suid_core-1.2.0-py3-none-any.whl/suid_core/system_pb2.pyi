...
class Object(_message.Message):
    ...
    coordinate: Point3f
    def __init__(self, coordinate: _Optional[_Union[Point3f, _Mapping]] = ...) -> None: ...
...
class AxisTemplate(_message.Message):
    __slots__ = ("x", "y", "z")
    X_FIELD_NUMBER: _ClassVar[int]
    Y_FIELD_NUMBER: _ClassVar[int]
    Z_FIELD_NUMBER: _ClassVar[int]
    ...
    y: str
    z: str
    def __init__(self, x: _Optional[str] = ..., y: _Optional[str] = ..., z: _Optional[str] = ...) -> None: ...

class configureStateRequest(_message.Message):
    __slots__ = ("states", "actuators")
    STATES_FIELD_NUMBER: _ClassVar[int]
    ACTUATORS_FIELD_NUMBER: _ClassVar[int]
    states: _containers.RepeatedCompositeFieldContainer[AxisTemplate]
    actuators: _containers.RepeatedScalarFieldContainer[bool]
    def __init__(self, states: _Optional[_Iterable[_Union[AxisTemplate, _Mapping]]] = ..., actuators: _Optional[_Iterable[bool]] = ...) -> None: ...

class configureStateResult(_message.Message):
    __slots__ = ("axis", "actuators")
    AXIS_FIELD_NUMBER: _ClassVar[int]
    ACTUATORS_FIELD_NUMBER: _ClassVar[int]
    axis: AxisTemplate
    actuators: _containers.RepeatedScalarFieldContainer[bool]
    def __init__(self, axis: _Optional[_Union[AxisTemplate, _Mapping]] = ..., actuators: _Optional[_Iterable[bool]] = ...) -> None: ...

class updateStateRequest(_message.Message):
    __slots__ = ("info",)
    INFO_FIELD_NUMBER: _ClassVar[int]
    info: WorldMappingResult
    def __init__(self, info: _Optional[_Union[WorldMappingResult, _Mapping]] = ...) -> None: ...

class updateStateResult(_message.Message):
    __slots__ = ("info",)
    INFO_FIELD_NUMBER: _ClassVar[int]
    info: WorldMappingResult
    def __init__(self, info: _Optional[_Union[WorldMappingResult, _Mapping]] = ...) -> None: ...
