...
from typing_extensions import Annotated
from wandelbots_api_client.v2.models.get_virtual_robot_io_value200_response import GetVirtualRobotIOValue200Response
...
class VirtualRobotApi:
    ...
    async def get_virtual_robot_io_value(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetVirtualRobotIOValue200Response",
        }
        response_data = await self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    async def get_virtual_robot_io_value_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetVirtualRobotIOValue200Response]:
        """Get I/O
