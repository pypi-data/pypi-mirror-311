...
class OpMode(BaseModel):
    ...
    def mode_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['OPERATION_MODE_MANUAL', 'OPERATION_MODE_AUTO']):
            raise ValueError("must be one of enum values ('OPERATION_MODE_MANUAL', 'OPERATION_MODE_AUTO')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpMode from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpMode from a dict"""
        if obj is None:
            return None
