...
from ..models.method_rws_create_method_type_id import MethodRWSCreateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodRWSCreate")


@_attrs_define
class MethodRWSCreate:
    """
    Attributes:
        method_id (Union[None, UUID, Unset]):
        name (Union[Unset, str]):  Default: 'RWS'.
        ...
        method_type_id (Union[Unset, MethodRWSCreateMethodTypeId]):  Default: MethodRWSCreateMethodTypeId.VALUE_7.
    """

    method_id: Union[None, UUID, Unset] = UNSET
    name: Union[Unset, str] = "RWS"
    ...
    method_type_id: Union[Unset, MethodRWSCreateMethodTypeId] = MethodRWSCreateMethodTypeId.VALUE_7
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodRWSCreateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodRWSCreateMethodTypeId(_method_type_id)

        method_rws_create = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_rws_create.additional_properties = d
        return method_rws_create
