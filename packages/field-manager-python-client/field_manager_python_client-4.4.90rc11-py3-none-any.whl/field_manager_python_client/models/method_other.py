...
from ..models.method_other_method_type_id import MethodOTHERMethodTypeId
...
class MethodOTHER:
    ...
    Attributes:
        ...
        method_type_id (Union[Unset, MethodOTHERMethodTypeId]):  Default: MethodOTHERMethodTypeId.VALUE_23.
    ...
    method_type_id: Union[Unset, MethodOTHERMethodTypeId] = MethodOTHERMethodTypeId.VALUE_23
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodOTHERMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodOTHERMethodTypeId(_method_type_id)
        ...
        method_other.additional_properties = d
        return method_other
