...
from ..models.method_rs_method_type_id import MethodRSMethodTypeId
...
class MethodRS:
    ...
    Attributes:
        ...
        method_type_id (Union[Unset, MethodRSMethodTypeId]):  Default: MethodRSMethodTypeId.VALUE_9.
    ...
    method_type_id: Union[Unset, MethodRSMethodTypeId] = MethodRSMethodTypeId.VALUE_9
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodRSMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodRSMethodTypeId(_method_type_id)
        ...
        method_rs.additional_properties = d
        return method_rs
