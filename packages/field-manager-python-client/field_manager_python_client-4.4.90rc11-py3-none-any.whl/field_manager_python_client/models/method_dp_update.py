...
from ..models.method_dp_update_method_type_id import MethodDPUpdateMethodTypeId
...
class MethodDPUpdate:
    ...
    Attributes:
        ...
        method_type_id (Union[Unset, MethodDPUpdateMethodTypeId]):  Default: MethodDPUpdateMethodTypeId.VALUE_25.
    """
    ...
    method_type_id: Union[Unset, MethodDPUpdateMethodTypeId] = MethodDPUpdateMethodTypeId.VALUE_25
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodDPUpdateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodDPUpdateMethodTypeId(_method_type_id)
