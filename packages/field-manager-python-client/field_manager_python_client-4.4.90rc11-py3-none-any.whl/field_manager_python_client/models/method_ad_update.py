...
from ..models.method_ad_update_method_type_id import MethodADUpdateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodADUpdate")


@_attrs_define
class MethodADUpdate:
    """
    Attributes:
        ...
        method_type_id (Union[Unset, MethodADUpdateMethodTypeId]):  Default: MethodADUpdateMethodTypeId.VALUE_17.
    """
    ...
    method_type_id: Union[Unset, MethodADUpdateMethodTypeId] = MethodADUpdateMethodTypeId.VALUE_17
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodADUpdateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodADUpdateMethodTypeId(_method_type_id)

        method_ad_update = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_ad_update.additional_properties = d
        return method_ad_update
