...
from ..models.method_rs_update_method_type_id import MethodRSUpdateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodRSUpdate")


@_attrs_define
class MethodRSUpdate:
    """
    Attributes:
        ...
        method_type_id (Union[Unset, MethodRSUpdateMethodTypeId]):  Default: MethodRSUpdateMethodTypeId.VALUE_9.
    """
    ...
    method_type_id: Union[Unset, MethodRSUpdateMethodTypeId] = MethodRSUpdateMethodTypeId.VALUE_9
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodRSUpdateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodRSUpdateMethodTypeId(_method_type_id)

        method_rs_update = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_rs_update.additional_properties = d
        return method_rs_update
