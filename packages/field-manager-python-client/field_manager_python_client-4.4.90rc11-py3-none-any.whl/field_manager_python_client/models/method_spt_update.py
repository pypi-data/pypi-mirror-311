...
from ..models.method_spt_update_method_type_id import MethodSPTUpdateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodSPTUpdate")


@_attrs_define
class MethodSPTUpdate:
    """
    Attributes:
        ...
        method_type_id (Union[Unset, MethodSPTUpdateMethodTypeId]):  Default: MethodSPTUpdateMethodTypeId.VALUE_11.
    """
    ...
    method_type_id: Union[Unset, MethodSPTUpdateMethodTypeId] = MethodSPTUpdateMethodTypeId.VALUE_11
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodSPTUpdateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodSPTUpdateMethodTypeId(_method_type_id)

        method_spt_update = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_spt_update.additional_properties = d
        return method_spt_update
