...
from ..models.method_tp_method_type_id import MethodTPMethodTypeId
...
class MethodTP:
    ...
    Attributes:
        ...
        method_type_id (Union[Unset, MethodTPMethodTypeId]):  Default: MethodTPMethodTypeId.VALUE_13.
    ...
    method_type_id: Union[Unset, MethodTPMethodTypeId] = MethodTPMethodTypeId.VALUE_13
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodTPMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodTPMethodTypeId(_method_type_id)
        ...
        method_tp.additional_properties = d
        return method_tp
