...
from ..models.method_pt_create_method_type_id import MethodPTCreateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodPTCreate")


@_attrs_define
class MethodPTCreate:
    """
    Attributes:
        method_id (Union[None, UUID, Unset]):
        name (Union[Unset, str]):  Default: 'PT'.
        ...
        method_type_id (Union[Unset, MethodPTCreateMethodTypeId]):  Default: MethodPTCreateMethodTypeId.VALUE_14.
    """

    method_id: Union[None, UUID, Unset] = UNSET
    name: Union[Unset, str] = "PT"
    ...
    method_type_id: Union[Unset, MethodPTCreateMethodTypeId] = MethodPTCreateMethodTypeId.VALUE_14
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodPTCreateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodPTCreateMethodTypeId(_method_type_id)

        method_pt_create = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_pt_create.additional_properties = d
        return method_pt_create
