...
T = TypeVar("T", bound="MethodSSCreate")


@_attrs_define
class MethodSSCreate:
    """
    Attributes:
        method_id (Union[None, UUID, Unset]):
        name (Union[Unset, str]):  Default: 'SS'.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_ss_create.additional_properties = d
