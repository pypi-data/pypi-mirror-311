...
from ..models.method_rws_update_method_type_id import MethodRWSUpdateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodRWSUpdate")


@_attrs_define
class MethodRWSUpdate:
    """
    Attributes:
        ...
        method_type_id (Union[Unset, MethodRWSUpdateMethodTypeId]):  Default: MethodRWSUpdateMethodTypeId.VALUE_7.
    """
    ...
    method_type_id: Union[Unset, MethodRWSUpdateMethodTypeId] = MethodRWSUpdateMethodTypeId.VALUE_7
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodRWSUpdateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodRWSUpdateMethodTypeId(_method_type_id)

        method_rws_update = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_rws_update.additional_properties = d
        return method_rws_update
