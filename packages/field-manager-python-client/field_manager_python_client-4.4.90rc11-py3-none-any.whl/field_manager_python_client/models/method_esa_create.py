...
from ..models.method_esa_create_method_type_id import MethodESACreateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodESACreate")


@_attrs_define
class MethodESACreate:
    """
    Attributes:
        method_id (Union[None, UUID, Unset]):
        name (Union[Unset, str]):  Default: 'ESA'.
        ...
        method_type_id (Union[Unset, MethodESACreateMethodTypeId]):  Default: MethodESACreateMethodTypeId.VALUE_15.
    """

    method_id: Union[None, UUID, Unset] = UNSET
    name: Union[Unset, str] = "ESA"
    ...
    method_type_id: Union[Unset, MethodESACreateMethodTypeId] = MethodESACreateMethodTypeId.VALUE_15
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodESACreateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodESACreateMethodTypeId(_method_type_id)

        method_esa_create = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_esa_create.additional_properties = d
        return method_esa_create
