...
from ..models.method_ro_create_method_type_id import MethodROCreateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodROCreate")


@_attrs_define
class MethodROCreate:
    """
    Attributes:
        method_id (Union[None, UUID, Unset]):
        name (Union[Unset, str]):  Default: 'RO'.
        ...
        method_type_id (Union[Unset, MethodROCreateMethodTypeId]):  Default: MethodROCreateMethodTypeId.VALUE_18.
    """

    method_id: Union[None, UUID, Unset] = UNSET
    name: Union[Unset, str] = "RO"
    ...
    method_type_id: Union[Unset, MethodROCreateMethodTypeId] = MethodROCreateMethodTypeId.VALUE_18
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodROCreateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodROCreateMethodTypeId(_method_type_id)

        method_ro_create = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_ro_create.additional_properties = d
        return method_ro_create
