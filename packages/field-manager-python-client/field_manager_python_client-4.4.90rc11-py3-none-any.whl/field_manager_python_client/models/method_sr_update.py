...
from ..models.method_sr_update_method_type_id import MethodSRUpdateMethodTypeId
...
class MethodSRUpdate:
    ...
    Attributes:
        ...
        method_type_id (Union[Unset, MethodSRUpdateMethodTypeId]):  Default: MethodSRUpdateMethodTypeId.VALUE_20.
    """
    ...
    method_type_id: Union[Unset, MethodSRUpdateMethodTypeId] = MethodSRUpdateMethodTypeId.VALUE_20
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodSRUpdateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodSRUpdateMethodTypeId(_method_type_id)
