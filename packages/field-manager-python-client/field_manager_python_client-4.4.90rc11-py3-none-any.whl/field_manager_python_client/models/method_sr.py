...
from ..models.method_sr_method_type_id import MethodSRMethodTypeId
...
class MethodSR:
    ...
    Attributes:
        ...
        method_type_id (Union[Unset, MethodSRMethodTypeId]):  Default: MethodSRMethodTypeId.VALUE_20.
    ...
    method_type_id: Union[Unset, MethodSRMethodTypeId] = MethodSRMethodTypeId.VALUE_20
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodSRMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodSRMethodTypeId(_method_type_id)
