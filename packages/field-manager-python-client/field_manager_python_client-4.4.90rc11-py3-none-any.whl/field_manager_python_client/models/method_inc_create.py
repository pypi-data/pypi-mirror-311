...
from ..models.method_inc_create_method_type_id import MethodINCCreateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodINCCreate")


@_attrs_define
class MethodINCCreate:
    """
    Attributes:
        method_id (Union[None, UUID, Unset]):
        name (Union[Unset, str]):  Default: 'INC'.
        ...
        method_type_id (Union[Unset, MethodINCCreateMethodTypeId]):  Default: MethodINCCreateMethodTypeId.VALUE_19.
    """

    method_id: Union[None, UUID, Unset] = UNSET
    name: Union[Unset, str] = "INC"
    ...
    method_type_id: Union[Unset, MethodINCCreateMethodTypeId] = MethodINCCreateMethodTypeId.VALUE_19
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodINCCreateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodINCCreateMethodTypeId(_method_type_id)

        method_inc_create = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_inc_create.additional_properties = d
        return method_inc_create
