...
T = TypeVar("T", bound="MethodADCreate")


@_attrs_define
class MethodADCreate:
    """
    Attributes:
        method_id (Union[None, UUID, Unset]):
        name (Union[Unset, str]):  Default: 'AD'.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_ad_create.additional_properties = d
        return method_ad_create
