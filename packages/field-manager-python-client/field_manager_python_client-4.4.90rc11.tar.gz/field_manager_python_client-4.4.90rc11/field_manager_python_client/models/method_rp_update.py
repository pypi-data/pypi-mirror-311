...
T = TypeVar("T", bound="MethodRPUpdate")


@_attrs_define
class MethodRPUpdate:
    """Structure for updating a rotary pressure method instance
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_rp_update.additional_properties = d
