...
from ..models.method_other_create_method_type_id import MethodOTHERCreateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodOTHERCreate")


@_attrs_define
class MethodOTHERCreate:
    """
    Attributes:
        method_id (Union[None, UUID, Unset]):
        name (Union[Unset, str]):  Default: 'OTHER'.
        ...
        method_type_id (Union[Unset, MethodOTHERCreateMethodTypeId]):  Default: MethodOTHERCreateMethodTypeId.VALUE_23.
    """

    method_id: Union[None, UUID, Unset] = UNSET
    name: Union[Unset, str] = "OTHER"
    ...
    method_type_id: Union[Unset, MethodOTHERCreateMethodTypeId] = MethodOTHERCreateMethodTypeId.VALUE_23
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodOTHERCreateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodOTHERCreateMethodTypeId(_method_type_id)

        method_other_create = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_other_create.additional_properties = d
        return method_other_create
