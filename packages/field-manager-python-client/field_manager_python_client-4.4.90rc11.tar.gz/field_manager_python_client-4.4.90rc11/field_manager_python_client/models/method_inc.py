...
from ..models.method_inc_method_type_id import MethodINCMethodTypeId
...
class MethodINC:
    ...
    Attributes:
        ...
        method_type_id (Union[Unset, MethodINCMethodTypeId]):  Default: MethodINCMethodTypeId.VALUE_19.
    ...
    method_type_id: Union[Unset, MethodINCMethodTypeId] = MethodINCMethodTypeId.VALUE_19
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodINCMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodINCMethodTypeId(_method_type_id)
        ...
        method_inc.additional_properties = d
        return method_inc
