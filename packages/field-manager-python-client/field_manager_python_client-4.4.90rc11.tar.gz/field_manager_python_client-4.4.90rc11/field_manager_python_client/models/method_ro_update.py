...
from ..models.method_ro_update_method_type_id import MethodROUpdateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodROUpdate")


@_attrs_define
class MethodROUpdate:
    """
    Attributes:
        ...
        method_type_id (Union[Unset, MethodROUpdateMethodTypeId]):  Default: MethodROUpdateMethodTypeId.VALUE_18.
    """
    ...
    method_type_id: Union[Unset, MethodROUpdateMethodTypeId] = MethodROUpdateMethodTypeId.VALUE_18
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodROUpdateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodROUpdateMethodTypeId(_method_type_id)

        method_ro_update = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_ro_update.additional_properties = d
        return method_ro_update
