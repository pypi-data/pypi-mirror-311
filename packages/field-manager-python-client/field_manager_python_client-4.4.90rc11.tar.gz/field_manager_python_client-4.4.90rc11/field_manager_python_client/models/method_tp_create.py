...
from ..models.method_tp_create_method_type_id import MethodTPCreateMethodTypeId
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodTPCreate")


@_attrs_define
class MethodTPCreate:
    """
    Attributes:
        method_id (Union[None, UUID, Unset]):
        name (Union[Unset, str]):  Default: 'TP'.
        ...
        method_type_id (Union[Unset, MethodTPCreateMethodTypeId]):  Default: MethodTPCreateMethodTypeId.VALUE_13.
    """

    method_id: Union[None, UUID, Unset] = UNSET
    name: Union[Unset, str] = "TP"
    ...
    method_type_id: Union[Unset, MethodTPCreateMethodTypeId] = MethodTPCreateMethodTypeId.VALUE_13
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodTPCreateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodTPCreateMethodTypeId(_method_type_id)

        method_tp_create = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_tp_create.additional_properties = d
        return method_tp_create
