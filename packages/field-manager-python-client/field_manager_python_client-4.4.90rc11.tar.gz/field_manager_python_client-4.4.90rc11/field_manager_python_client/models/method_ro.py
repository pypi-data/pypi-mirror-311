...
from ..models.method_ro_method_type_id import MethodROMethodTypeId
...
class MethodRO:
    ...
    Attributes:
        ...
        method_type_id (Union[Unset, MethodROMethodTypeId]):  Default: MethodROMethodTypeId.VALUE_18.
    ...
    method_type_id: Union[Unset, MethodROMethodTypeId] = MethodROMethodTypeId.VALUE_18
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodROMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodROMethodTypeId(_method_type_id)
        ...
        method_ro.additional_properties = d
        return method_ro
