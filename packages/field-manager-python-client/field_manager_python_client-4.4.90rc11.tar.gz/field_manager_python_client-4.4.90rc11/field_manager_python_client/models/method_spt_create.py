...
from ..models.method_spt_create_method_type_id import MethodSPTCreateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodSPTCreate")


@_attrs_define
class MethodSPTCreate:
    """
    Attributes:
        method_id (Union[None, UUID, Unset]):
        name (Union[Unset, str]):  Default: 'SPT'.
        ...
        method_type_id (Union[Unset, MethodSPTCreateMethodTypeId]):  Default: MethodSPTCreateMethodTypeId.VALUE_11.
    """

    method_id: Union[None, UUID, Unset] = UNSET
    name: Union[Unset, str] = "SPT"
    ...
    method_type_id: Union[Unset, MethodSPTCreateMethodTypeId] = MethodSPTCreateMethodTypeId.VALUE_11
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodSPTCreateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodSPTCreateMethodTypeId(_method_type_id)

        method_spt_create = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_spt_create.additional_properties = d
        return method_spt_create
