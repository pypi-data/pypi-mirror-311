...
from ..models.method_pt_method_type_id import MethodPTMethodTypeId
...
class MethodPT:
    ...
    Attributes:
        ...
        method_type_id (Union[Unset, MethodPTMethodTypeId]):  Default: MethodPTMethodTypeId.VALUE_14.
    ...
    method_type_id: Union[Unset, MethodPTMethodTypeId] = MethodPTMethodTypeId.VALUE_14
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodPTMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodPTMethodTypeId(_method_type_id)
        ...
        method_pt.additional_properties = d
        return method_pt
