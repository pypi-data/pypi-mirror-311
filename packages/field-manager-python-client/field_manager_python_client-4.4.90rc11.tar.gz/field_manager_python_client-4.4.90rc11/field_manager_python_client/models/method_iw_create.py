...
from ..models.method_iw_create_method_type_id import MethodIWCreateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodIWCreate")


@_attrs_define
class MethodIWCreate:
    """
    Attributes:
        method_id (Union[None, UUID, Unset]):
        name (Union[Unset, str]):  Default: 'IW'.
        ...
        method_type_id (Union[Unset, MethodIWCreateMethodTypeId]):  Default: MethodIWCreateMethodTypeId.VALUE_21.
    """

    method_id: Union[None, UUID, Unset] = UNSET
    name: Union[Unset, str] = "IW"
    ...
    method_type_id: Union[Unset, MethodIWCreateMethodTypeId] = MethodIWCreateMethodTypeId.VALUE_21
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodIWCreateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodIWCreateMethodTypeId(_method_type_id)

        method_iw_create = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_iw_create.additional_properties = d
        return method_iw_create
