...
from ..models.method_inc_update_method_type_id import MethodINCUpdateMethodTypeId
from ..models.method_status_enum import MethodStatusEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="MethodINCUpdate")


@_attrs_define
class MethodINCUpdate:
    """
    Attributes:
        ...
        method_type_id (Union[Unset, MethodINCUpdateMethodTypeId]):  Default: MethodINCUpdateMethodTypeId.VALUE_19.
    """
    ...
    method_type_id: Union[Unset, MethodINCUpdateMethodTypeId] = MethodINCUpdateMethodTypeId.VALUE_19
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        method_type_id: Union[Unset, MethodINCUpdateMethodTypeId]
        if isinstance(_method_type_id, Unset):
            method_type_id = UNSET
        else:
            method_type_id = MethodINCUpdateMethodTypeId(_method_type_id)

        method_inc_update = cls(
            method_id=method_id,
            name=name,
            remarks=remarks,
        ...
        method_inc_update.additional_properties = d
        return method_inc_update
