        ...
        for response_201_item_data in _response_201:
            ...
            def _parse_response_201_item(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_201_item_type_15 = MethodAD.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_201_item_type_16 = MethodRO.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_201_item_type_17 = MethodINC.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_201_item_type_18 = MethodSR.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_201_item_type_19 = MethodIW.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_201_item_type_20 = MethodDT.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_201_item_type_21 = MethodOTHER.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_201_item_type_22 = MethodSRS.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_201_item_type_23 = MethodDP.from_dict(data)
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                response_201_item_type_24 = MethodWST.from_dict(data)
