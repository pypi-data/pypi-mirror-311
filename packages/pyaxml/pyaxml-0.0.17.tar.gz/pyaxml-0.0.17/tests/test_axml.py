...
class AXMLTest(unittest.TestCase):
    ...
    def testAXMLnotAligned(self):
        ...
        for filename in filenames:
            with open(os.path.join(test_dir, filename), "rb") as fp:
                ...
                sb_s = b"".join(pyaxml.StringBlock(proto=elt, utf8=sb.proto.hnd.flag & pyaxml.axml_pb2.UTF8_FLAG == pyaxml.axml_pb2.UTF8_FLAG).pack() for elt in sb.proto.stringblocks) + sb.proto.pad_stringblocks
    ...
    def testNullbytes(self):
        ...
        try:
            ...
            self.assertEqual(str(e), "All strings must be XML compatible: Unicode or ASCII, no NULL bytes or control characters")
            return
        self.assertTrue(False, "should raise an error")
