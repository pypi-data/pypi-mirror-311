...
class ARSCResTableConfig:
    ...
    def get_qualifier(self) -> str:
        ...
        * `hdpi-v4`
        ...
        screen_layout = self.proto.screenConfig & 0xFF
        ...
        smallest_screen_width_dp = (self.proto.screenConfig & 0xFFFF0000) >> 16
        if smallest_screen_width_dp != 0:
            res.append("sw%ddp" % smallest_screen_width_dp)

        screen_width_dp = self.proto.screenSizeDp & 0xFFFF
        screen_height_dp = (self.proto.screenSizeDp & 0xFFFF0000) >> 16
        ...
        screen_layout2 = self.proto.screenConfig2 & 0xFF
        ...
        color_mode = (self.proto.screenConfig2 & 0xFF00) >> 8
        ...
        ui_mode = (self.proto.screenConfig & 0xFF00) >> 8
