...
setup(
    ...
    package_data={
        '': ['*.yml', '*.json', 'backend_folder/*', 'backend_folder/.gitignore' , 'backend_folder/*/*'],  # Include specific file types
    ...
    entry_points={
        'console_scripts': [
            'start=folder_structure_generator_7edge.generator:create_folder_structure_with_files',  # Additional command
