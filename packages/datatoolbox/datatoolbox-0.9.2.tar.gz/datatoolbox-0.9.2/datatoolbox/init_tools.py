...
def initCATRegions():
    rawInput = {
        "R5OECD": "AIAALAANDASMATAATFAUSAUTBELBVTCANCCKCHECHICXRCYMDEUDNKESPFINFJIFRAFROGBRGGYGIBGRCGRLGUMIMNIOTIRLISLITAJEYJPNLIELUXMCONCLNFKNLDNORNZLPRTPYFSJMSLBSMRSPMSWETURUMIUSAVATVGBVIRVUTWSM",
    ...
    for region in rawInput.keys():
        countryList = [
            rawInput[region][i : i + 3] for i in range(0, len(rawInput[region]), 3)
        ]
...
] + list(dt.mapp.regions.EU28.membersOf("EU28"))
