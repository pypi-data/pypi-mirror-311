...
finalEnergyCommercial = dt.getTable(
    "Final_Energy|Comercial_and_public|Total__Historic__IEA_WEB_2019"
)
print("Final energy Commercial buildings")
print(
    "Germany: {:2.2f} {}".format(
        finalEnergyCommercial.loc["DEU", 2015], finalEnergyCommercial.meta["unit"]
    )
)
...
finalEnergyResidential = dt.getTable(
    "Final_Energy|Residential|Total__Historic__IEA_WEB_2019"
)
print("Final energy Residential buildings")
print(
    "Germany: {:2.2f} {}".format(
        finalEnergyResidential.loc["DEU", 2015], finalEnergyResidential.meta["unit"]
    )
)
...
print(
    "Germany: {:2.2f} {}".format(
        totalFinalEnergy.loc["DEU", 2015], totalFinalEnergy.meta["unit"]
    )
)
...
table_CH4_Agri = dt.getTable(
    "Emissions|CH4|Agriculture__Historic__FAO_2019"
)  # .loc[countryList,years]
