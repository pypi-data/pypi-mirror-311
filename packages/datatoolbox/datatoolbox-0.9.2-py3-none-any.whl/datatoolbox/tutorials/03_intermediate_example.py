...
scenarioCategory = {"1.5": [], "2": [], "3": [], "4": [], ">4": []}

# dictionay to temporaly saving the data to be able to compute statistics
categorizedData = {
    "1.5": pd.DataFrame(columns=list(range(2000, 2101, 10))),
...
plt.subplot(2, 1, 2)
plt.plot(
    categorizedData[">4"].columns,
    categorizedData[">4"].median(axis=0),
    "k",
    linewidth=2,
)
plt.plot(
...
plt.plot(
    categorizedData["3"].columns,
    categorizedData["3"].median(axis=0),
    "orange",
    linewidth=2,
)
plt.plot(
    categorizedData["2"].columns, categorizedData["2"].median(axis=0), "y", linewidth=2
)
plt.plot(
    categorizedData["1.5"].columns,
    categorizedData["1.5"].median(axis=0),
    "g",
    linewidth=2,
)
plt.xlim([2000, 2050])
