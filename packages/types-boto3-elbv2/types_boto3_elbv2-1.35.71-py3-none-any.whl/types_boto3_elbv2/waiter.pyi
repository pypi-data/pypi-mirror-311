...
class LoadBalancerAvailableWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elbv2/waiters/#loadbalanceravailablewaiter)
    """
    def wait(
...
class LoadBalancerExistsWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elbv2/waiters/#loadbalancerexistswaiter)
    """
    def wait(
...
class LoadBalancersDeletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elbv2/waiters/#loadbalancersdeletedwaiter)
    """
    def wait(
...
class TargetDeregisteredWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elbv2/waiters/#targetderegisteredwaiter)
    """
    def wait(
...
class TargetInServiceWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elbv2/waiters/#targetinservicewaiter)
    """
