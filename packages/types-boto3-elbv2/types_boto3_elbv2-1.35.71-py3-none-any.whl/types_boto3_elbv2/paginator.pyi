...
class DescribeAccountLimitsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elbv2/paginators/#describeaccountlimitspaginator)
    """
    def paginate(
...
class DescribeListenerCertificatesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elbv2/paginators/#describelistenercertificatespaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class DescribeListenersPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elbv2/paginators/#describelistenerspaginator)
    """
    def paginate(
...
class DescribeLoadBalancersPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elbv2/paginators/#describeloadbalancerspaginator)
    """
    def paginate(
...
class DescribeRulesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elbv2/paginators/#describerulespaginator)
    """
    def paginate(
...
class DescribeSSLPoliciesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elbv2/paginators/#describesslpoliciespaginator)
    """
    def paginate(
...
class DescribeTargetGroupsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elbv2/paginators/#describetargetgroupspaginator)
    """
    def paginate(
