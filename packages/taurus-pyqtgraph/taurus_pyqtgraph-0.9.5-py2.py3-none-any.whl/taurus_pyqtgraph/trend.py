...
class TaurusTrend(PlotWidget, BaseConfigurableClass):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        self._decimation_activated = False
    ...
    def _loadArchivingDataOnce(self):
        ask_decimation = self._ask_for_decimation
        decimation_activated = self._decimation_activated
        ...
        self._ask_for_decimation = ask_decimation
        self._decimation_activated = decimation_activated
        ...
        while True:
            ...
            if ask_period.exec_():
                ...
                try:
                    ...
                    if 0.1 < r < min_period:
                        msg = ("Buffer size will be surpassed, "
                               "data will be discarded.\n"
                               "You can change the buffer size at "
                               "your own responsibility and try again.")
                        self._askForConfirmation(msg, buttons=QtGui
                                                 .QMessageBox.Ok)
                        return None
                    return r
    ...
    def configure_decimation_options(self, activate_decimation=False,
