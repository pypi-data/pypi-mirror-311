...
def test_discover():
    ...
    result = client.discover(address='192.168.1.12/24')
    print(result)
...
def test_read1():
    ...
    dict_point = {}
    # 1_3_6_1_2_1_1_1_0
    dict_point['snmp1'] = {'point_writable': True, 'point_name': 'snmp1', 'point_device_address': '192.168.1.200/161/v1/public/public', 'point_oid': '1.3.6.1.4.1.319.1.2.0.0.0.1', 'point_scale': '1'}
    dict_point['snmp2'] = {'point_writable': True, 'point_name': 'snmp2', 'point_device_address': '192.168.1.200/161/v1/public/public', 'point_oid': '1.3.6.1.4.1.319.1.2.0.0.0.2', 'point_scale': '1'}
    dict_point['snmp3'] = {'point_writable': True, 'point_name': 'snmp3', 'point_device_address': '192.168.1.200/161/v1/public/public', 'point_oid': '1.3.6.1.2.1.1.3.0', 'point_scale': '1'}
    dict_point['snmp4'] = {'point_writable': True, 'point_name': 'snmp4', 'point_device_address': '192.168.1.200/161/v1/public/public', 'point_oid': '1.3.6.1.2.1.1.1.0', 'point_scale': '1'}
