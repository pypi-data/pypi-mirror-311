...
class ListChannelsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediapackage/paginators/#listchannelspaginator)
    """
    def paginate(
...
class ListHarvestJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediapackage/paginators/#listharvestjobspaginator)
    """
    def paginate(
...
class ListOriginEndpointsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediapackage/paginators/#listoriginendpointspaginator)
    """
    def paginate(
