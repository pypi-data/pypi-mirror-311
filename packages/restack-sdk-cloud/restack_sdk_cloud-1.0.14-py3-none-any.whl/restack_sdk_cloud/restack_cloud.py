...
class RestackCloud:
    ...
    async def stack(self, stackInput: StackInput) -> str:
            ...
            'applications': [
                {
                    ...
                    **({'healthCheckPath': app['healthCheckPath']} if 'healthCheckPath' in app else {})
        ...
        if response.status_code != 200:
            ...
            if error_message.get('error') == errorCodes.INVALID_RESTACK_CLOUD_TOKEN and error_message.get('createTokenUrl'):
