...
from typing import List, Literal, Optional, Union, Dict, Generator, Tuple
...
class IModel(metaclass=ABCMeta):
    def __init__(self, solver_id: Literal["SCIP", "CBC", "CP", "SAT", "CLP", "CPLEX", "CPLEX_CP", "GLOP", "BOP", "GLPK"], name=""):
...
class ICpModel(metaclass=ABCMeta):
    ...
    @abstractmethod
    def addMapDomain(
        self, var, bool_var_array, offset
    ):
