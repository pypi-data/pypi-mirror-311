...
class TransportWanVpnInterfaceCellularFeatureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] nat_ipv4: Network Address Translation on this interface - Default value: `false`
...
class TransportWanVpnInterfaceCellularFeature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tunnel_qos_mode: Optional[pulumi.Input[str]] = None,
            tunnel_qos_mode_variable: Optional[pulumi.Input[str]] = None,
            version: Optional[pulumi.Input[int]] = None) -> 'TransportWanVpnInterfaceCellularFeature':
        """
