...
preview_task_and_results = Table(
  ...
  Column('preview_cmd', Text, nullable=True),
  Column('results', Text, nullable=True),
)


#I see the table is under "storage collection" and with a different name
# then here. I think I'm missing something in the full cycle for creating a
# "preview-tasks table"

# https://screenshot.googleplex.com/4qdKZcnKMynqWvh
