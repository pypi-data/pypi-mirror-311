...
class ListChannelGroupsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediapackagev2/paginators/#listchannelgroupspaginator)
    """
    def paginate(
...
class ListChannelsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediapackagev2/paginators/#listchannelspaginator)
    """
    def paginate(
...
class ListHarvestJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediapackagev2/paginators/#listharvestjobspaginator)
    """
    def paginate(
...
class ListOriginEndpointsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mediapackagev2/paginators/#listoriginendpointspaginator)
    """
    def paginate(
