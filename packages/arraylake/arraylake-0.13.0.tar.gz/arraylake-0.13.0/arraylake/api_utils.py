...
class ArraylakeHttpClient:
    ...
    def __init__(self, api_url: str, hint: Optional[str] = None, token: Optional[str] = None, managed_sessions: bool = True):
        ...
        self.managed_sessions = config.get("server_managed_sessions", managed_sessions)
...
class AsyncRetryTransport(httpx.AsyncBaseTransport):
    ...
    def __post_init__(self) -> None:
        ...
        self.wrapped_transport = httpx.AsyncHTTPTransport(limits=limits, verify=self.verify_ssl, cert=self.ssl_cafile)
