...
class AsyncClient:
    ...
    Args:
        ...
        auth_org:
            [Optional] If not provided, tries to get this from `user.org` in the config.
    """
    ...
    async def _init_chunkstore(
        ...
        if bucket is None:
            ...
            return mk_chunkstore_from_bucket_config(
                bucket, repo_id, inline_threshold_bytes, fetch_credentials_func, **client_kws  # type: ignore
            )
