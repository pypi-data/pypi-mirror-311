...
async def sped_fiscal(task: RpaProcessoEntradaDTO) -> RpaRetornoProcessoDTO:
    ...
    try:
        ...
        try:
            ...
            if not checkbox_gerar_e115.is_checked() == 1:
            ...
            if not checkbox_gerar_cfop.is_checked() == 1:
            ...
            if not checkbox_valores_ipi.is_checked() == 1:
            ...
            if not checkbox_gerar_base_ct_icms_st.is_checked() == 1:
        ...
        i = 0
        while i < max_attempts:
            aviso_gerando_sped_full_path = "assets\\emsys\\gerando_sped_fiscal.png"
            try:
