...
from consul.consulprovider import ConsulProvider
...
class SecurityProvider:
    ...
    @classmethod
    async def create(cls, generate_keys: bool, ask_for_keys: bool, client_microservice_ip: str= None, client_microservice_port: int= None, consul_provider: ConsulProvider = None):
