...
class OpenTradeContextBase(OpenContextBase):
    ...
    def accinfo_query(self, trd_env=TrdEnv.REAL, acc_id=0, acc_index=0, refresh_cache=False, currency=Currency.HKD):
        ...
        col_list = [
            ...
            'hk_cash', 'hk_avl_withdrawal_cash', 'hkd_net_cash_power',
            'us_cash', 'us_avl_withdrawal_cash', 'usd_net_cash_power',
            'cn_cash', 'cn_avl_withdrawal_cash', 'cnh_net_cash_power',
            'jp_cash', 'jp_avl_withdrawal_cash', 'jpy_net_cash_power',
            'sg_cash', 'sg_avl_withdrawal_cash', 'sgd_net_cash_power',
            'au_cash', 'au_avl_withdrawal_cash', 'aud_net_cash_power',
