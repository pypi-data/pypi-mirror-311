...
from ADLStream2.utils.plot_utils import EvaluationVisualizer
...
class BaseEvaluator(ABC):
    ...
    def update_predictions(self, context):
        """Gets new predictions from ADLStream2 context

        Args:
            context (ADLStreamContext): ADLStream2 context
        """
