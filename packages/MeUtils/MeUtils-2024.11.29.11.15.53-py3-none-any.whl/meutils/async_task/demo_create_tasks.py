...
if __name__ == '__main__':
    ...
    test.do_task_retry.apply_async(kwargs={'args': "do_task_retry", "kwargs": ""})
    test.do_task_retrying.apply_async(kwargs={'args': "do_task_retrying", "kwargs": ""})
    test.do_task_retry_backoff.apply_async(kwargs={'args': "do_task_retry_backoff", "kwargs": ""})
