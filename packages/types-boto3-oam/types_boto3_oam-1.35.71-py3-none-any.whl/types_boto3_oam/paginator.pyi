...
class ListAttachedLinksPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_oam/paginators/#listattachedlinkspaginator)
    """
    def paginate(
...
class ListLinksPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_oam/paginators/#listlinkspaginator)
    """
    def paginate(
...
class ListSinksPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_oam/paginators/#listsinkspaginator)
    """
    def paginate(
