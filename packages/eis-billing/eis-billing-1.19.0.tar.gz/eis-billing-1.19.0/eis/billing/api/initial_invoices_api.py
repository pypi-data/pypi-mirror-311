...
class InitialInvoicesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_initial_invoice_endpoint = _Endpoint(
            settings={
                'response_type': (CreateInvoiceResponseClass,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/billingservice/v1/initial-invoices',
                'operation_id': 'create_initial_invoice',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def create_initial_invoice(
        ...
        **kwargs
        ...
        This will create an initial invoice. It will be created once a policy is approved and it will cover a partial until the issuing of the regular invoice.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_initial_invoice(create_invoice_request_dto, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['create_invoice_request_dto'] = \
            create_invoice_request_dto
        return self.create_initial_invoice_endpoint.call_with_http_info(**kwargs)
