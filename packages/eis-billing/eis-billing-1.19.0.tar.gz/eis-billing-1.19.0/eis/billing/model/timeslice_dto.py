...
class TimesliceDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'premium': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, policy_objects, _from, created_at, updated_at, premium, *args, **kwargs):  # noqa: E501
        """TimesliceDto - a model defined in OpenAPI

        Args:
            id (float): Internal unique identifier for the object. You should not have to use this, use code instead.
            policy_objects ([PolicyObjectDto]): Timeslice policy data.
            _from (datetime): Timeslice validity start.
            created_at (datetime): Time at which the object was created.
            updated_at (datetime): Time at which the object was updated.
            premium (bool, date, datetime, dict, float, int, list, str, none_type): Timeslice premium.
        ...
        Keyword Args:
            ...
            to (datetime): Timeslice validity end.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, policy_objects, _from, created_at, updated_at, premium, *args, **kwargs):  # noqa: E501
        """TimesliceDto - a model defined in OpenAPI
