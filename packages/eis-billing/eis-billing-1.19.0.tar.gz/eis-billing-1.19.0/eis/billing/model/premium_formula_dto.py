...
class PremiumFormulaDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, product_version_id, group, name, expression, type, unit, *args, **kwargs):  # noqa: E501
        """PremiumFormulaDto - a model defined in OpenAPI
        ...
        Args:
            ...
            type (str): Type of Premium that is based on time.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, product_version_id, group, name, expression, type, unit, *args, **kwargs):  # noqa: E501
        """PremiumFormulaDto - a model defined in OpenAPI
