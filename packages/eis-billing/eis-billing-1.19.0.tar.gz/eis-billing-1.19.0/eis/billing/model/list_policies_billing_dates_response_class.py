...
class ListPoliciesBillingDatesResponseClass(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([PolicyBillingDateClass],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, next_page_token, *args, **kwargs):  # noqa: E501
        """ListPoliciesBillingDatesResponseClass - a model defined in OpenAPI

        Args:
            items ([PolicyBillingDateClass]): Invoices list items.
