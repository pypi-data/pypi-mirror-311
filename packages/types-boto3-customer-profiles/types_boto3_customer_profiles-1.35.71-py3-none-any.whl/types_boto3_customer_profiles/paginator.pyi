...
class GetSimilarProfilesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_customer_profiles/paginators/#getsimilarprofilespaginator)
    """
    def paginate(
...
class ListEventStreamsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_customer_profiles/paginators/#listeventstreamspaginator)
    """
    def paginate(
...
class ListObjectTypeAttributesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_customer_profiles/paginators/#listobjecttypeattributespaginator)
    """
    def paginate(
        self,
...
class ListRuleBasedMatchesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_customer_profiles/paginators/#listrulebasedmatchespaginator)
    """
    def paginate(
...
class ListSegmentDefinitionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_customer_profiles/paginators/#listsegmentdefinitionspaginator)
    """
    def paginate(
