...
@LastEditTime: 2024-11-22 17:14:46
...
class CdpHelper:
    ...
    @classmethod
    def get_valid_date(self, valid_type, expire_type, expire_value):
        """
        ...
        if valid_type == 1:
            ...
            if expire_type == 1: # 指定天过期
                return (datetime.now() + timedelta(days=int(expire_value))).strftime("%Y-%m-%d 23:59:59")
            else:
                return expire_value
