...
class SchemeLevelInfo:
    def __init__(self):
        ...
        self.expire_select_type = 0 # 过期选项类型(0-当年 1-1年 2-2年)
    ...
    def get_field_list(cls):
        return [
            'id', 'guid', 'scheme_id', 'level_id', 'level_name', 'valid_type', 'expire_type', 'expire_value', 'expire_select_type', 'upgrade_threshold', 'relegation_threshold', 'is_release', 'create_date', 'modify_date'
        ]
