...
@LastEditTime: 2024-11-25 11:31:07
...
class StoreBase:
    ...
    def __init__(self):
        ...
        self.incr_process_start_date = ""  # 增量处理时间
    ...
    def get_field_list(self):
        return ['id', 'guid', 'business_id', 'scheme_id', 'platform_id', 'store_name', 'seller_nick', 'plat_store_id', 'init_integral_multiple', 'init_growth_config', 'is_incr_process', 'incr_process_start_date', 'is_omid_merge', 'is_release', 'create_date', 'modify_date']
