...
class NetworkManagerClient(BaseClient):
    ...
    def create_direct_connect_gateway_attachment(
        ...
        """
        Creates an Amazon Web Services Direct Connect gateway attachment See also: [AWS
        API
        Documentation](https://docs.aws.amazon.com/goto/WebAPI/networkmanager-2019-07-05/CreateDirectConnectGatewayAttachment).
