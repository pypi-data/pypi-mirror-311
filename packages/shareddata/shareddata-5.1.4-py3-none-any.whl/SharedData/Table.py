...
class Table:
    ...
    string_fields = ['symbol','tag','portfolio','tradeid','clordid']
    ...
    def init_paths(self):
        ...
        if not self.shareddata.schema is None:
            ...
            try:
                ...
                if loc[0] != -1:
                    folder_local = self.shareddata.schema[loc[0]]['folder_local'] # BUG: folder_local is not being updated
                ...
                if (self.database_folder == ''):
                    ...
                    if len(self.shareddata.dbfolders) > 1:
                        ...
                        self.database_folder = self.shareddata.dbfolders[0]
                    self.schema['folder_local'] = self.database_folder.encode('utf-8') # BUG: folder_local is not being updated
            except Exception as e:
    ...
    def create_header(self):
        ...
        if not check_pkey:
            ...
            if self.hasindex:
                for field in Table.string_fields:
