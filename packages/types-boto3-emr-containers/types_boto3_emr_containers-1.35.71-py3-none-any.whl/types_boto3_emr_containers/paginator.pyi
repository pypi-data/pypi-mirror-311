...
class ListJobRunsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_emr_containers/paginators/#listjobrunspaginator)
    """
    def paginate(
...
class ListJobTemplatesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_emr_containers/paginators/#listjobtemplatespaginator)
    """
    def paginate(
...
class ListManagedEndpointsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_emr_containers/paginators/#listmanagedendpointspaginator)
    """
    def paginate(
...
class ListSecurityConfigurationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_emr_containers/paginators/#listsecurityconfigurationspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListVirtualClustersPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_emr_containers/paginators/#listvirtualclusterspaginator)
    """
    def paginate(
