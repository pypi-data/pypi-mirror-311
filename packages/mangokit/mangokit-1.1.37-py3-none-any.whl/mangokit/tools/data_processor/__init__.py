...
from mangokit.exceptions import ERROR_MSG_0028, ERROR_MSG_0002, ERROR_MSG_0047, ToolsError
...
from .random_character_info_data import RandomCharacterInfoData
from .random_number_data import RandomNumberData
from .random_string_data import RandomStringData
from .random_time_data import RandomTimeData
    ...
    def regular(self, func: str):
        ...
        if match:
            ...
            try:
                ...
                raise ToolsError(*ERROR_MSG_0047)
...
class DataProcessor(ObtainRandomData, DataClean):
    ...
    def specify_replace(cls, data: str, replace: str):
        ...
        if len(replace_list) > 1:
            raise ToolsError(*ERROR_MSG_0028)
    ...
    def replace_str(self, data: str) -> str:
        ...
        for replace_value in replace_list:
            ...
            if value is None:
                raise ToolsError(*ERROR_MSG_0002, value=(key_text,))
            if key:
