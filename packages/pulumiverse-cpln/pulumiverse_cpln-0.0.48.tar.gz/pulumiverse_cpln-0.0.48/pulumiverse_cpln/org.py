...
class OrgArgs:
    ...
    def observability(self, value: pulumi.Input['OrgObservabilityArgs']):
    ...
    @invitees.setter
    def invitees(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
    ...
    def session_timeout_seconds(self, value: Optional[pulumi.Input[int]]):
