...
setuptools.setup(
    ...
    keywords="petkit, eversweet 3 pro, feeder mini, d4, petkit feeder, petkit water fountain, freshelement solo, pura x, pura max, pura air, purobot, eversweet max, pura max 2",
