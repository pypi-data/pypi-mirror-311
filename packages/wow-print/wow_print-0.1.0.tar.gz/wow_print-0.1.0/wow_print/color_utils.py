...
def _predefined_color_check(color: str) -> list:
    """
...
def _hex_to_rgb(hex_color: str) -> tuple | list:
    """
...
def _rgb_to_ansi(rgb_color: tuple | list, is_foreground: bool) -> str | list:
    """
...
def color_print(text=None, fg: str = None, bg: str = None, bold: bool = False, italic: bool = False,
                underline: bool = False, strikethrough: bool = False, frame: bool = False, print_time: bool = True):
    """
