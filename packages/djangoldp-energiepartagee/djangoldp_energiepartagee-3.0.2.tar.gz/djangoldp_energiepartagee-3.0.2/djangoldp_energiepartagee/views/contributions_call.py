from djangoldp_energiepartagee.models.contribution import CONTRIBUTION_CHOICES
from djangoldp_energiepartagee.views.contributions import ContributionsView
