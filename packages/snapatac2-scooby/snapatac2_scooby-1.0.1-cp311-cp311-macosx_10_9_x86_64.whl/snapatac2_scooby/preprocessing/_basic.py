...
from snapatac2_scooby.preprocessing._cell_calling import filter_cellular_barcodes_ordmag
...
def make_fragment_file(
    ...
    if compression is None:
        _, compression = snapatac2_scooby._utils.get_file_format(output_file)
...
def import_data(
    ...
    *,
    ...
    sorted_by_barcode
        ...
        Note the :func:`~snapatac2_scooby.pp.make_fragment_file` will always sort the
    ...
    --------
    make_fragment_file
    :func:`~snapatac2_scooby.ex.export_fragments` 
    ...
    if isinstance(fragment_file, list):
        ...
        snapatac2_scooby._utils.anndata_ipar(
    ...
    *,
    ...
    if inplace:
        if isinstance(adata, list):
            snapatac2_scooby._utils.anndata_par(
                adata,
...
def select_features(
    ...
    iter = 1
    while iter < max_iter:
        embedding = snapatac2_scooby.tl.spectral(adata, features=selected_features, inplace=False)[1]
        clusters = snapatac2_scooby.tl.leiden(snapatac2_scooby.pp.knn(embedding, inplace=False))
        rpm = snapatac2_scooby.tl.aggregate_X(adata, groupby=clusters).X
