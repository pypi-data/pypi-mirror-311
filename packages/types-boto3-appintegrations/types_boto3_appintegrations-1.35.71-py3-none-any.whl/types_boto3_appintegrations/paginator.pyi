...
class ListApplicationAssociationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_appintegrations/paginators/#listapplicationassociationspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListApplicationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_appintegrations/paginators/#listapplicationspaginator)
    """
    def paginate(
...
class ListDataIntegrationAssociationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_appintegrations/paginators/#listdataintegrationassociationspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListDataIntegrationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_appintegrations/paginators/#listdataintegrationspaginator)
    """
    def paginate(
...
class ListEventIntegrationAssociationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_appintegrations/paginators/#listeventintegrationassociationspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListEventIntegrationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_appintegrations/paginators/#listeventintegrationspaginator)
    """
    def paginate(
