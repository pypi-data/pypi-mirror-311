...
hv.extension('bokeh')
pn.config.theme = 'default' # 'default' / 'dark'
...
class MRIsimulator(param.Parameterized):
    ...
    def loadPhantom(self):
        ...
        if npyFiles:
            ...
            for poly in tqdm(polys, units=' polygons'):
    ...
    def setupSpoiler(self):
        spoilerArea = 30. # uTs/m
        self.boards['slice']['objects']['spoiler'] = sequence.getGradient('slice', totalArea=0, name='spoiler')
