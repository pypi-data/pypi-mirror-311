...
if os.getenv(('PYPWS_RUN_LOCALLY')).lower() == 'true':
...
def test_41a():
    ...
    flammable_output_configs = [FlammableOutputConfig(position = LocalPosition(50.0, 0.0, 0.0)), FlammableOutputConfig(position = LocalPosition(50.0, 0.0, 1.0)), FlammableOutputConfig(position = LocalPosition(50.0, 3.0, 2.0))]
