...
def test_case_130():
    ...
    if resultCode == ResultCode.SUCCESS:
        ...
        print (f'Mole fraction: {convert_comp_mass_to_mole_calculation.composition_mole}')
        print (f'Mass fraction: {convert_comp_mass_to_mole_calculation.composition_mass}')
