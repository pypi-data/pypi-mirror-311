...
class UnstableDatasetEntryCreateRequestEntriesItem(pydantic.BaseModel):
    ...
    rejected_message: typing.Optional[UnstableDatasetEntryCreateRequestEntriesItemRejectedMessage]
    ...
    judgement: typing.Optional[UnstableDatasetEntryCreateRequestEntriesItemJudgement]
