...
class UpdateIdpGroupMappingsRequest(BaseModel):
    """
    UpdateIdpGroupMappingsRequest
    """ # noqa: E501
    mappings: List[UpdateIdpGroupMappingsRequestMappingsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mappings": [UpdateIdpGroupMappingsRequestMappingsInner.from_dict(_item) for _item in obj["mappings"]] if obj.get("mappings") is not None else None
        })
