...
class CreateRequestInfoSupportTicket(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ticketing_provider", "remote_id", "identifier", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ticketing_provider": obj.get("ticketing_provider"),
