...
class PaymentDataReader(_DataReader):
    ...
    def get_total_credit_card_df(self, start_date, end_date):
        ...
        total_credit_card_df = (
            total_credit_card_df[total_credit_card_df['ITEM_NAME2'] == '합계']
            .pivot(index='TIME', columns='ITEM_NAME1', values='DATA_VALUE')
            )
    ...
    def get_bank_credit_card_df(self, start_date, end_date):
        ...
        bank_credit_card_df = (
            bank_credit_card_df[bank_credit_card_df['ITEM_NAME2'] == '은행계']
            .pivot(index='TIME', columns='ITEM_NAME1', values='DATA_VALUE')
            )
    ...
    def get_not_bank_credit_card_df(self, start_date, end_date):
        ...
        not_bank_credit_card_df = (
            not_bank_credit_card_df[not_bank_credit_card_df['ITEM_NAME2'] == '비은행계']
            .pivot(index='TIME', columns='ITEM_NAME1', values='DATA_VALUE')
            )
