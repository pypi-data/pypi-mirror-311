...
class ListCrlsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_rolesanywhere/paginators/#listcrlspaginator)
    """
    def paginate(
...
class ListProfilesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_rolesanywhere/paginators/#listprofilespaginator)
    """
    def paginate(
...
class ListSubjectsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_rolesanywhere/paginators/#listsubjectspaginator)
    """
    def paginate(
...
class ListTrustAnchorsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_rolesanywhere/paginators/#listtrustanchorspaginator)
    """
    def paginate(
