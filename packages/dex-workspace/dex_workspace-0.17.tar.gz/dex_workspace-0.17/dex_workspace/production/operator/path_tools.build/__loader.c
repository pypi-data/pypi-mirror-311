 ...
 */
extern PyObject *modulecode_path_tools(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"path_tools", modulecode_path_tools, 0, 0, NUITKA_TRANSLATED_FLAG
