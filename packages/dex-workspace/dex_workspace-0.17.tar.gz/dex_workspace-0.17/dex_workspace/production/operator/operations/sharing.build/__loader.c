 ...
 */
extern PyObject *modulecode_sharing(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"sharing", modulecode_sharing, 0, 0, NUITKA_TRANSLATED_FLAG
