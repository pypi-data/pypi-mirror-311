 ...
 */
extern PyObject *modulecode_scripts(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"scripts", modulecode_scripts, 0, 0, NUITKA_TRANSLATED_FLAG
