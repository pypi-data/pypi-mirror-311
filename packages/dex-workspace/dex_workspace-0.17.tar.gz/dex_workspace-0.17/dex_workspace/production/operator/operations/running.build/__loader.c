 ...
 */
extern PyObject *modulecode_running(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"running", modulecode_running, 0, 0, NUITKA_TRANSLATED_FLAG
