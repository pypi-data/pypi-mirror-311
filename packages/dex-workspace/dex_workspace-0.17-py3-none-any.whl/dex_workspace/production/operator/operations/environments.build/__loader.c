 ...
 */
extern PyObject *modulecode_environments(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"environments", modulecode_environments, 0, 0, NUITKA_TRANSLATED_FLAG
