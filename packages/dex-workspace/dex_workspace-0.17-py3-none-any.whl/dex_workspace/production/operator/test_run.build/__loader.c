 ...
 */
extern PyObject *modulecode_test_run(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"test_run", modulecode_test_run, 0, 0, NUITKA_TRANSLATED_FLAG
