 ...
 */
extern PyObject *modulecode_storage(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"storage", modulecode_storage, 0, 0, NUITKA_TRANSLATED_FLAG
