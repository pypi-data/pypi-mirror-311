 ...
 */
extern PyObject *modulecode_files(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"files", modulecode_files, 0, 0, NUITKA_TRANSLATED_FLAG
