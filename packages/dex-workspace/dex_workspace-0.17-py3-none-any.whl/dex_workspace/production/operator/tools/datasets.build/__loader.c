 ...
 */
extern PyObject *modulecode_datasets(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"datasets", modulecode_datasets, 0, 0, NUITKA_TRANSLATED_FLAG
