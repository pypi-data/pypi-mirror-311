 ...
 */
extern PyObject *modulecode_run_request(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"run_request", modulecode_run_request, 0, 0, NUITKA_TRANSLATED_FLAG
