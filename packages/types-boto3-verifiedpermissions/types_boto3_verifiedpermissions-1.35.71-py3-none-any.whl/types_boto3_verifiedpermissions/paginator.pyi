...
class ListIdentitySourcesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_verifiedpermissions/paginators/#listidentitysourcespaginator)
    """
    def paginate(
...
class ListPoliciesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_verifiedpermissions/paginators/#listpoliciespaginator)
    """
    def paginate(
...
class ListPolicyStoresPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_verifiedpermissions/paginators/#listpolicystorespaginator)
    """
    def paginate(
...
class ListPolicyTemplatesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_verifiedpermissions/paginators/#listpolicytemplatespaginator)
    """
    def paginate(
