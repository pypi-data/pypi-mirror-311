...
class ListCapabilitiesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_b2bi/paginators/#listcapabilitiespaginator)
    """
    def paginate(
...
class ListPartnershipsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_b2bi/paginators/#listpartnershipspaginator)
    """
    def paginate(
...
class ListProfilesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_b2bi/paginators/#listprofilespaginator)
    """
    def paginate(
...
class ListTransformersPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_b2bi/paginators/#listtransformerspaginator)
    """
    def paginate(
