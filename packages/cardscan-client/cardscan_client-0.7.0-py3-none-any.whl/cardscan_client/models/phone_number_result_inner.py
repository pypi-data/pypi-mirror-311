...
class PhoneNumberResultInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhoneNumberResultInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhoneNumberResultInner:
        """Create an instance of PhoneNumberResultInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PhoneNumberResultInner.parse_obj(obj)

        _obj = PhoneNumberResultInner.parse_obj({
            "value": obj.get("value"),
