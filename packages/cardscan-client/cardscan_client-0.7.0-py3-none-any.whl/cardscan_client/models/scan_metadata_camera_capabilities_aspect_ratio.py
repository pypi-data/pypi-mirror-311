...
class ScanMetadataCameraCapabilitiesAspectRatio(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScanMetadataCameraCapabilitiesAspectRatio:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScanMetadataCameraCapabilitiesAspectRatio:
        """Create an instance of ScanMetadataCameraCapabilitiesAspectRatio from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ScanMetadataCameraCapabilitiesAspectRatio.parse_obj(obj)

        _obj = ScanMetadataCameraCapabilitiesAspectRatio.parse_obj({
            "max": obj.get("max"),
            "min": obj.get("min")
        })
        return _obj
