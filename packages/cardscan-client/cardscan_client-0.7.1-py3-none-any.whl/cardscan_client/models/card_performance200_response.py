...
class CardPerformance200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardPerformance200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardPerformance200Response:
        """Create an instance of CardPerformance200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardPerformance200Response.parse_obj(obj)

        _obj = CardPerformance200Response.parse_obj({
