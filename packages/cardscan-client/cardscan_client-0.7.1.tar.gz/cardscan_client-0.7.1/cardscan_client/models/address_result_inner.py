...
class AddressResultInner(BaseModel):
    """
    AddressResultInner
    """
    ...
    __properties = ["value", "scores", "type", "label"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressResultInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressResultInner:
        """Create an instance of AddressResultInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressResultInner.parse_obj(obj)

        _obj = AddressResultInner.parse_obj({
            "value": obj.get("value"),
