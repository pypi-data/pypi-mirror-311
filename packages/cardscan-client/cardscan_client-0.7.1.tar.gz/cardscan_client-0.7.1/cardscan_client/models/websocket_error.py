...
class WebsocketError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebsocketError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebsocketError:
        """Create an instance of WebsocketError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebsocketError.parse_obj(obj)

        _obj = WebsocketError.parse_obj({
