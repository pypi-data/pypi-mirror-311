...
class CopayResultInner(BaseModel):
    """
    CopayResultInner
    """
    ...
    __properties = ["value", "scores", "service", "category"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CopayResultInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CopayResultInner:
        """Create an instance of CopayResultInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CopayResultInner.parse_obj(obj)

        _obj = CopayResultInner.parse_obj({
            "value": obj.get("value"),
