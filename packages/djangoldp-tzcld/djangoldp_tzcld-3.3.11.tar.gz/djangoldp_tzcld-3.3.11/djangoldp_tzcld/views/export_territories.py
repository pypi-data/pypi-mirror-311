                ...
                if validators.url(urlid):
                    ...
                    if instance:
                        ...
                        if territories_adhesions:
                            ...
                            name = []
                            year = []
                            for territories_adhesion in territories_adhesions:
                                type.append(getattr(territories_adhesion, "type", ""))
                                name.append(getattr(territories_adhesion, "name", ""))
                                year.append(getattr(territories_adhesion, "year", ""))
                            row.append(", ".join(type))
                            row.append(", ".join(name))
                            row.append(", ".join(year))
