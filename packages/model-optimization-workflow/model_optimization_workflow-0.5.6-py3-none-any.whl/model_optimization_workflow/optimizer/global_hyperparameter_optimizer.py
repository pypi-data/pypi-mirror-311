...
class GlobalHyperparameterOptimizer:
    ...
    def suggest_parameters(self):
        ...
        params = {
            ...
            'prediction_window': trial.suggest_categorical(
                'prediction_window',
                self.config['assembler']['dataset_labeler']['parameters']['prediction_window']
            ),
    ...
    def print_final_results(self):
        ...
        formatted_params = {
            ...
            'prediction_window': best_trial.params['prediction_window'],
