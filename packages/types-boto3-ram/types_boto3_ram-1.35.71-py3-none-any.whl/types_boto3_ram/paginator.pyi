...
class GetResourcePoliciesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ram/paginators/#getresourcepoliciespaginator)
    """
    def paginate(
...
class GetResourceShareAssociationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ram/paginators/#getresourceshareassociationspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class GetResourceShareInvitationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ram/paginators/#getresourceshareinvitationspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class GetResourceSharesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ram/paginators/#getresourcesharespaginator)
    """
    def paginate(
...
class ListPrincipalsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ram/paginators/#listprincipalspaginator)
    """
    def paginate(
...
class ListResourcesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ram/paginators/#listresourcespaginator)
    """
    def paginate(
