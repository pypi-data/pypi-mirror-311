...
def new_hatchat(backend_url: str):
    ...
    for i in range(maxRetry):
        try:
            ...
            cc = config_loader.load_client_config(ClientConfig(
...
wfapp = new_hatchat(settings.GOMTM_URL)