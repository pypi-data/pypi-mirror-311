...
from mtmai.chainlit.data.base import BaseDataLayer
from mtmai.chainlit.data.utils import queue_until_user_message
...
if TYPE_CHECKING:
    ...
    from mtmai.chainlit.step import FeedbackDict, StepDict
...
class LiteralDataLayer(BaseDataLayer):
    ...
    async def get_thread(self, thread_id: str) -> "Optional[ThreadDict]":
        from mtmai.chainlit.step import check_add_step_in_cot, stub_step
