...
if TYPE_CHECKING:
    from mtmai.chainlit.types import FileReference
...
class BaseSession:
    ...
    @property
    def files_dir(self):
        from mtmai.chainlit.config import FILES_DIRECTORY
    ...
    async def persist_file(
        ...
        # 功能： 将文本 图形，视频等 element 持久存储到本地文件系统。
        #       但是，以后会升级为使数据库或者第三方放存储的方式来完成这里的功能。
    ...
    def to_persistable(self) -> Dict:
        from mtmai.chainlit.user_session import user_sessions
