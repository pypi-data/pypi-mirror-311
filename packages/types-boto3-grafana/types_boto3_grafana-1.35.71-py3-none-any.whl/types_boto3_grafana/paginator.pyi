...
class ListPermissionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_grafana/paginators/#listpermissionspaginator)
    """
    def paginate(
...
class ListVersionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_grafana/paginators/#listversionspaginator)
    """
    def paginate(
...
class ListWorkspaceServiceAccountTokensPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_grafana/paginators/#listworkspaceserviceaccounttokenspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListWorkspaceServiceAccountsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_grafana/paginators/#listworkspaceserviceaccountspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListWorkspacesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_grafana/paginators/#listworkspacespaginator)
    """
    def paginate(
