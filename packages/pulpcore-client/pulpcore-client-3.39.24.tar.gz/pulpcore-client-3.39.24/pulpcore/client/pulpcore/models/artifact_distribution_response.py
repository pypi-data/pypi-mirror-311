...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, pulp_href=None, pulp_labels=None, pulp_created=None, base_path=None, base_url=None, content_guard=None, hidden=False, local_vars_configuration=None):  # noqa: E501
