...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_path=None, pulp_labels=None, pulp_href=None, base_url=None, content_guard=None, name=None, local_vars_configuration=None):  # noqa: E501
