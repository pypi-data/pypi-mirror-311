...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, prn=None, content_guard=None, name=None, base_path=None, pulp_href=None, no_content_change_since=None, hidden=False, base_url=None, pulp_last_updated=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
