...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, base_url=None, pulp_href=None, base_path=None, hidden=False, pulp_labels=None, pulp_created=None, name=None, local_vars_configuration=None):  # noqa: E501
