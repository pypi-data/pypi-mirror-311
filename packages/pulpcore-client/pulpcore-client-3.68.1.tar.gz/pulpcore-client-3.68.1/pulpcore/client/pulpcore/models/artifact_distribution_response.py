...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, content_guard=None, hidden=False, prn=None, base_path=None, base_url=None, name=None, no_content_change_since=None, pulp_last_updated=None, pulp_href=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
