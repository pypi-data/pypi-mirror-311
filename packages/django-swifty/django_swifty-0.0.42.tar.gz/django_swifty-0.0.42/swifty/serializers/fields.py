...
class BasicFieldSerializer:
    ...
    def __init__(self, *args, extra_kwargs=None, **kwargs):
        self.extra_kwargs = extra_kwargs or {}
        super(BasicFieldSerializer, self).__init__(self, *args, **kwargs)
...
class BaseSectionField(serializers.JSONField):
    ...
    def __init__(self, section=None, **filtered_kwargs):
        """
        _summary_
        ...
        self.fields = self.section["fields"] = (
            section
            and {
                field_props["field_name"]: FIELD_TYPE_MAP[field_props["type"]](
                    parent=self, **field_props
                )
                for field_props in section.get("fields", [])
                if field_props
            }
            or {}
        )
