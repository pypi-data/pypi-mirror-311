...
from pc_builder.suggestions.cpu import suggestCompatibleCPU


class TestSuggestCompatibleCPU(unittest.TestCase):
    ...
    def test_suggest_compatible_cpus(self, mock_load_cpus):
        ...
        result = suggestCompatibleCPU(userBuild, cpuComp=None)
...
class TestSuggestCompatibleCPUExtended(unittest.TestCase):
    ...
    def test_out_of_budget_returns_cheapest_cpus(self, mock_load_cpus):
        ...
        cpu1 = MagicMock(
            price="150$", checkCompatibility=MagicMock(return_value=(True, "Compatible"))
        )
        cpu2 = MagicMock(
            price="120$", checkCompatibility=MagicMock(return_value=(True, "Compatible"))
        )
        cpu3 = MagicMock(
            price="170$", checkCompatibility=MagicMock(return_value=(True, "Compatible"))
        )
        cpu4 = MagicMock(
            price="110$", checkCompatibility=MagicMock(return_value=(True, "Compatible"))
        )
        cpu5 = MagicMock(
            price="190$", checkCompatibility=MagicMock(return_value=(True, "Compatible"))
        )
        cpu6 = MagicMock(
            price="100$", checkCompatibility=MagicMock(return_value=(True, "Compatible"))
        )
    ...
    def test_cpus_within_budget_and_use_case_work(self, mock_load_cpus):
        ...
        cpu1 = MagicMock(
            price="230$", checkCompatibility=MagicMock(return_value=(True, "Compatible"))
        )
        cpu2 = MagicMock(
            price="500$",
    ...
    def test_cpus_within_budget_and_use_case_gaming(self, mock_load_cpus):
        ...
        cpu1 = MagicMock(
            price="200$", checkCompatibility=MagicMock(return_value=(True, "Compatible"))
        )
        cpu2 = MagicMock(
            price="500$",
            checkCompatibility=MagicMock(return_value=(True, "Compatible")),
