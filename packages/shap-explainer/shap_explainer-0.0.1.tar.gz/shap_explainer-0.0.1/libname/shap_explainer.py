def shap_values_to_json_with_bins(features, shap_values, num_bins=10):
...
def chat_with_gpt(prompt, llm_chain, shap_data):
    ...
    3. Offer quantified recommendations derived from SHAP trends and causal data.
    4. Summarize findings with a concise, prioritized action plan.
    ...
    3. **Data-Driven Recommendations:**
       ...
       - Quantify recommendations wherever possible (e.g., "Complete X additional projects").
