...
class Deasciifier:
    ...
    turkish_downcase_asciify_table["ç"] = "c"
    turkish_downcase_asciify_table["Ç"] = "c"
    turkish_downcase_asciify_table["ğ"] = "g"
    turkish_downcase_asciify_table["Ğ"] = "g"
    turkish_downcase_asciify_table["ö"] = "o"
    turkish_downcase_asciify_table["Ö"] = "o"
    turkish_downcase_asciify_table["ı"] = "i"
    turkish_downcase_asciify_table["İ"] = "i"
    turkish_downcase_asciify_table["ş"] = "s"
    turkish_downcase_asciify_table["Ş"] = "s"
    turkish_downcase_asciify_table["ü"] = "u"
    turkish_downcase_asciify_table["Ü"] = "u"
    ...
    turkish_upcase_accents_table["ç"] = "C"
    turkish_upcase_accents_table["Ç"] = "C"
    turkish_upcase_accents_table["ğ"] = "G"
    turkish_upcase_accents_table["Ğ"] = "G"
    turkish_upcase_accents_table["ö"] = "O"
    turkish_upcase_accents_table["Ö"] = "O"
    turkish_upcase_accents_table["ı"] = "I"
    turkish_upcase_accents_table["İ"] = "i"
    turkish_upcase_accents_table["ş"] = "S"
    turkish_upcase_accents_table["Ş"] = "S"
    turkish_upcase_accents_table["ü"] = "U"
    turkish_upcase_accents_table["Ü"] = "U"
    ...
    def convert_to_turkish(self):
        ...
        for i in range(len(self.turkish_string)):
            ...
            if self.turkish_need_correction(c, point=i):
                ...
                self.turkish_string = self.set_char_at(
                    self.turkish_string, i, self.turkish_toggle_accent(c)
                )
            else:
    ...
    def turkish_match_pattern(self, dlist, point=0):
        ...
        rank = 2 * len(dlist)
        str = self.turkish_get_context(
            Deasciifier.turkish_context_size, point=point
        )
        start = 0
        end = 0
    ...
    def turkish_get_context(self, size=turkish_context_size, point=0):
        ...
        while i < len(s) and not space and index < len(self.ascii_string):
            current_char = self.turkish_string[index]
            x = Deasciifier.turkish_downcase_asciify_table.get(
                current_char, False
            )
            if not x:
                if not space:
        ...
        while i >= 0 and index >= 0:
            current_char = self.turkish_string[index]
            x = Deasciifier.turkish_upcase_accents_table.get(
                current_char, False
            )
            if not x:
                if not space:
