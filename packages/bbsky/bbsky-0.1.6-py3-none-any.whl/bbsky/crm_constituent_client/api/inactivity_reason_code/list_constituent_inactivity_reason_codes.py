...
from ...models.constituent_inactivity_reason_codes_list_collection import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/constituentinactivityreasoncodes",
        "params": params,
    }
...
) -> Optional[Union[Any, ConstituentInactivityReasonCodesListCollection, ProblemDetails]]:
    if response.status_code == 200:
        response_200 = ConstituentInactivityReasonCodesListCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ConstituentInactivityReasonCodesListCollection, ProblemDetails]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List constituent inactivity reason codes.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ConstituentInactivityReasonCodesListCollection, ProblemDetails]
    """
