...
if TYPE_CHECKING:
    from ..models.constituent_merge_list_summary import ConstituentMergeListSummary


T = TypeVar("T", bound="ConstituentMergeListCollection")


@_attrs_define
class ConstituentMergeListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentMergeListSummary']]): The set of items included in the response. This may
    ...
    value: Union[Unset, List["ConstituentMergeListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentMergeListSummary.from_dict(value_item_data)
        ...
        constituent_merge_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_merge_list_collection
