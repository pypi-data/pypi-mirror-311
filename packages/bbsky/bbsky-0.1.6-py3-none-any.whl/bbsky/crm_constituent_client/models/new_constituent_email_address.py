...
T = TypeVar("T", bound="NewConstituentEmailAddress")


@_attrs_define
class NewConstituentEmailAddress:
    """CreateConstituentEmailAddress.

    Example:
        {'constituent_id': '11163BAF-07CF-40A1-AA54-E5F2C2F3AECC', 'email_address_type': 'Email', 'email_address':
            'tmv@groupmail.net', 'primary': True, 'spouse_name': '', 'update_matching_spouse_email_address': False,
            'household': False, 'household_member': False, 'update_matching_household_email_address': False, 'do_not_email':
            False, 'info_source': '', 'info_source_comments': '', 'constituent_data_review_rollback_reason': '',
            'forced_primary': False, 'can_edit_primary': False, 'invalid_fields': '', 'origin': 'User', 'start_date':
            '2015-09-18T12:00:00.0000000+00:00'}
    ...
    Attributes:
        ...
        update_matching_household_email_address (Union[Unset, bool]): Indicates whether copy email address information
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_constituent_email_address = cls(
            constituent_id=constituent_id,
            email_address=email_address,
        ...
        return new_constituent_email_address
