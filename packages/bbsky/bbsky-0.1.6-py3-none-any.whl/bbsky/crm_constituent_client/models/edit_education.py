...
if TYPE_CHECKING:
    from ..models.edit_education_affiliated_additional_information import (
        EditEducationAffiliatedAdditionalInformation,
    )
    from ..models.edit_education_unaffiliated_additional_information import (
        EditEducationUnaffiliatedAdditionalInformation,
    )
    from ..models.fuzzy_date import FuzzyDate


T = TypeVar("T", bound="EditEducation")
...
class EditEducation:
    ...
    Example:
        {'primary_record': False, 'educational_institution_id': '6d31a4d0-57fb-454e-9ce9-f09049327153',
            'academic_catalog_program': '', 'educational_program': 'FullCourse', 'constituency_status': 'Unknown',
            'date_graduated': {'year': 2015, 'month': 6, 'day': 17}, 'date_left': {'year': 2017, 'month': 4, 'day': 19},
            'academic_catalog_degree': '', 'educational_degree': 'MBA', 'educational_award': '', 'start_date': {'year':
            2014, 'month': 4, 'day': 13}, 'class_year': 0, 'preferred_class_year': 0, 'educational_source': '',
            'educational_source_date': {'year': 0, 'month': 0, 'day': 0}, 'comment': '', 'affiliated': False,
            'educational_history_level': '', 'educational_history_reason': '', 'use_academic_catalog': False,
            'educational_history_status': '00000000-0000-0000-0000-000000000004'}

    Attributes:
        primary_record (Union[Unset, bool]): Indicates whether primary education information.
        educational_institution_id (Union[Unset, str]): The educational institution.
        ...
        affiliated_additional_information (Union[Unset, List['EditEducationAffiliatedAdditionalInformation']]):
            Affiliated additional information.
        unaffiliated_additional_information (Union[Unset, List['EditEducationUnaffiliatedAdditionalInformation']]):
        ...
        educational_history_status (Union[Unset, str]): The status. This simple list can be queried at
    ...
    educational_institution_id: Union[Unset, str] = UNSET
    ...
    affiliated_additional_information: Union[Unset, List["EditEducationAffiliatedAdditionalInformation"]] = UNSET
    unaffiliated_additional_information: Union[Unset, List["EditEducationUnaffiliatedAdditionalInformation"]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if educational_institution_id is not UNSET:
            field_dict["educational_institution_id"] = educational_institution_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        educational_institution_id = d.pop("educational_institution_id", UNSET)
        ...
        for affiliated_additional_information_item_data in _affiliated_additional_information or []:
            affiliated_additional_information_item = EditEducationAffiliatedAdditionalInformation.from_dict(
        ...
        for unaffiliated_additional_information_item_data in _unaffiliated_additional_information or []:
            unaffiliated_additional_information_item = EditEducationUnaffiliatedAdditionalInformation.from_dict(
