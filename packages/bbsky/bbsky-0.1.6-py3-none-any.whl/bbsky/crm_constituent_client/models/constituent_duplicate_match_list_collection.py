...
if TYPE_CHECKING:
    from ..models.constituent_duplicate_match_list_summary import ConstituentDuplicateMatchListSummary


T = TypeVar("T", bound="ConstituentDuplicateMatchListCollection")


@_attrs_define
class ConstituentDuplicateMatchListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentDuplicateMatchListSummary']]): The set of items included in the response.
            This may be a subset of the items in the collection.
    ...
    value: Union[Unset, List["ConstituentDuplicateMatchListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentDuplicateMatchListSummary.from_dict(value_item_data)
        ...
        constituent_duplicate_match_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_duplicate_match_list_collection
