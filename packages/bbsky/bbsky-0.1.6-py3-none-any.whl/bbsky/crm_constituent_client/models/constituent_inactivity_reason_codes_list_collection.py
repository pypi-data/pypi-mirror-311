...
if TYPE_CHECKING:
    from ..models.constituent_inactivity_reason_codes_list_summary import (
        ConstituentInactivityReasonCodesListSummary,
    )


T = TypeVar("T", bound="ConstituentInactivityReasonCodesListCollection")


@_attrs_define
class ConstituentInactivityReasonCodesListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentInactivityReasonCodesListSummary']]): The set of items included in the
    ...
    value: Union[Unset, List["ConstituentInactivityReasonCodesListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentInactivityReasonCodesListSummary.from_dict(value_item_data)
        ...
        constituent_inactivity_reason_codes_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_inactivity_reason_codes_list_collection
