...
T = TypeVar("T", bound="NewOrganizationValidationCountries")


@_attrs_define
class NewOrganizationValidationCountries:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_organization_validation_countries = cls(
            country_id=country_id,
            browsable=browsable,
        )

        new_organization_validation_countries.additional_properties = d
        return new_organization_validation_countries
