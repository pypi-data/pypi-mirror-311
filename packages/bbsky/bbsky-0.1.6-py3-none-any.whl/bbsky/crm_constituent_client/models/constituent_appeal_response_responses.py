...
T = TypeVar("T", bound="ConstituentAppealResponseResponses")


@_attrs_define
class ConstituentAppealResponseResponses:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        constituent_appeal_response_responses = cls(
            response_category=response_category,
            response=response,
            date=date,
            code=code,
        ...
        constituent_appeal_response_responses.additional_properties = d
        return constituent_appeal_response_responses
