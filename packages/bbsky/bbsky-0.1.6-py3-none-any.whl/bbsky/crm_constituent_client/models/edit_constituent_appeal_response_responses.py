...
T = TypeVar("T", bound="EditConstituentAppealResponseResponses")


@_attrs_define
class EditConstituentAppealResponseResponses:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_constituent_appeal_response_responses = cls(
            response_category=response_category,
            response=response,
            date=date,
            code=code,
        ...
        edit_constituent_appeal_response_responses.additional_properties = d
        return edit_constituent_appeal_response_responses
