...
if TYPE_CHECKING:
    ...
    from ..models.new_constituent_phone_country_codes import NewConstituentPhoneCountryCodes


T = TypeVar("T", bound="NewConstituentPhone")


@_attrs_define
class NewConstituentPhone:
    """CreateConstituentPhone.

    Example:
        {'constituent_id': '', 'phone_type': '', 'number': '', 'primary': False, 'do_not_call': False, 'spouse_name':
            '', 'update_matching_spouse_phone': False, 'household': False, 'household_member': False,
            'update_matching_household_phone': False, 'start_time': '', 'end_time': '', 'info_source': '',
            'info_source_comments': '', 'country': '', 'seasonal_start_date': '', 'seasonal_end_date': '', 'start_date': '',
            'do_not_call_reason': '', 'confidential': False, 'country_codes': [{'country_id': '', 'country_code': ''}],
            'constituent_data_review_rollback_reason': '', 'forced_primary': False, 'can_edit_primary': False,
            'invalid_fields': '', 'origin': 'User', 'donottext': False}
    ...
    Attributes:
        ...
        update_matching_household_phone (Union[Unset, bool]): Indicates whether copy phone information to household
            members.
        ...
        country_codes (Union[Unset, List['NewConstituentPhoneCountryCodes']]): Country codes.
    ...
    country_codes: Union[Unset, List["NewConstituentPhoneCountryCodes"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for country_codes_item_data in _country_codes or []:
            country_codes_item = NewConstituentPhoneCountryCodes.from_dict(country_codes_item_data)
