...
if TYPE_CHECKING:
    from ..models.constituent_contact_list_summary import ConstituentContactListSummary


T = TypeVar("T", bound="ConstituentContactListCollection")


@_attrs_define
class ConstituentContactListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentContactListSummary']]): The set of items included in the response. This may
    ...
    value: Union[Unset, List["ConstituentContactListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentContactListSummary.from_dict(value_item_data)
        ...
        constituent_contact_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_contact_list_collection
