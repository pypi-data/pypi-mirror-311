...
if TYPE_CHECKING:
    from ..models.constituent_phone_list_summary import ConstituentPhoneListSummary


T = TypeVar("T", bound="ConstituentPhoneListCollection")


@_attrs_define
class ConstituentPhoneListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentPhoneListSummary']]): The set of items included in the response. This may
    ...
    value: Union[Unset, List["ConstituentPhoneListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentPhoneListSummary.from_dict(value_item_data)
        ...
        constituent_phone_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_phone_list_collection
