...
T = TypeVar("T", bound="EditRelationshipJobInfo")


@_attrs_define
class EditRelationshipJobInfo:
    """EditRelationshipJobInfo.

    Example:
        {'job_title': 'Dietician', 'career_level': 'executive', 'job_category': '', 'start_date':
            '2022-12-15T12:00:00.0000000+00:00', 'end_date': '2026-12-25T12:00:00.0000000+00:00', 'job_department': '',
            'job_division': '', 'job_schedule': {}, 'job_responsibility': '', 'private_record': 'false',
            'sync_end_date_to_relationship': 'true', 'last_job': 'true'}
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_relationship_job_info = cls(
            job_title=job_title,
        ...
        return edit_relationship_job_info
