...
T = TypeVar("T", bound="NewOrganizationZipLookupCountries")


@_attrs_define
class NewOrganizationZipLookupCountries:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_organization_zip_lookup_countries = cls(
            country_id=country_id,
            country_name=country_name,
        )

        new_organization_zip_lookup_countries.additional_properties = d
        return new_organization_zip_lookup_countries
