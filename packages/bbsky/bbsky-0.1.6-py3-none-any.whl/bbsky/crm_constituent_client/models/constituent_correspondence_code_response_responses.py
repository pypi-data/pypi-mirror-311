...
T = TypeVar("T", bound="ConstituentCorrespondenceCodeResponseResponses")


@_attrs_define
class ConstituentCorrespondenceCodeResponseResponses:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        constituent_correspondence_code_response_responses = cls(
            response_category=response_category,
            response=response,
            date=date,
            code=code,
        ...
        constituent_correspondence_code_response_responses.additional_properties = d
        return constituent_correspondence_code_response_responses
