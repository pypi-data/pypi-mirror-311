...
if TYPE_CHECKING:
    from ..models.state_list_summary import StateListSummary


T = TypeVar("T", bound="StateListCollection")


@_attrs_define
class StateListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['StateListSummary']]): The set of items included in the response. This may be a subset
    ...
    value: Union[Unset, List["StateListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = StateListSummary.from_dict(value_item_data)
