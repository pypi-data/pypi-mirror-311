...
T = TypeVar("T", bound="NewConstituentPhoneCountryCodes")


@_attrs_define
class NewConstituentPhoneCountryCodes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_constituent_phone_country_codes = cls(
            country_id=country_id,
            country_code=country_code,
        )

        new_constituent_phone_country_codes.additional_properties = d
        return new_constituent_phone_country_codes
