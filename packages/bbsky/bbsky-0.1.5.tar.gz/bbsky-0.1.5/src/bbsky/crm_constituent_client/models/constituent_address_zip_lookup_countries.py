...
T = TypeVar("T", bound="ConstituentAddressZipLookupCountries")


@_attrs_define
class ConstituentAddressZipLookupCountries:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        constituent_address_zip_lookup_countries = cls(
            country_id=country_id,
            country_name=country_name,
        )

        constituent_address_zip_lookup_countries.additional_properties = d
        return constituent_address_zip_lookup_countries
