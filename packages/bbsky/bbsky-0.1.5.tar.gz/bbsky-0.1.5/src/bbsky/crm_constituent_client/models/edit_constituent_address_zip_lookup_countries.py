...
T = TypeVar("T", bound="EditConstituentAddressZipLookupCountries")


@_attrs_define
class EditConstituentAddressZipLookupCountries:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_constituent_address_zip_lookup_countries = cls(
            country_id=country_id,
            country_name=country_name,
        )

        edit_constituent_address_zip_lookup_countries.additional_properties = d
        return edit_constituent_address_zip_lookup_countries
