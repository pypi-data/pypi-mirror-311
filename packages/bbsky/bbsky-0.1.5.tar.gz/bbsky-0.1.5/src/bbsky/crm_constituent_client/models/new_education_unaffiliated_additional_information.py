...
T = TypeVar("T", bound="NewEducationUnaffiliatedAdditionalInformation")


@_attrs_define
class NewEducationUnaffiliatedAdditionalInformation:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_education_unaffiliated_additional_information = cls(
            id=id,
        ...
        new_education_unaffiliated_additional_information.additional_properties = d
        return new_education_unaffiliated_additional_information
