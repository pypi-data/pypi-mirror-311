...
T = TypeVar("T", bound="EditConstituentFundraiser")


@_attrs_define
class EditConstituentFundraiser:
    """EditConstituentFundraiser.

    Example:
        {'date_from': '2021-11-28T12:00:00.0000000+00:00', 'date_to': '2022-12-28T12:00:00.0000000+00:00'}
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_constituent_fundraiser = cls(
            date_from=date_from,
            date_to=date_to,
        )

        return edit_constituent_fundraiser
