...
if TYPE_CHECKING:
    from ..models.edit_constituent_phone_country_codes import EditConstituentPhoneCountryCodes
    from ..models.edit_constituent_phone_matching_household_members import (
...
T = TypeVar("T", bound="EditConstituentPhone")


@_attrs_define
class EditConstituentPhone:
    """EditConstituentPhone.

    Example:
        {'phone_type': 'Business', 'number': '8439195648', 'primary': True, 'do_not_call': False, 'spouse_name': '',
            'spouse_has_matching_phone': False, 'update_matching_spouse_phone': False, 'household': False,
            'household_member': False, 'update_matching_household_phone': False, 'matching_household_members': [],
            'start_time': {'hour': 3, 'minute': 30}, 'end_time': {'hour': 5, 'minute': 30}, 'info_source': '',
            'info_source_comments': '', 'country': '', 'seasonal_start_date': {'month': 3, 'day': 21}, 'seasonal_end_date':
            {'month': 3, 'day': 21}, 'start_date': '', 'end_date': '', 'do_not_call_reason': '', 'confidential': False,
            'country_codes': [{'countryid': '', 'countrycode': ''}], 'constituent_data_review_rollback_reason': '',
            'forced_primary': False, 'can_edit_primary': False, 'invalid_fields': '', 'origin_code': 'User'}
    ...
    Attributes:
        ...
        number (Union[Unset, str]): The number.
        ...
        update_matching_household_phone (Union[Unset, bool]): Indicates whether update matching phone numbers in
            household.
        matching_household_members (Union[Unset, List['EditConstituentPhoneMatchingHouseholdMembers']]): Matching
            household members.
        ...
        country_codes (Union[Unset, List['EditConstituentPhoneCountryCodes']]): Country codes.
    ...
    matching_household_members: Union[Unset, List["EditConstituentPhoneMatchingHouseholdMembers"]] = UNSET
    ...
    country_codes: Union[Unset, List["EditConstituentPhoneCountryCodes"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for matching_household_members_item_data in _matching_household_members or []:
            matching_household_members_item = EditConstituentPhoneMatchingHouseholdMembers.from_dict(
        ...
        for country_codes_item_data in _country_codes or []:
            country_codes_item = EditConstituentPhoneCountryCodes.from_dict(country_codes_item_data)
