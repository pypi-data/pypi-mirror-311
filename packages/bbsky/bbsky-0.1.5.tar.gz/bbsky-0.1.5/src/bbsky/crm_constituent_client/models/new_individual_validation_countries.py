...
T = TypeVar("T", bound="NewIndividualValidationCountries")


@_attrs_define
class NewIndividualValidationCountries:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_individual_validation_countries = cls(
            country_id=country_id,
            browsable=browsable,
        )

        new_individual_validation_countries.additional_properties = d
        return new_individual_validation_countries
