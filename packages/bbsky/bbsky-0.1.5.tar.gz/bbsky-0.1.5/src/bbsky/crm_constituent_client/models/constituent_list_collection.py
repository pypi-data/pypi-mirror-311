...
if TYPE_CHECKING:
    from ..models.constituent_list_summary import ConstituentListSummary


T = TypeVar("T", bound="ConstituentListCollection")


@_attrs_define
class ConstituentListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentListSummary']]): The set of items included in the response. This may be a
    ...
    value: Union[Unset, List["ConstituentListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentListSummary.from_dict(value_item_data)
        ...
        constituent_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_list_collection
