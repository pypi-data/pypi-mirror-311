...
T = TypeVar("T", bound="EditConstituentEmailAddressMatchingHouseholdMembers")


@_attrs_define
class EditConstituentEmailAddressMatchingHouseholdMembers:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_constituent_email_address_matching_household_members = cls(
            constituent_id=constituent_id,
            name=name,
            relationship_to_primary=relationship_to_primary,
        )

        edit_constituent_email_address_matching_household_members.additional_properties = d
        return edit_constituent_email_address_matching_household_members
