...
from ...models.constituent_phone_list_collection import ConstituentPhoneListCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/constituents/{constituent_id}/phones",
        "params": params,
    }
...
) -> Optional[Union[Any, ConstituentPhoneListCollection, ProblemDetails]]:
    if response.status_code == 200:
        response_200 = ConstituentPhoneListCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ConstituentPhoneListCollection, ProblemDetails]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List constituent phones.
     ...
     This operation returns all phone numbers for a constituent.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ConstituentPhoneListCollection, ProblemDetails]
    """
