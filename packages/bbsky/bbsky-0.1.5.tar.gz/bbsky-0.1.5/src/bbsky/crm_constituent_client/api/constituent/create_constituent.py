...
from ...models.new_constituent import NewConstituent
...
def sync_detailed(
    *,
    ...
    Args:
        body (NewConstituent): CreateConstituent Example: {'last_name': '', 'first_name': '',
            'middle_name': '', 'title': '', 'suffix': '', 'nick_name': '', 'maiden_name': '',
