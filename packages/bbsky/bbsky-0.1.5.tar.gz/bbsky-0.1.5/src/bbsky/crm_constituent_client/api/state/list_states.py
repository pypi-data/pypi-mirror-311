...
from ...models.state_list_collection import StateListCollection
...
) -> Optional[Union[Any, ProblemDetails, StateListCollection]]:
    if response.status_code == 200:
        response_200 = StateListCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ProblemDetails, StateListCollection]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ProblemDetails, StateListCollection]
    """
