...
from ...models.new_constituent_appeal import NewConstituentAppeal
...
def _get_kwargs(
    *,
    body: NewConstituentAppeal,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/constituentappeals",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (NewConstituentAppeal): CreateConstituentAppeal Example: {'constituent_id': '',
            'appeal_id': '', 'mkt_segmentation': '', 'date_sent': '', 'mkt_package_id': '',
