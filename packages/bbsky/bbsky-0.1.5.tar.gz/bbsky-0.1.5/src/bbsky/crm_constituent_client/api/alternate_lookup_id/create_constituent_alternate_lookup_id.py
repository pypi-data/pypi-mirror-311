...
from ...models.new_constituent_alternate_lookup_id import NewConstituentAlternateLookupId
...
def _get_kwargs(
    *,
    body: NewConstituentAlternateLookupId,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/alternatelookupids",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (NewConstituentAlternateLookupId): CreateConstituentAlternateLookupId Example:
