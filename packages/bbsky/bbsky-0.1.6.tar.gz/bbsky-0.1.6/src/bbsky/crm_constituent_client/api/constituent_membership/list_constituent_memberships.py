...
from ...models.constituent_memberships_list_collection import ConstituentMembershipsListCollection
from ...models.list_constituent_memberships_site_filter_mode import ListConstituentMembershipsSiteFilterMode
...
def _get_kwargs(
    constituent_id: str,
    *,
    site_filter_mode: Union[Unset, ListConstituentMembershipsSiteFilterMode] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/constituent/{constituent_id}/constituentmemberships",
        "params": params,
    }
...
) -> Optional[Union[Any, ConstituentMembershipsListCollection, ProblemDetails]]:
    if response.status_code == 200:
        response_200 = ConstituentMembershipsListCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ConstituentMembershipsListCollection, ProblemDetails]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        constituent_id (str):
        site_filter_mode (Union[Unset, ListConstituentMembershipsSiteFilterMode]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ConstituentMembershipsListCollection, ProblemDetails]
    """
