...
from ...models.constituent_alternate_lookup_id_list_collection import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/constituents/{constituent_id}/alternatelookupids",
        "params": params,
    }
...
) -> Optional[Union[Any, ConstituentAlternateLookupIdListCollection, ProblemDetails]]:
    if response.status_code == 200:
        response_200 = ConstituentAlternateLookupIdListCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ConstituentAlternateLookupIdListCollection, ProblemDetails]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List constituent alternate lookup ids.
     ...
     This operation returns all alternate lookup ids for a constituent.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ConstituentAlternateLookupIdListCollection, ProblemDetails]
    """
