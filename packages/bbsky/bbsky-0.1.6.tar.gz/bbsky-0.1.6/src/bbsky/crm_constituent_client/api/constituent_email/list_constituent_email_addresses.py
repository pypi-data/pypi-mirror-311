...
from ...models.constituent_email_address_list_collection import ConstituentEmailAddressListCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/constituents/{constituent_id}/emailaddresses",
        "params": params,
    }
...
) -> Optional[Union[Any, ConstituentEmailAddressListCollection, ProblemDetails]]:
    if response.status_code == 200:
        response_200 = ConstituentEmailAddressListCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ConstituentEmailAddressListCollection, ProblemDetails]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List constituent email addresses.
     ...
     This operation returns all email addresses for a constituent.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ConstituentEmailAddressListCollection, ProblemDetails]
    """
