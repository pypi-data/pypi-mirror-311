...
if TYPE_CHECKING:
    from ..models.constituent_fundraiser_list_summary import ConstituentFundraiserListSummary


T = TypeVar("T", bound="ConstituentFundraiserListCollection")


@_attrs_define
class ConstituentFundraiserListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentFundraiserListSummary']]): The set of items included in the response. This
    ...
    value: Union[Unset, List["ConstituentFundraiserListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentFundraiserListSummary.from_dict(value_item_data)
        ...
        constituent_fundraiser_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_fundraiser_list_collection
