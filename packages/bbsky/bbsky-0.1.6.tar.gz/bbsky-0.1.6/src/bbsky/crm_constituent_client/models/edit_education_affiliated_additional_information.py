...
T = TypeVar("T", bound="EditEducationAffiliatedAdditionalInformation")


@_attrs_define
class EditEducationAffiliatedAdditionalInformation:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_education_affiliated_additional_information = cls(
            id=id,
        ...
        edit_education_affiliated_additional_information.additional_properties = d
        return edit_education_affiliated_additional_information
