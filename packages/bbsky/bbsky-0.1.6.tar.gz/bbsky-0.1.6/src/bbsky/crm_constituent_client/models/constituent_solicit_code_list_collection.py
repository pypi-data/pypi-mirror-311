...
if TYPE_CHECKING:
    from ..models.constituent_solicit_code_list_summary import ConstituentSolicitCodeListSummary


T = TypeVar("T", bound="ConstituentSolicitCodeListCollection")


@_attrs_define
class ConstituentSolicitCodeListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentSolicitCodeListSummary']]): The set of items included in the response. This
    ...
    value: Union[Unset, List["ConstituentSolicitCodeListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentSolicitCodeListSummary.from_dict(value_item_data)
        ...
        constituent_solicit_code_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_solicit_code_list_collection
