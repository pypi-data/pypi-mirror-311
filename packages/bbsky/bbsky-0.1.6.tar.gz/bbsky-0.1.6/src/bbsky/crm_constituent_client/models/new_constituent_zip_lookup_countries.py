...
T = TypeVar("T", bound="NewConstituentZipLookupCountries")


@_attrs_define
class NewConstituentZipLookupCountries:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_constituent_zip_lookup_countries = cls(
            country_id=country_id,
            country_name=country_name,
        )

        new_constituent_zip_lookup_countries.additional_properties = d
        return new_constituent_zip_lookup_countries
