...
T = TypeVar("T", bound="NewConstituentAddressValidationCountries")


@_attrs_define
class NewConstituentAddressValidationCountries:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_constituent_address_validation_countries = cls(
            country_id=country_id,
            browsable=browsable,
        )

        new_constituent_address_validation_countries.additional_properties = d
        return new_constituent_address_validation_countries
