...
T = TypeVar("T", bound="ConstituentPhoneCountryCodes")


@_attrs_define
class ConstituentPhoneCountryCodes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        constituent_phone_country_codes = cls(
            country_id=country_id,
            country_code=country_code,
        )

        constituent_phone_country_codes.additional_properties = d
        return constituent_phone_country_codes
