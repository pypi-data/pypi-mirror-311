...
T = TypeVar("T", bound="NewRelationshipJobInfo")


@_attrs_define
class NewRelationshipJobInfo:
    """CreateRelationshipJobInfo.

    Example:
        {'context_id': '', 'relationship': '', 'job_title': '', 'career_level': '', 'job_category': '', 'start_date':
            '', 'end_date': '', 'job_department': '', 'job_division': '', 'job_schedule': '', 'job_responsibility': '',
            'private_record': False, 'sync_end_date_to_relationship': False}

    Attributes:
        context_id (str): The context ID.
        relationship (str): The relationship. This simple list can be queried at https://api.sky.blackbaud.com/crm-
            adnmg/simplelists/62083cb6-2a32-4d1d-aace-0ad288292ab7?parameters=constituentid,{context_id}.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return new_relationship_job_info
