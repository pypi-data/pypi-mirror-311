...
T = TypeVar("T", bound="NewEducationAffiliateDadditionalInformation")


@_attrs_define
class NewEducationAffiliateDadditionalInformation:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_education_affiliate_dadditional_information = cls(
            id=id,
        ...
        new_education_affiliate_dadditional_information.additional_properties = d
        return new_education_affiliate_dadditional_information
