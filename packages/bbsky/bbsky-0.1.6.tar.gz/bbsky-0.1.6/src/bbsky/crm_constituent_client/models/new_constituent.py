...
if TYPE_CHECKING:
    ...
    from ..models.new_constituent_validation_countries import NewConstituentValidationCountries
    from ..models.new_constituent_zip_lookup_countries import NewConstituentZipLookupCountries


T = TypeVar("T", bound="NewConstituent")


@_attrs_define
class NewConstituent:
    """CreateConstituent.

    Example:
        {'last_name': '', 'first_name': '', 'middle_name': '', 'title': '', 'suffix': '', 'nick_name': '',
            'maiden_name': '', 'birth_date': '', 'gender': 'Unknown', 'marital_status': '', 'address_type': '',
            'address_country': '', 'address_block': '', 'address_city': '', 'address_state': '', 'address_post_code': '',
            'address_do_not_mail': False, 'address_do_not_mail_reason': '', 'phone_type': '', 'phone_number': '',
            'email_address_type': '', 'email_address': '', 'skip_adding_security_groups': False, 'existing_spouse': False,
            'spouse_id': '', 'spouse_last_name': '', 'spouse_first_name': '', 'spouse_middle_name': '', 'spouse_title': '',
            'spouse_suffix': '', 'spouse_nick_name': '', 'spouse_maiden_name': '', 'spouse_birth_date': '', 'spouse_gender':
            'Unknown', 'spouse_relationship_type_code': '', 'spouse_reciprocal_type_code': '', 'spouse_start_date': '',
    ...
    Attributes:
        ...
        nick_name (Union[Unset, str]): The the constituent's nickname. character limit: 50..
        ...
        validation_countries (Union[Unset, List['NewConstituentValidationCountries']]): Validation countries.
        zip_lookup_countries (Union[Unset, List['NewConstituentZipLookupCountries']]): Zip lookup countries.
    ...
    validation_countries: Union[Unset, List["NewConstituentValidationCountries"]] = UNSET
    zip_lookup_countries: Union[Unset, List["NewConstituentZipLookupCountries"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for validation_countries_item_data in _validation_countries or []:
            validation_countries_item = NewConstituentValidationCountries.from_dict(validation_countries_item_data)
        ...
        for zip_lookup_countries_item_data in _zip_lookup_countries or []:
            zip_lookup_countries_item = NewConstituentZipLookupCountries.from_dict(zip_lookup_countries_item_data)
