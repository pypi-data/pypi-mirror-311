...
if TYPE_CHECKING:
    from ..models.constituent_email_address_list_summary import ConstituentEmailAddressListSummary


T = TypeVar("T", bound="ConstituentEmailAddressListCollection")


@_attrs_define
class ConstituentEmailAddressListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentEmailAddressListSummary']]): The set of items included in the response.
    ...
    value: Union[Unset, List["ConstituentEmailAddressListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentEmailAddressListSummary.from_dict(value_item_data)
        ...
        constituent_email_address_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_email_address_list_collection
