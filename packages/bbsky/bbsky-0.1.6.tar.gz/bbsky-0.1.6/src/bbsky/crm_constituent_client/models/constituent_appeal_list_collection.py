...
if TYPE_CHECKING:
    from ..models.constituent_appeal_list_summary import ConstituentAppealListSummary


T = TypeVar("T", bound="ConstituentAppealListCollection")


@_attrs_define
class ConstituentAppealListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentAppealListSummary']]): The set of items included in the response. This may
    ...
    value: Union[Unset, List["ConstituentAppealListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentAppealListSummary.from_dict(value_item_data)
        ...
        constituent_appeal_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_appeal_list_collection
