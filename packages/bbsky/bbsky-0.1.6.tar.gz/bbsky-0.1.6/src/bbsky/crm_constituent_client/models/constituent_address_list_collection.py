...
if TYPE_CHECKING:
    from ..models.constituent_address_list_summary import ConstituentAddressListSummary


T = TypeVar("T", bound="ConstituentAddressListCollection")


@_attrs_define
class ConstituentAddressListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentAddressListSummary']]): The set of items included in the response. This may
            be a subset of the items in the collection.
    ...
    value: Union[Unset, List["ConstituentAddressListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentAddressListSummary.from_dict(value_item_data)
        ...
        constituent_address_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_address_list_collection
