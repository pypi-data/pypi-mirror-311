...
T = TypeVar("T", bound="ConstituentAddressMatchingHouseholdMembers")


@_attrs_define
class ConstituentAddressMatchingHouseholdMembers:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        constituent_address_matching_household_members = cls(
            constituent_id=constituent_id,
            name=name,
            relationship_to_primary=relationship_to_primary,
        )

        constituent_address_matching_household_members.additional_properties = d
        return constituent_address_matching_household_members
