...
T = TypeVar("T", bound="NewConstituentSolicitCode")


@_attrs_define
class NewConstituentSolicitCode:
    """CreateConstituentSolicitCode.

    Example:
        {'constituent_id': '17818cc6-b622-4b30-8d2a-098c5ba4bd0b', 'solicit_code': 'Do not mail', 'start_date': '',
            'end_date': '', 'comments': '', 'consent_preference': 'No response', 'source_evidence': '', 'source_file': '',
            'privacy_policy': '', 'supporting_information': '', 'consent_statement': ''}

    Attributes:
        constituent_id (str): The constituent ID.
        solicit_code (str): The solicit code. This simple list can be queried at https://api.sky.blackbaud.com/crm-
            adnmg/simplelists/ea7286bd-d27b-4028-b507-4bdb92580499?parameters=feature_id,{b6a5f4eb-
            adf7-4fa4-a3e0-8cd96e58d8c2}&parameters=feature_type,{1}.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_constituent_solicit_code = cls(
            constituent_id=constituent_id,
            solicit_code=solicit_code,
        ...
        return new_constituent_solicit_code
