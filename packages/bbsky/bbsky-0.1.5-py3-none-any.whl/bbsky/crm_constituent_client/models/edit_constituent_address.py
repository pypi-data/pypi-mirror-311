...
if TYPE_CHECKING:
    from ..models.edit_constituent_address_matching_household_members import (
        EditConstituentAddressMatchingHouseholdMembers,
    )
    from ..models.edit_constituent_address_validation_countries import (
        EditConstituentAddressValidationCountries,
    )
    from ..models.edit_constituent_address_zip_lookup_countries import (
...
T = TypeVar("T", bound="EditConstituentAddress")


@_attrs_define
class EditConstituentAddress:
    """EditConstituentAddress.

    Example:
        {'address_type': '', 'address_block': '', 'city': '', 'state_': '', 'postcode': '', 'country_': '', 'cart': '',
            'dpc': '', 'lot': '', 'start_date': {'year': 2014, 'month': 4, 'day': 13}, 'end_date': {'year': 2024, 'month':
            4, 'day': 13}, 'primary': False, 'do_not_mail': False, 'omit_from_validation': False, 'county': '',
            'congressional_district': '', 'state_house_district': '', 'state_senate_district': '', 'local_precinct': '',
            'info_source': '', 'region': '', 'last_validation_attempt_date': '2019-11-04T10:04:00.0000000+00:00',
            'validation_message': '', 'certification_data': 0, 'ncoa_last_submit_date': '2019-11-04T10:04:00.0000000+00:00',
            'ncoa_return': '', 'ncoa_footnote': '', 'ncoa_dpv_footnote': '', 'ncoa_move_date': {'year': 2024, 'month': 4,
            'day': 13}, 'ncoa_dma_suppression': False, 'ncoa_mail_grade': '', 'zip_lookup_countries': [{'country_id': '',
            'country_name': ''}], 'validation_countries': [{'country_id': '', 'browsable': False}], 'update_contacts':
            False, 'has_contacts': False, 'do_not_mail_reason': '', 'household': False, 'household_member': False,
            'update_matching_household_addresses': False, 'matching_household_members': [{'constituent_id': '', 'name': '',
            'relationship_to_primary': ''}], 'historical_start_date': '2014-11-04T10:04:00.0000000+00:00',
            'historical_end_date': '2024-11-04T10:04:00.0000000+00:00', 'date_added': '2014-11-04T11:04:00.0000000+00:00',
            'info_source_comments': '', 'confidential': False, 'constituent_data_review_rollback_reason': '',
            'forced_primary': False, 'can_edit_primary': False, 'invalid_fields': '', 'origin': 'User'}
    ...
    Attributes:
        ...
        zip_lookup_countries (Union[Unset, List['EditConstituentAddressZipLookupCountries']]): Zip lookup countries.
        validation_countries (Union[Unset, List['EditConstituentAddressValidationCountries']]): Validation countries.
        ...
        update_matching_household_addresses (Union[Unset, bool]): Indicates whether update matching addresses in
            household.
        matching_household_members (Union[Unset, List['EditConstituentAddressMatchingHouseholdMembers']]): Matching
            household members.
    ...
    zip_lookup_countries: Union[Unset, List["EditConstituentAddressZipLookupCountries"]] = UNSET
    validation_countries: Union[Unset, List["EditConstituentAddressValidationCountries"]] = UNSET
    ...
    matching_household_members: Union[Unset, List["EditConstituentAddressMatchingHouseholdMembers"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for zip_lookup_countries_item_data in _zip_lookup_countries or []:
            zip_lookup_countries_item = EditConstituentAddressZipLookupCountries.from_dict(
        ...
        for validation_countries_item_data in _validation_countries or []:
            validation_countries_item = EditConstituentAddressValidationCountries.from_dict(
        ...
        for matching_household_members_item_data in _matching_household_members or []:
            matching_household_members_item = EditConstituentAddressMatchingHouseholdMembers.from_dict(
        ...
        return edit_constituent_address
