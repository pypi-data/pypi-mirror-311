...
if TYPE_CHECKING:
    from ..models.constituent_attribute_list_summary import ConstituentAttributeListSummary


T = TypeVar("T", bound="ConstituentAttributeListCollection")


@_attrs_define
class ConstituentAttributeListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentAttributeListSummary']]): The set of items included in the response. This
    ...
    value: Union[Unset, List["ConstituentAttributeListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentAttributeListSummary.from_dict(value_item_data)
        ...
        constituent_attribute_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_attribute_list_collection
