...
if TYPE_CHECKING:
    from ..models.constituent_email_address_matching_household_members import (
        ConstituentEmailAddressMatchingHouseholdMembers,
    )


T = TypeVar("T", bound="ConstituentEmailAddress")


@_attrs_define
class ConstituentEmailAddress:
    ...
    Attributes:
        ...
        update_matching_household_email_address (Union[Unset, bool]): Indicates whether update matching email addresses
            in household.
        matching_household_members (Union[Unset, List['ConstituentEmailAddressMatchingHouseholdMembers']]): Matching
            household members.
    ...
    matching_household_members: Union[Unset, List["ConstituentEmailAddressMatchingHouseholdMembers"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for matching_household_members_item_data in _matching_household_members or []:
            matching_household_members_item = ConstituentEmailAddressMatchingHouseholdMembers.from_dict(
        ...
        return constituent_email_address
