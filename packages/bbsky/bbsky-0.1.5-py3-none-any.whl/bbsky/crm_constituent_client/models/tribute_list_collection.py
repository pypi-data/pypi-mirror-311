...
if TYPE_CHECKING:
    from ..models.tribute_list_summary import TributeListSummary


T = TypeVar("T", bound="TributeListCollection")


@_attrs_define
class TributeListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['TributeListSummary']]): The set of items included in the response. This may be a
    ...
    value: Union[Unset, List["TributeListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = TributeListSummary.from_dict(value_item_data)
        ...
        return tribute_list_collection
