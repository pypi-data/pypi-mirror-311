...
if TYPE_CHECKING:
    from ..models.constituent_memberships_list_summary import ConstituentMembershipsListSummary


T = TypeVar("T", bound="ConstituentMembershipsListCollection")


@_attrs_define
class ConstituentMembershipsListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['ConstituentMembershipsListSummary']]): The set of items included in the response. This
    ...
    value: Union[Unset, List["ConstituentMembershipsListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = ConstituentMembershipsListSummary.from_dict(value_item_data)
        ...
        constituent_memberships_list_collection = cls(
            count=count,
            value=value,
        ...
        return constituent_memberships_list_collection
