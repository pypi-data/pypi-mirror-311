...
if TYPE_CHECKING:
    from ..models.education_list_summary import EducationListSummary


T = TypeVar("T", bound="EducationListCollection")


@_attrs_define
class EducationListCollection:
    ...
    Attributes:
        count (Union[Unset, int]): The number of items available for retrieval into the collection after applying any
            request parameters.
        value (Union[Unset, List['EducationListSummary']]): The set of items included in the response. This may be a
    ...
    value: Union[Unset, List["EducationListSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = EducationListSummary.from_dict(value_item_data)
        ...
        return education_list_collection
