...
T = TypeVar("T", bound="ConstituentSolicitCode")


@_attrs_define
class ConstituentSolicitCode:
    """GetConstituentSolicitCode.

    Attributes:
        solicit_code (str): The solicit code. This simple list can be queried at https://api.sky.blackbaud.com/crm-adnmg
            /simplelists/ea7286bd-d27b-4028-b507-4bdb92580499?parameters=feature_id,{c5b90f15-b76b-48e3-bf4f-
            b55c8717d36e}&parameters=feature_type,{1}.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return constituent_solicit_code
