...
T = TypeVar("T", bound="EditConstituentAddressValidationCountries")


@_attrs_define
class EditConstituentAddressValidationCountries:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_constituent_address_validation_countries = cls(
            country_id=country_id,
            browsable=browsable,
        )

        edit_constituent_address_validation_countries.additional_properties = d
        return edit_constituent_address_validation_countries
