...
from ...models.education_list_collection import EducationListCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/constituents/{constituent_id}/educationalhistories",
        "params": params,
    }
...
) -> Optional[Union[Any, EducationListCollection, ProblemDetails]]:
    if response.status_code == 200:
        response_200 = EducationListCollection.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, EducationListCollection, ProblemDetails]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List educations.
     ...
     This operation returns the education history for a constituent.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, EducationListCollection, ProblemDetails]
    """
