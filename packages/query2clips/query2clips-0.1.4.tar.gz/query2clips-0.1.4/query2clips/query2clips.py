...
class Query2Clips:
    ...
    def query_to_video_urls(self, query: str, search_limit: int, search_offset: int):
        ...
        dump_path = os.path.join(self.output_dir, f"urls.csv")
