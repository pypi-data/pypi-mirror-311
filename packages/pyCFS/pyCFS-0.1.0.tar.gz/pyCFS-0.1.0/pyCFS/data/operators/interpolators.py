...
from pyCFS.data.io import cfs_types, CFSResultArray
...
def interpolation_matrix_nearest_neighbor(
    ...
    if formulation == "forward":
        return _interpolation_matrix_nearest_neighbor_forward(
            source_coord, target_coord, num_neighbors, interpolation_exp, max_distance, workers
        )
...
def interpolate_nearest_neighbor(
    ...
    >>> result_data_write = interpolate_region_nearest_neighbor(
    >>>     mesh_src=src_mesh,
    >>>     data_src=src_data,
