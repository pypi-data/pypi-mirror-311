...
class CFSWriter:
    ...
    def create_file(self, mesh_data: CFSMeshData | None = None, result_data: CFSResultData | None = None):
        ...
        if mesh_data is not None:
            ...
            if result_data is not None:
                ...
                self.write_multistep(result_data=result_data)
    ...
    def get_create_multistep(
        ...
        if f"MultiStep_{multi_step_id}" in grp_result_child:
            ...
            grp_result_description = grp_result_child["ResultDescription"]
        else:
    ...
    def write_history_multistep(
        self, result_data: CFSResultData, multi_step_id=1, analysis_type=cfs_analysis_type.NO_ANALYSIS
    ):
