...
from pyCFS.data.io.cfs_types import cfs_result_type, cfs_analysis_type, cfs_history_types, cfs_result_definition
...
class CFSResultData:
    ...
    def add_data_array(
        ...
        *,
        ...
        data : np.ndarray | CFSResultArray
            data to be added. Supported shapes: (n, m, d) or (n,m)
    ...
    def add_data(
        ...
        *,
        ...
        if cfs_history_types[restype] == cfs_result_definition.HISTORY:
