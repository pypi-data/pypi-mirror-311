...
class ListDataGrantsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dataexchange/paginators/#listdatagrantspaginator)
    """
    def paginate(
...
class ListDataSetRevisionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dataexchange/paginators/#listdatasetrevisionspaginator)
    """
    def paginate(
...
class ListDataSetsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dataexchange/paginators/#listdatasetspaginator)
    """
    def paginate(
...
class ListEventActionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dataexchange/paginators/#listeventactionspaginator)
    """
    def paginate(
...
class ListJobsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dataexchange/paginators/#listjobspaginator)
    """
    def paginate(
...
class ListReceivedDataGrantsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dataexchange/paginators/#listreceiveddatagrantspaginator)
    """
    def paginate(
...
class ListRevisionAssetsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dataexchange/paginators/#listrevisionassetspaginator)
    """
    def paginate(
