...
AdagradW.__doc__ = r"""Implements AdagradW algorithm.
...
def adagradw(
    ...
    *,
    ...
    r"""Functional API that performs AdagradW algorithm computation.

    See :class:`~adagradw.AdagradW` for details.
    """
    ...
    if foreach and not torch.jit.is_scripting():
        func = _multi_tensor_adagradw
    else:
        func = _single_tensor_adagradw
    ...
    *,
    ...
    for ((device_params, device_grads, device_state_sums, device_state_steps), _) in grouped_tensorlists.values():
        ...
        if device_has_sparse_grad:
            return _single_tensor_adagradw(
                device_params,
                device_grads,
                device_state_sums,
                device_state_steps,
