...
class GMResSolver(LinearSolver):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('innerproduct', 'iterations', 'restart', 'norm')
...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('display', 'iterations', 'residuals', 'maxiter', 'callback', 'ax', 'sol', 'plotrates', 'ress', 'printrates', 'pre', 'plt', 'mat', 'tol', 'clear_output', 'its', 'callback_sol', '_final_residual', 'atol', 'fig')
