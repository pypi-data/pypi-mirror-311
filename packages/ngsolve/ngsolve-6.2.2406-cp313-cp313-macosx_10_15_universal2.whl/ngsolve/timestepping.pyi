...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_cls', 'bfmstar', '_lin_solver_args', 'c', 'time', 'gfu_old', 'dt')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_cls', 'bfmstar', 'gfv_old', '_lin_solver_args', 'gfa_old', 'c', 'time', 'gfu_old', 'dt')
