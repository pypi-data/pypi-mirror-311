...
import pathlib
import datetime
from typing import Any, Dict, Callable, ClassVar, Iterator, overload, Literal, TypeAlias
...
class SensingState(EnvironmentState):
    ...
    def init_buffer(self, key: str, description: BufferDescription | None = ..., data: numpy.ndarray = ...) -> Buffer: ...
