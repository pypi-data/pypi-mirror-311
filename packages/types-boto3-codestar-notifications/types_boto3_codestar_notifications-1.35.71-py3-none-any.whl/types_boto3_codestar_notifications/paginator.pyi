...
class ListEventTypesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codestar_notifications/paginators/#listeventtypespaginator)
    """
    def paginate(
...
class ListNotificationRulesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codestar_notifications/paginators/#listnotificationrulespaginator)
    """
    def paginate(
...
class ListTargetsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codestar_notifications/paginators/#listtargetspaginator)
    """
    def paginate(
