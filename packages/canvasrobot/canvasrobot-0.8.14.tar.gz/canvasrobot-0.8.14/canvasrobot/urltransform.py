...
from .commandline import create_db_folder
...
@click.command()
@click.option("--dryrun", default=True, help="If True only show possible result.")
@click.option("--testing", default=False, help="If True test.")
@click.option("--db_no_update", default=True, help="If True never database update.")
@click.option("--db_force_update", default=False, help="If True force db update.")
@click.option("--stop_after", default=1, help="Stop after this many courses.")
def run(dryrun, testing, db_no_update, db_force_update, stop_after):
    tr = UrlTransformationRobot(db_no_update=db_no_update,
                                db_force_update=db_force_update)  # default location db: folder 'databases'
