...
# -----------------------------
@router.bloomerp_route(
    path='send-emails', # path will become /employees/{pk}/send-emails & /customers/{pk}/send-emails
    name='Send Email',
    description='Send email to object of {model} model',
    route_type='detail',
    url_name='send_email', # url name will become employees_detail_send_email & customers_detail_send_email
