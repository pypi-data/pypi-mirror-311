...
class PluginUploader:
  ...
  AS 'PARSE_JSON($${json_string}$$)::object';"""
    ...
    def upload_plugin(
        ...
        if len([w for w in anaconda_packages if "snowflake-snowpark-python" in w]) == 0:
        ...
        # remove snowflake-connector-python if it's found its way into the other packages
        other_package_names = [
