...
class ListDataIntegrationFlowsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_supplychain/paginators/#listdataintegrationflowspaginator)
    """
    def paginate(
        self,
...
class ListDataLakeDatasetsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_supplychain/paginators/#listdatalakedatasetspaginator)
    """
    def paginate(
...
class ListInstancesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_supplychain/paginators/#listinstancespaginator)
    """
    def paginate(
