...
class AnyInstanceInServiceWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elb/waiters/#anyinstanceinservicewaiter)
    """
    def wait(
...
class InstanceDeregisteredWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elb/waiters/#instancederegisteredwaiter)
    """
    def wait(
...
class InstanceInServiceWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elb/waiters/#instanceinservicewaiter)
    """
    def wait(
