...
class DescribeActivitiesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/paginators/#describeactivitiespaginator)
    """
    def paginate(
...
class DescribeCommentsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/paginators/#describecommentspaginator)
    """
    def paginate(
...
class DescribeDocumentVersionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/paginators/#describedocumentversionspaginator)
    """
    def paginate(
        self,
...
class DescribeFolderContentsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/paginators/#describefoldercontentspaginator)
    """
    def paginate(
...
class DescribeGroupsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/paginators/#describegroupspaginator)
    """
    def paginate(
...
class DescribeNotificationSubscriptionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/paginators/#describenotificationsubscriptionspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class DescribeResourcePermissionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/paginators/#describeresourcepermissionspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class DescribeRootFoldersPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/paginators/#describerootfolderspaginator)
    """
    def paginate(
...
class DescribeUsersPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/paginators/#describeuserspaginator)
    """
    def paginate(
...
class SearchResourcesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/paginators/#searchresourcespaginator)
    """
    def paginate(
