...
class Property(BaseModel):
	...
	lte: bool
	schema: str
	type: Union[PropertyTypeStr,PropertyType]
	subTypes: List[Union[PropertyTypeStr,PropertyType]]
	propertyType:str
	read:bool
	write:bool
	ignored:bool
	...
	def __init__(self, name: str,
				 type: Union[PropertyTypeStr,PropertyType] = PropertyTypeStr.PROPERTY_STRING,
				 subTypes: List[Union[PropertyTypeStr,PropertyType]]= None,
				 description: str = '',
				 lte: bool = None,schema: str='',
				 propertyType : str ='',
				 read : bool=None,
				 write:bool=None,
				 ignored:bool=None,
	...
	def getPropertyTypeByString(self, v):
		if not self._PropertyMap.get(v):
			...
			if "(" in v:
				self.setSubTypesbyType(v)
				return PropertyType.PROPERTY_SET
