from ultipa.types.types_response import Task, Top
...
from ultipa.utils.convert import convertToAnyObject, convertToTask
    ...
    def showTask(self, algoNameOrId: Optional[Union[int, str]] = None, status: TaskStatus = None,
        ...
        if res.data:
            for obj in res.data:
                ...
                newData.task_info = convertToTask(task_info)
