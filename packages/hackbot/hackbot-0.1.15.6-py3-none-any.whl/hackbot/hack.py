...
from hackbot.utils import url_format, compress_source_code
...
async def hack_target(
    address: str, port: int, api_key: str, source_path: str = ".", output: Optional[str] = None
