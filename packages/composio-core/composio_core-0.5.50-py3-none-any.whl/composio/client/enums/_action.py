...
class Action(_AnnotatedEnum[ActionData], path=ACTIONS_CACHE):
    ...
    PEOPLEDATALABS_AUTOCOMPLETE: 'Action'
    PEOPLEDATALABS_COMPANY_CLEAN: 'Action'
    PEOPLEDATALABS_COMPANY_ENRICHMENT: 'Action'
    PEOPLEDATALABS_COMPANY_SEARCH: 'Action'
    PEOPLEDATALABS_IP_ENRICHMENT: 'Action'
    PEOPLEDATALABS_LOCATION_CLEAN: 'Action'
    PEOPLEDATALABS_PERSON_ENRICHMENT: 'Action'
    PEOPLEDATALABS_PERSON_IDENTITY: 'Action'
    PEOPLEDATALABS_PERSON_SEARCH: 'Action'
    PEOPLEDATALABS_SCHOOL_CLEAN: 'Action'
    PEOPLEDATALABS_SKILL_ENRICHMENT: 'Action'
