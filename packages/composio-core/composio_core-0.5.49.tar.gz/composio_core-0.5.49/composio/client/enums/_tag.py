...
class Tag(_AnnotatedEnum[TagData], path=TAGS_CACHE):
    ...
    PEOPLEDATALABS_AUTOCOMPLETE: 'Tag'
    PEOPLEDATALABS_CLEANER_ENDPOINTS: 'Tag'
    PEOPLEDATALABS_COMPANY_ENDPOINTS: 'Tag'
    PEOPLEDATALABS_IMPORTANT: 'Tag'
    PEOPLEDATALABS_IP_ENRICHMENT: 'Tag'
    PEOPLEDATALABS_JOB_TITLE_ENRICHMENT: 'Tag'
    PEOPLEDATALABS_PERSON_ENDPOINTS: 'Tag'
    PEOPLEDATALABS_SKILL_ENRICHMENT: 'Tag'
