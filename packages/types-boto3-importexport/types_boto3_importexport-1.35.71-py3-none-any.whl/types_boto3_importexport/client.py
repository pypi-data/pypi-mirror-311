...
class ImportExportClient(BaseClient):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_importexport/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/importexport.html#ImportExport.Client)
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_importexport/client/#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_importexport/client/#can_paginate)
        """
    ...
    def generate_presigned_url(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_importexport/client/#generate_presigned_url)
        """
    ...
    def close(self) -> None:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_importexport/client/#close)
        """
    ...
    def cancel_job(self, **kwargs: Unpack[CancelJobInputRequestTypeDef]) -> CancelJobOutputTypeDef:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_importexport/client/#cancel_job)
        """
    ...
    def create_job(self, **kwargs: Unpack[CreateJobInputRequestTypeDef]) -> CreateJobOutputTypeDef:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_importexport/client/#create_job)
        """
    ...
    def get_shipping_label(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_importexport/client/#get_shipping_label)
        """
    ...
    def get_status(self, **kwargs: Unpack[GetStatusInputRequestTypeDef]) -> GetStatusOutputTypeDef:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_importexport/client/#get_status)
        """
    ...
    def list_jobs(self, **kwargs: Unpack[ListJobsInputRequestTypeDef]) -> ListJobsOutputTypeDef:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_importexport/client/#list_jobs)
        """
    ...
    def update_job(self, **kwargs: Unpack[UpdateJobInputRequestTypeDef]) -> UpdateJobOutputTypeDef:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_importexport/client/#update_job)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_jobs"]) -> ListJobsPaginator:
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_importexport/client/#get_paginator)
        """
