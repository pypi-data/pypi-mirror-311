...
if __name__ == "__main__":
    # 同步测试
    # proxy_ip2 = "http://192.168.1.111:7890"  # 替换为你的代理 IP
    # proxy_ip2 = "47.251.43.115:33333"  # 替换为你的代理 IP
    proxy_ip = "socks5://0.146.179.8:45652"  # 替换为你的代理 IP
    # proxy_ip = "socks4://130.193.123.34:5678"  # 替换为你的代理 IP
    ...
    async def main():
        print("\n异步测试结果:")
        print(await test_proxy_async(proxy_ip, test_url, timeout=20))
