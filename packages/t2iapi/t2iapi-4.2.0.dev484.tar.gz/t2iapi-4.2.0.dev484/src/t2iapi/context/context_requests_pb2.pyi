...
class AssociateValidateAndChangeIdentificationOfPatientOrLocationContextStateRequest(_message.Message):
    __slots__ = ("descriptor_handle", "num_validators")
    DESCRIPTOR_HANDLE_FIELD_NUMBER: _ClassVar[int]
    NUM_VALIDATORS_FIELD_NUMBER: _ClassVar[int]
    descriptor_handle: str
    num_validators: str
    def __init__(self, descriptor_handle: _Optional[str] = ..., num_validators: _Optional[str] = ...) -> None: ...
