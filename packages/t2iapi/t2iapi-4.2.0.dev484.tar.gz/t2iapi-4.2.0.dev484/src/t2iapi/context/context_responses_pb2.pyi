...
class AssociateValidateAndChangeIdentificationOfPatientOrLocationContextStateResponse(_message.Message):
    __slots__ = ("status", "context_state_handle", "prior_mdib_version")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    CONTEXT_STATE_HANDLE_FIELD_NUMBER: _ClassVar[int]
    PRIOR_MDIB_VERSION_FIELD_NUMBER: _ClassVar[int]
    status: _basic_responses_pb2.BasicResponse
    context_state_handle: str
    prior_mdib_version: int
    def __init__(self, status: _Optional[_Union[_basic_responses_pb2.BasicResponse, _Mapping]] = ..., context_state_handle: _Optional[str] = ..., prior_mdib_version: _Optional[int] = ...) -> None: ...

class GetSupportedContextTypesResponse(_message.Message):
    __slots__ = ("status", "context_type")
    STATUS_FIELD_NUMBER: _ClassVar[int]
