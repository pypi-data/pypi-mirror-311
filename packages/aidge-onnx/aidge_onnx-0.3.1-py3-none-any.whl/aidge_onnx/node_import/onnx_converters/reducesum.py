...
def import_reducesum(onnx_node: onnx.NodeProto,
    ...
    reducesum_attrs : dict = {"axes" : List[int],"keep_dims" : 1, "noop_with_empty_axes" : 0}
    ...
    if  reducesum_attrs["axes"] is None:
        Log.warn("Warning: Operator 'ReduceSum' must have 'axes' attribute or input. This node will be filled by a GenericOperator.")
        return None
