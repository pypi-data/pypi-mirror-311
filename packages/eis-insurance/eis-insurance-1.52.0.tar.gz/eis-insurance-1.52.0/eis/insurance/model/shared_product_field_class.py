...
class SharedProductFieldClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, group, label, type_entity, type_id, insured_object_id, is_required, is_hidden, is_hidden_customer_portal, is_editable_customer_portal, is_system, is_unique, default_value, min_value, max_value, order, created_at, updated_at, created_by, updated_by, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, group, label, type_entity, type_id, insured_object_id, is_required, is_hidden, is_hidden_customer_portal, is_editable_customer_portal, is_system, is_unique, default_value, min_value, max_value, order, created_at, updated_at, created_by, updated_by, *args, **kwargs):  # noqa: E501
        """SharedProductFieldClass - a model defined in OpenAPI
