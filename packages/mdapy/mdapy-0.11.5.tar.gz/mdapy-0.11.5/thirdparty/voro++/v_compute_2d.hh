...
class voro_compute_2d {
    public:
        ...
        const int hy;
        /** A constant, set to the value of hx multiplied by hy, which is used
         * in the routines which step through mask boxes in sequence. */
        const int hxy;
         ...
         * derived container_poly class, this also holds particle radii. */
        double **p;
    ...
    private:
        ...
        const double bxsq;
        /** This sets the current value being used to mark tested blocks in the
         * mask. */
        unsigned int mv;
        ...
        /** An pointer to the array holding the minimum distances associated
         * with the worklists. */
        double *mrad;
        ...
        int *qu;
        /** A pointer to the end of the queue array, used to determine when the
         * queue is full. */
        int *qu_l;
        template<class v_cell_2d>
