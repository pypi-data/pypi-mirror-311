 ...
 * \param[in,out] minr a pointer to the current minimum distance. If the
 *                     distance computed in this function is smaller, then this
 *                     distance is set to the new one.
