...
struct wall_sphere : public wall_3d {
    public:
         ...
         *                  neighbor tracking.
         * \param[in] (xc_,yc_,zc_) a position vector for the sphere's center.
...
struct wall_cylinder : public wall_3d {
    public:
         ...
         * \param[in] (xa_,ya_,za_) a vector pointing along the direction of
         *                          the cylinder.
...
struct wall_cone : public wall_3d {
    public:
         ...
         * \param[in] (xa_,ya_,za_) a vector pointing along the axis of the
         *                          cone.
         * \param[in] ang the angle (in radians) of the cone, measured from the
         *                axis.
         * \param[in] w_id_ an ID number to associate with the wall for
         *                  neighbor tracking. */
