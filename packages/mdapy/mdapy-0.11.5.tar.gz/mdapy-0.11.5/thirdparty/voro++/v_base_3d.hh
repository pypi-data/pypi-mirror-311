...
class voro_base_3d {
    public:
        ...
        const int nxy;
        /** A constant, set to the value of nx*ny*nz, which is used in the
         * routines that step through blocks in sequence. */
        const int nxyz;
    ...
    protected:
         ...
         * \return The value of a modulo b, consistent for negative numbers. */
         ...
         * (-1,-1,0,0,1).
         * \param[in] (a,b) the input integers.
         * \return The value of a div b, consistent for negative numbers. */
