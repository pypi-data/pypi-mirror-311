...
if __name__ == "__main__":
    ...
    # lat.compute()
    # lat.box[2, 2] += 20
    lat = System(r"D:\Study\Gra-Al\potential_test\phonon\alc\POSCAR")
    type_list = lat.data["type"].to_numpy()
    potential = NEP(r"D:\Study\Gra-Al\potential_test\phonon\alc\nep.txt")
    ...
    elas = Elastic(lat.pos, lat.box, ["Al", "C"], type_list, potential)
