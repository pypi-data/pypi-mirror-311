...
class ListApplicationRevisionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codedeploy/paginators/#listapplicationrevisionspaginator)
    """
    def paginate(
...
class ListApplicationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codedeploy/paginators/#listapplicationspaginator)
    """
    def paginate(
...
class ListDeploymentConfigsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codedeploy/paginators/#listdeploymentconfigspaginator)
    """
    def paginate(
...
class ListDeploymentGroupsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codedeploy/paginators/#listdeploymentgroupspaginator)
    """
    def paginate(
...
class ListDeploymentInstancesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codedeploy/paginators/#listdeploymentinstancespaginator)
    """
    def paginate(
...
class ListDeploymentTargetsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codedeploy/paginators/#listdeploymenttargetspaginator)
    """
    def paginate(
...
class ListDeploymentsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codedeploy/paginators/#listdeploymentspaginator)
    """
    def paginate(
...
class ListGitHubAccountTokenNamesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codedeploy/paginators/#listgithubaccounttokennamespaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListOnPremisesInstancesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codedeploy/paginators/#listonpremisesinstancespaginator)
    """
    def paginate(
