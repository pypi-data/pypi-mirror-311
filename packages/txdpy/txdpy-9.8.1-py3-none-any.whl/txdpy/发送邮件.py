...
auth = oss2.Auth('LTAIdl6QeGZ4udof', 'CAiyowpuVzGEJcFWLca3YKBbsUKki3')
bucket = oss2.Bucket(auth, endpoint, 'bk179')


def 发送邮件(邮件主题, 邮件信息, 发送邮箱地址 = None, 接受邮箱地址 = None, 发送邮箱密码 = None):
    """
    :param 邮件主题: 邮件主题(标题)
    :param 邮件信息: 邮件文本信息
