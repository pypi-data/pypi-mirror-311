__all__ = ['prurar_code', 'convert_pc', 'convert_kl', 'delete_flase_empty', 'txdavg', 'txdpercavg', 'txdmin', 'txdperc',
           ...
           'get_ssq', 'is_ssq', 'is_school', 'get_major_name', 'school_names', 'major_names','文本模糊搜索','字符串相似度',
           'school_info','XiuzCode','ReadPdf','BkZkMajorInfo','YjsMajorInfo','GroupBy','文本错别字检查','英文表头对应中文',
           '删除html标签属性','读取图片列表'
           ]
