...
def get_record_image_lqs(record_data) -> ImagePIL.Image:
...
def get_record_image_ark(record_data, renormalize=True) -> ImagePIL.Image:
...
def get_record_image_cutter(record_data, renormalize=True) -> ImagePIL.Image:
