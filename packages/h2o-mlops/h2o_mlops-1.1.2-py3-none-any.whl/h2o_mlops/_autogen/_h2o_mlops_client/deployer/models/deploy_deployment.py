...
class DeployDeployment(object):
    ...
    openapi_types = {
        ...
        'monitoring_record': 'V2MonitoringRecord'
    }
    ...
    def __init__(self, id=None, project_id=None, deployment_environment_id=None, created_time=None, last_modified_time=None, single_deployment=None, shadow_deployment=None, split_deployment=None, security=None, display_name=None, description=None, revision_id=None, revision_create_time=None, user_info=None, custom_cors=None, monitor=None, monitoring_record=None, local_vars_configuration=None):  # noqa: E501
        ...
        if monitoring_record is not None:
            self.monitoring_record = monitoring_record
    ...
    @property
    def monitoring_record(self):
        """Gets the monitoring_record of this DeployDeployment.  # noqa: E501


        :return: The monitoring_record of this DeployDeployment.  # noqa: E501
        :rtype: V2MonitoringRecord
        """
        return self._monitoring_record

    @monitoring_record.setter
    def monitoring_record(self, monitoring_record):
        """Sets the monitoring_record of this DeployDeployment.


        :param monitoring_record: The monitoring_record of this DeployDeployment.  # noqa: E501
        :type monitoring_record: V2MonitoringRecord
        """

        self._monitoring_record = monitoring_record
