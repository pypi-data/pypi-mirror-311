...
from superverse.utils.internal import classproperty
...
KHULNASOFT_COLOR_PALETTE = ["C28DFC", "A351FB", "8315F9", "6706CE", "5905B3", "4D049A"]
...
class ColorPalette:
    ...
    def DEFAULT(cls) -> ColorPalette:
        ...
        ![default-color-palette](https://media.khulnasoft.com/
        superverse-annotator-examples/default-color-palette.png)
        """  # noqa: E501 // docs
        return ColorPalette.from_hex(color_hex_list=DEFAULT_COLOR_PALETTE)

    @classproperty
    def KHULNASOFT(cls) -> ColorPalette:
        """
        Returns a Khulnasoft color palette.

        Returns:
            ColorPalette: A ColorPalette instance with Khulnasoft colors.

        Example:
            ```python
            import superverse as sv

            sv.ColorPalette.KHULNASOFT
            # ColorPalette(colors=[Color(r=194, g=141, b=252), Color(r=163, g=81, b=251), ...])
            ```

        ![khulnasoft-color-palette](https://media.khulnasoft.com/
        superverse-annotator-examples/khulnasoft-color-palette.png)
        """  # noqa: E501 // docs
        return ColorPalette.from_hex(color_hex_list=KHULNASOFT_COLOR_PALETTE)
