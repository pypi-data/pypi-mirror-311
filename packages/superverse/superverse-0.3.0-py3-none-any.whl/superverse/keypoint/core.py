...
from superverse.detection.utils import get_data_item, is_data_equal
from superverse.validators import validate_keypoints_fields


@dataclass
class KeyPoints:
    """
    The `sv.KeyPoints` class in the Superverse library standardizes results from
    various keypoint detection and pose estimation models into a consistent format. This
    class simplifies data manipulation and filtering, providing a uniform API for
    integration with Superverse [keypoints annotators](/latest/keypoint/annotators).

    === "Ultralytics"

        Use [`sv.KeyPoints.from_ultralytics`](/latest/keypoint/core/#superverse.keypoint.core.KeyPoints.from_ultralytics)
    ...
    === "Inference"
        ...
        Use [`sv.KeyPoints.from_inference`](/latest/keypoint/core/#superverse.keypoint.core.KeyPoints.from_inference)
        method, which accepts [Inference](https://inference.khulnasoft.com/) pose result.
        ...
        image = cv2.imread(<SOURCE_IMAGE_PATH>)
        model = get_model(model_id=<POSE_MODEL_ID>, api_key=<KHULNASOFT_API_KEY>)
    ...
    === "MediaPipe"
        ...
        Use [`sv.KeyPoints.from_mediapipe`](/latest/keypoint/core/#superverse.keypoint.core.KeyPoints.from_mediapipe)
    ...
    def from_inference(cls, inference_result: Union[dict, Any]) -> KeyPoints:
        """
        Create a `sv.KeyPoints` object from the [Khulnasoft](https://khulnasoft.com/)
        API inference result or the [Inference](https://inference.khulnasoft.com/)
        package results.

        Args:
            inference_result (dict, any): The result from the
                Khulnasoft API or Inference package containing predictions with keypoints.
        ...
        Examples:
            ...
            client = InferenceHTTPClient(
                api_url="https://detect.khulnasoft.com",
