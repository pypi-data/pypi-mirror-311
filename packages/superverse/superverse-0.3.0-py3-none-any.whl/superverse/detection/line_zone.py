...
from superverse.detection.utils import cross_product
from superverse.draw.color import Color
from superverse.draw.utils import draw_rectangle, draw_text
from superverse.geometry.core import Point, Position, Rect, Vector
from superverse.utils.image import overlay_image
from superverse.utils.internal import SuperverseWarnings
...
class LineZone:
    ...
    <video controls>
        <source
            src="https://media.khulnasoft.com/superverse/cookbooks/count-objects-crossing-the-line-result-1280x720.mp4"
            type="video/mp4">
    </video>
    ...
    def trigger(self, detections: Detections) -> Tuple[np.ndarray, np.ndarray]:
        ...
        if detections.tracker_id is None:
            warnings.warn(
                ...
                "https://superverse.khulnasoft.com/latest/trackers for more "
                "information.",
                category=SuperverseWarnings,
            )
            return crossed_in, crossed_out
