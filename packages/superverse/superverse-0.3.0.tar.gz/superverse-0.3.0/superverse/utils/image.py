...
from superverse.draw.color import Color, unify_to_bgr
from superverse.draw.utils import calculate_optimal_text_scale, draw_text
...
def crop_image(
    ...
    ![crop_image](https://media.khulnasoft.com/superverse-docs/crop-image.png){ align=center width="800" }
    """  # noqa E501 // docs
...
def resize_image(
    ...
    ![resize_image](https://media.khulnasoft.com/superverse-docs/resize-image.png){ align=center width="800" }
    """  # noqa E501 // docs
...
def letterbox_image(
    ...
    ![letterbox_image](https://media.khulnasoft.com/superverse-docs/letterbox-image.png){ align=center width="800" }
    """  # noqa E501 // docs
...
def overlay_image(
    ...
    ![overlay_image](https://media.khulnasoft.com/superverse-docs/overlay-image.png){ align=center width="800" }
    """  # noqa E501 // docs
