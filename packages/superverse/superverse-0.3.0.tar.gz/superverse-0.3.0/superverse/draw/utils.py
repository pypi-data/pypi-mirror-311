...
from superverse.geometry.core import Point, Rect
...
def draw_line(
    ...
    Parameters:
        ...
        color (Color): The color of the line, defaults to Color.KHULNASOFT
...
def draw_rectangle(
    scene: np.ndarray, rect: Rect, color: Color = Color.KHULNASOFT, thickness: int = 2
) -> np.ndarray:
    """
...
def draw_filled_rectangle(
    scene: np.ndarray, rect: Rect, color: Color = Color.KHULNASOFT, opacity: float = 1
) -> np.ndarray:
    """
...
def draw_polygon(
    ...
    Parameters:
        ...
        color (Color): The color of the polygon. Defaults to Color.KHULNASOFT.
