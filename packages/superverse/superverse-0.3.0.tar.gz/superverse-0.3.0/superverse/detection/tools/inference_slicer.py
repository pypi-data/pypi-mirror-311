...
from superverse.detection.utils import move_boxes, move_masks, move_oriented_boxes
from superverse.utils.image import crop_image
from superverse.utils.internal import (
    SuperverseWarnings,
    warn_deprecated,
)
    ...
    def __init__(
        ...
        if overlap_ratio_wh is not None:
            warn_deprecated(
                ...
                "will be removed in `superverse-0.27.0`. Please manually set it to "
