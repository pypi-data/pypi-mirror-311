...
query_station_result = QueryStationRelatedHandler(endpoint="http://fuxi-ai.cn:10115", auth_provider=EnvVarCredentialsProvider())
result = query_station_result.execute_query_area(QueryAreaRequest(
    type=0,  # 0: wind, 1: solar
    provinces=['Hainan'],
    start_time='2024-01-31 16:00:00',
...
query_station_result = query_station_result.execute_query_station(QueryStationRequest(
    ids=["4"],
    # provinces=["Hainan"],
    page=1,
    page_size=100,
...
print(f"Query station result: {query_station_result.model_dump_json()}")
...
# train_infer_handler = TrainInferHandler(endpoint="http://fuxi-ai.cn:10115", auth_provider=EnvVarCredentialsProvider())
# query_infer_result = train_infer_handler.execute_query_infer(QueryInferRequest(
#     ids=[4],
#     algos=["xgb_wind_ultra_points"],
#     start_time="2024-03-03 00:00:00",
...
#         ndays=160,
#         hours=24,
#         coords=[{"req_lat": 35.56544828, "req_lon": 113.21735880}],
...
#         ndays=1,
#         hours=24,
#         coords=[{'req_lat': 18.66933828300006, 'req_lon': 109.11524498800003}],
