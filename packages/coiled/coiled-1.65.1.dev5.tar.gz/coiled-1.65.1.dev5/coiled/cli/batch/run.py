...
@click.option(
    "--task-on-scheduler", default=False, is_flag=True, help="Run task with smallest job id on scheduler node"
)
@click.option("--array", default=None, type=str)
@click.option("--scheduler-task-array", default=None, type=str)
