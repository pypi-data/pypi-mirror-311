...
_TRDMARKET = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TrdMarket_Futures_Simulate_HK', index=7, number=10,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TrdMarket_Futures_Simulate_US', index=8, number=11,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_ORDERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OrderType_TWAP', index=14, number=16,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OrderType_TWAPLimit', index=15, number=17,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OrderType_VWAP', index=16, number=18,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
