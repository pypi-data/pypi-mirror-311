...
packages = \
['kuflow_temporal_workflow_kuflow', 'kuflow_temporal_workflow_kuflow.models']
...
setup_kwargs = {
    'name': 'kuflow-temporal-workflow-kuflow',
    'version': '3.0.0',
    'description': 'KuFlow SDK :: Temporal.io workflow utilities to interact with KuFlow',
