...
def test_sweights_simple_roofit(example_file):
    ...
    hlteff.counts()
    hlteff.efficiencies()
    hlteff.write("results/output_test_sweights_simple_roofit.root")
...
def test_sweights_simple_zfit(example_file):
    ...
    hlteff = HltEff(
        ...
        observable=obs,
        pdf=pdf,
        output_path="results/sweights_simple_zfit/",
        sweights="signal_yield",
        threads=8,
        expert_mode=True,
    )
    ...
    hlteff.counts()
    hlteff.efficiencies()
    hlteff.write("results/output_test_sweights_simple_zfit.root")
...
def test_sweights_with_prefit(example_file):
    ...
    hlteff.counts()
    hlteff.efficiencies()
    hlteff.write("results/output_test_sweights_with_prefit.root")
