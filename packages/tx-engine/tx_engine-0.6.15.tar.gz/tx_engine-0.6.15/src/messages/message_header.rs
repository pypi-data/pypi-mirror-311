...
** https://www.ibm.com/docs/en/zos/2.1.0?topic=functions-read-read-from-file-socket
** This states that the size of the buffer can not be greater than INT_MAX (+2147483647)
*/
...
mod tests {
    ...
    fn validate() {
        ...
        // Block messages don not have size limitation
        let h = MessageHeader {
            magic,
            command: *b"block\0\0\0\0\0\0\0",
            payload_size: 0x80000000,
            checksum: [0x12, 0x34, 0x56, 0x78],
        };
