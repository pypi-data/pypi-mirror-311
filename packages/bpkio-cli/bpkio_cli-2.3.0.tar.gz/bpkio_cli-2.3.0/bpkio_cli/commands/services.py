import click
import cloup
from bpkio_api.models import (AdaptiveStreamingCdnService,
                              AdaptiveStreamingCdnServiceIn,
                              AdInsertionService, ContentReplacementService,
                              ContentReplacementSlot, ServiceIn,
                              VirtualChannelService, VirtualChannelSlot)
...
from bpkio_cli.commands.creators.slot_iterators import (
    clear_slots_command, replicate_slots_command)
...
from bpkio_cli.commands.creators.virtual_channel_slot import \
    create_slot_command
