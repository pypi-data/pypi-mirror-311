...
from histudio.app.utils import dbhelpers, auth, commands
from histudio.app.services import persons_service, auth_service
...
from histudio import __file__ as root_path
...
def version():
    ...
    """
    from histudio import __version__

    print(f"histudio version: {__version__}")
...
def clear_memory_cache():
    ...
    from histudio.app import cache
...
def dump_database(store=False):
    """
    Dump database described in histudio environment variables and save it to
    configured object storage.
    """
    print("hi from env cli")
