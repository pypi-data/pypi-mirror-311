...
from histudio.app import config, swagger
...
from histudio.app.utils import cache, fs, logs, monitoring
from histudio.app.utils.flask import ParsedUserAgent, ORJSONProvider
...
def configure_auth():
    from histudio.app.services import persons_service
