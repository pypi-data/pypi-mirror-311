...
from histudio.app.utils import dbhelpers
from histudio.app.utils.env import envtobool, env_with_semicolon_to_list
...
DATABASE = {
    ...
    "database": os.getenv("DB_DATABASE", "lanstudiodb"),
}
...
TMP_DIR = os.getenv("TMP_DIR", os.path.join(tempfile.gettempdir(), "histudio"))
...
FS_S3_CREATE_BUCKET = envtobool("FS_S3_CREATE_BUCKET", False)
...
JOB_QUEUE_NOMAD_PLAYLIST_JOB = os.getenv(
    "JOB_QUEUE_NOMAD_PLAYLIST_JOB", "histudio-playlist"
)
JOB_QUEUE_NOMAD_NORMALIZE_JOB = os.getenv("JOB_QUEUE_NOMAD_NORMALIZE_JOB", "")
JOB_QUEUE_NOMAD_HOST = os.getenv("JOB_QUEUE_NOMAD_HOST", "histudio-nomad-01.histudio")
...
LDAP_BASE_DN = os.getenv("LDAP_BASE_DN", "cn=Users,dc=histudio,dc=local")
LDAP_GROUP = os.getenv("LDAP_GROUP", "")
LDAP_DOMAIN = os.getenv("LDAP_DOMAIN", "histudio.local")
