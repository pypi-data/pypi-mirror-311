...
class Task(db.Model, BaseMixin, SerializerMixin):
    ...
    wip_date = db.Column(db.DateTime)
    mandays_count = db.Column(db.Integer, default=0)
    retake_date = db.Column(db.DateTime)
    awf_date = db.Column(db.DateTime)
    app_date = db.Column(db.DateTime)
