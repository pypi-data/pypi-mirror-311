...
from histudio.app.utils import events, fields, cache
from histudio.app.utils import query as query_utils
...
from histudio.app.models.task import assignees_table
        ...
        if task_id is not None:
            ...
            if task_id not in task_map:
                task_dict = {
                    ...
                    "mandays_count": task_mandays_count,
                    ...
                    "wip_date": fields.serialize_value(
                        task_wip_date
                    ),
                    "retake_date": fields.serialize_value(
                        task_retake_date
                    ),
                    "awf_date": fields.serialize_value(
                        task_awf_date
                    ),
                    "app_date": fields.serialize_value(
                        task_app_date
                    ),
                    "count": task_count,
