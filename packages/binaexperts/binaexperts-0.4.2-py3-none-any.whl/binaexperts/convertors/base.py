...
from binaexperts.utils.loadhelpers import *
from binaexperts.utils.utils import *
...
class YOLOConvertor(BaseConvertor):
    ...
    def __init__(self):
        ...
        yolo_schema_path = os.path.join(os.path.dirname(__file__), '..', 'schema', YOLO_SCHEMA_FILE)
        normalizer_schema_path = os.path.join(os.path.dirname(__file__), '..', 'schema', NORMALIZER_SCHEMA_FILE)
...
class BinaExpertsConvertor(BaseConvertor):
    ...
    def __init__(self):
        ...
        binaexperts_schema_path = os.path.join(os.path.dirname(__file__), '..', 'schema', BINAEXPERTS_SCHEMA_FILE)
        normalizer_schema_path = os.path.join(os.path.dirname(__file__), '..', 'schema', NORMALIZER_SCHEMA_FILE)
