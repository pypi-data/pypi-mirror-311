...
class EnvironmentExistsWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/waiters/#environmentexistswaiter)
    """
    def wait(
...
class EnvironmentTerminatedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/waiters/#environmentterminatedwaiter)
    """
    def wait(
...
class EnvironmentUpdatedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/waiters/#environmentupdatedwaiter)
    """
    def wait(
