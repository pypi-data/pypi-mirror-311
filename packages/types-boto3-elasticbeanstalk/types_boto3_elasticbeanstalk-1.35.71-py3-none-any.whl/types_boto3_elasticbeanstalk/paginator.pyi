...
class DescribeApplicationVersionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/paginators/#describeapplicationversionspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class DescribeEnvironmentManagedActionHistoryPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/paginators/#describeenvironmentmanagedactionhistorypaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class DescribeEnvironmentsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/paginators/#describeenvironmentspaginator)
    """
    def paginate(
...
class DescribeEventsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/paginators/#describeeventspaginator)
    """
    def paginate(
...
class ListPlatformVersionsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/paginators/#listplatformversionspaginator)
    """
    def paginate(
