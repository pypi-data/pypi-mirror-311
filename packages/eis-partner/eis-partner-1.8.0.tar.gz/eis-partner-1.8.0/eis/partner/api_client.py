...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PartnerApi()
        api_instance.create_partner  # this is an instance of the class Endpoint
        api_instance.create_partner()  # this invokes api_instance.create_partner.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_partner.callable or self.callable in this class
