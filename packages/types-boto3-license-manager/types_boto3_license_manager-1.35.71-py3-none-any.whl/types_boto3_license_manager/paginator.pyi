...
class ListAssociationsForLicenseConfigurationPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_license_manager/paginators/#listassociationsforlicenseconfigurationpaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListLicenseConfigurationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_license_manager/paginators/#listlicenseconfigurationspaginator)
    """
    def paginate(
        self,
...
class ListLicenseSpecificationsForResourcePaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_license_manager/paginators/#listlicensespecificationsforresourcepaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListResourceInventoryPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_license_manager/paginators/#listresourceinventorypaginator)
    """
    def paginate(
...
class ListUsageForLicenseConfigurationPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_license_manager/paginators/#listusageforlicenseconfigurationpaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
