...
def collection_from_file(file_path: list):
    """
    Crée une instance de la classe Collection.
    file_paths: chemin vers le fichier d'entrée, 
    """
        
    all_parts = []  # Liste de toutes les parties séparées
    current_part = []  # Liste pour la partie courante
    ...
    # Créer des objets Uniprot pour chaque partie et les ajouter à la collection
    uniprot_objects = [uniprot.Uniprot('\n'.join(part)) for part in all_parts]
