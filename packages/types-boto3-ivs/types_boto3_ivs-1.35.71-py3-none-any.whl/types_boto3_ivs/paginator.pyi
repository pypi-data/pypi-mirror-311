...
class ListChannelsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ivs/paginators/#listchannelspaginator)
    """
    def paginate(
...
class ListPlaybackKeyPairsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ivs/paginators/#listplaybackkeypairspaginator)
    """
    def paginate(
...
class ListRecordingConfigurationsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ivs/paginators/#listrecordingconfigurationspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListStreamKeysPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ivs/paginators/#liststreamkeyspaginator)
    """
    def paginate(
...
class ListStreamsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ivs/paginators/#liststreamspaginator)
    """
    def paginate(
